...
export const PSM_DATA: ChantData[] = [
  {
    ...
    mode: "8",
    books: ["psm"],
    pages: { "psm": [{ page: "31", sequence: 2, extent: 1 }] },
  },
  {
    id: "gregobase:3304",
    incipit: "Nonne sic",
    ...
    mode: "8",
    books: ["psm"],
    pages: { "psm": [{ page: "363", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:7476",
    ...
    mode: "1",
    books: ["psm"],
    pages: { "psm": [{ page: "31", sequence: 0, extent: 0 }] },
  },
  {
    id: "gregobase:7477",
    ...
    mode: "4",
    books: ["psm"],
    pages: { "psm": [{ page: "37", sequence: 0, extent: 0 }] },
  },
  {
    id: "gregobase:7561",
    ...
    mode: "8",
    books: ["psm"],
    pages: { "psm": [{ page: "372", sequence: 1, extent: 2 }] },
  },
  {
    id: "gregobase:7563",
    ...
    mode: "8",
    books: ["psm"],
    pages: { "psm": [{ page: "368", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:7564",
    ...
    mode: "4",
    books: ["psm"],
    pages: { "psm": [{ page: "377", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:7732",
    ...
    mode: "4",
    books: ["psm"],
    pages: { "psm": [{ page: "85", sequence: 0, extent: 0 }] },
  },
  {
    id: "gregobase:7763",
    ...
    mode: null,
    books: ["psm"],
    pages: { "psm": [{ page: "342", sequence: 0, extent: 0 }] },
  },
  {
    id: "gregobase:7804",
    ...
    mode: "2",
    books: ["psm"],
    pages: { "psm": [{ page: "387", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:8655",
    ...
    mode: "1",
    books: ["psm"],
    pages: { "psm": [{ page: "272", sequence: 1, extent: 1 }] },
  },
  {
    id: "gregobase:8657",
    ...
    mode: "1",
    books: ["psm"],
    pages: { "psm": [{ page: "8", sequence: 1, extent: 2 }] },
  },
  {
    id: "gregobase:8660",
    ...
    mode: "2",
    books: ["psm"],
    pages: { "psm": [{ page: "11", sequence: 1, extent: 1 }] },
  },
  {
    id: "gregobase:8661",
    ...
    mode: "8",
    books: ["psm"],
    pages: { "psm": [{ page: "13", sequence: 2, extent: 2 }] },
  },
  {
    id: "gregobase:8664",
    ...
    mode: "7",
    books: ["psm"],
    pages: { "psm": [{ page: "18", sequence: 1, extent: 1 }] },
  },
  {
    id: "gregobase:8666",
    ...
    mode: "6",
    books: ["psm"],
    pages: { "psm": [{ page: "20", sequence: 1, extent: 1 }] },
  },
  {
    id: "gregobase:8667",
    ...
    mode: "7",
    books: ["psm"],
    pages: { "psm": [{ page: "22", sequence: 1, extent: 1 }] },
  },
  {
    id: "gregobase:9061",
    incipit: "Credidi",
    ...
    mode: "8",
    books: ["psm"],
    pages: { "psm": [{ page: "312", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:9062",
  ...
  },
  {
    ...
    mode: "p",
    books: ["psm"],
    pages: { "psm": [{ page: "309", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:9064",
    ...
    mode: null,
    books: ["psm"],
    pages: { "psm": [{ page: "314", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:9065",
    incipit: "Sana animam",
    ...
    mode: null,
    books: ["psm"],
    pages: { "psm": [{ page: "315", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:9091",
    ...
    mode: "1",
    books: ["psm"],
    pages: { "psm": [{ page: "321", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:9104",
    ...
    mode: null,
    books: ["psm"],
    pages: { "psm": [{ page: "315", sequence: 2, extent: 2 }] },
  },
  {
    id: "gregobase:9158",
    ...
    mode: null,
    books: ["psm"],
    pages: { "psm": [{ page: "112", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:9159",
    ...
    mode: null,
    books: ["psm"],
    pages: { "psm": [{ page: "110", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:9162",
    ...
    mode: null,
    books: ["psm"],
    pages: { "psm": [{ page: "114", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:11322",
    ...
    mode: "2",
    books: ["psm"],
    pages: { "psm": [{ page: "161", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:11323",
    incipit: "Ego autem",
    ...
    mode: "3",
    books: ["psm"],
    pages: { "psm": [{ page: "3", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:15476",
    ...
    mode: "8",
    books: ["psm"],
    pages: { "psm": [{ page: "119", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:15673",
    ...
    mode: "1",
    books: ["psm"],
    pages: { "psm": [{ page: "386", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:16102",
    incipit: "In noctibus",
    ...
    mode: "d",
    books: ["psm"],
    pages: { "psm": [{ page: "", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:16898",
    ...
    mode: "d",
    books: ["psm"],
    pages: { "psm": [{ page: "56", sequence: 1, extent: 1 }] },
  },
  {
    id: "gregobase:16899",
    ...
    mode: "7",
    books: ["psm"],
    pages: { "psm": [{ page: "87", sequence: 1, extent: 1 }] },
  },
  {
    id: "gregobase:16900",
    incipit: "Lætétur cor",
    ...
    mode: "d",
    books: ["psm"],
    pages: { "psm": [{ page: "239", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:17590",
    incipit: "Esto mihi",
    ...
    mode: "1",
    books: ["psm"],
    pages: { "psm": [{ page: "158", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:17654",
    ...
    mode: "3",
    books: ["psm"],
    pages: { "psm": [{ page: "358", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:17689",
    ...
    mode: "6",
    books: ["psm"],
    pages: { "psm": [{ page: "53", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:17803",
    ...
    mode: "3",
    books: ["psm"],
    pages: { "psm": [{ page: "358", sequence: 0, extent: 0 }] },
  },
  {
    id: "gregobase:17833",
    ...
    mode: "1",
    books: ["psm"],
    pages: { "psm": [{ page: "391", sequence: 1, extent: 1 }] },
  },
  {
    id: "gregobase:17834",
    ...
    mode: "8",
    books: ["psm"],
    pages: { "psm": [{ page: "31", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:17905",
    ...
    mode: "2",
    books: ["psm"],
    pages: { "psm": [{ page: "452", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:17907",
    incipit: "Ego dormivi ",
    ...
    mode: "8",
    books: ["psm"],
    pages: { "psm": [{ page: "28", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:18038",
    incipit: "Filii Sion",
    ...
    mode: "8",
    books: ["psm"],
    pages: { "psm": [{ page: "78", sequence: 1, extent: 1 }] },
  },
  {
    id: "gregobase:18039",
    ...
    mode: "7",
    books: ["psm"],
    pages: { "psm": [{ page: "143", sequence: 1, extent: 1 }] },
  },
  {
    id: "gregobase:18040",
    ...
    mode: "8",
    books: ["psm"],
    pages: { "psm": [{ page: "261", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:18042",
    ...
    mode: "8",
    books: ["psm"],
    pages: { "psm": [{ page: "25", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:18043",
    ...
    mode: "4",
    books: ["psm"],
    pages: { "psm": [{ page: "20", sequence: 2, extent: 1 }] },
  },
  {
    id: "gregobase:18044",
    ...
    mode: "1",
    books: ["psm"],
    pages: { "psm": [{ page: "262", sequence: 1, extent: 1 }] },
  },
  {
    id: "gregobase:18045",
    ...
    mode: "8",
    books: ["psm"],
    pages: { "psm": [{ page: "42", sequence: 3, extent: 1 }] },
  },
  {
    id: "gregobase:18049",
    ...
    mode: "1",
    books: ["psm"],
    pages: { "psm": [{ page: "121", sequence: 1, extent: 1 }] },
  },
  {
    id: "gregobase:18050",
    ...
    mode: "8",
    books: ["psm"],
    pages: { "psm": [{ page: "262", sequence: 2, extent: 2 }] },
  },
  {
    id: "gregobase:18051",
    ...
    mode: "1",
    books: ["psm"],
    pages: { "psm": [{ page: "38", sequence: 2, extent: 1 }] },
  },
  {
    id: "gregobase:18052",
    incipit: "Oculi mei",
    ...
    mode: "4",
    books: ["psm"],
    pages: { "psm": [{ page: "38", sequence: 1, extent: 1 }] },
  },
  {
    id: "gregobase:18054",
    ...
    mode: "4",
    books: ["psm"],
    pages: { "psm": [{ page: "88", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:18057",
    ...
    mode: "4",
    books: ["psm"],
    pages: { "psm": [{ page: "220", sequence: 1, extent: 1 }] },
  },
  {
    id: "gregobase:18058",
    ...
    mode: "5",
    books: ["psm"],
    pages: { "psm": [{ page: "230", sequence: 2, extent: 1 }] },
  },
  {
    id: "gregobase:18059",
    ...
    mode: "1",
    books: ["psm"],
    pages: { "psm": [{ page: "276", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:18060",
    incipit: "Sana Domine",
    ...
    mode: "2",
    books: ["psm"],
    pages: { "psm": [{ page: "100", sequence: 0, extent: 1 }] },
  },
  {
    id: "gregobase:18061",
    ...
    mode: "e",
    books: ["psm"],
    pages: { "psm": [{ page: "118", sequence: 0, extent: 1 }] },
  }
];
