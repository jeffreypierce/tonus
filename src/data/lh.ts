...
export const LH_DATA: ChantData[] = [
  ...
  },
  {
    ...
    gabc: "(c4)Di(f)cá(e)mus(d) lau(e)des(dc) Dó(de)mi(e)no(e) (,)\r\nfer(g)vén(ghwih)te(gf) prom(g)pti(ghg) spí(fe)ri(de)tu ;(e) (;)\r\nho(f)ra(e) vo(d)lú(e)ta(dc) sé(d!ewf)xi(d)es(d,)\r\nnos(d) ad(f) o(e)rán(g)dum(ghg) pró(fe)vo(de)cat.(e) (::)\r\n2. In(f) hac(e) e(d)nim(e) fi(dc)dé(de)li(e)bus(e) (,)\r\nve(g)ræ(ghwih) sa(gf)lú(g)tis(ghg) gló(fe)ri(de)a,(e) (;)\r\nbe(f)á(e)ti(d) A(e)gni(dc) hó(d!ewf)sti(d)a,(d,)\r\ncru(d)cis(f) vir(e)tú(g)te(ghg) réd(fe)di(de)tur.(e) (::)\r\n3. Cu(f)ius(e) lu(d)ce(e) cla(dc)rís(de)si(e)ma(e) (,)\r\nte(g)né(ghwih)bri(gf)cat(g) me(ghg)rí(fe)di(de)es ;(e) (;)\r\nsu(f)má(e)mus(d) to(e)to(dc) pé(d!ewf)cto(d)re(d,)\r\ntan(d)ti(f) splen(e)dó(g)ris(ghg) grá(fe)ti(de)am.(e) (::)\r\n4. De(f)o(e) Pa(d)tri(e) sit(dc) gló(de)ri(e)a(e) (,)\r\ne(g)iús(ghwih)que(gf) so(g)li(ghg) Fí(fe)li(de)o(e) (;)\r\ncum(f) Spí(e)ri(d)tu(e) Pa(dc)rá(d!ewf)cli(d)to,(d,)\r\nin(d) sem(f)pi(e)tér(g)na(ghg) sæ(fe)cu(de)la.(e) (::)\r\nA(efe)men.(de) (::)",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)TEr(f)nis(e) ho(d)rá(e)rum(dc) tér(de)mi(e)nis(e) (,)\r\nvo(g)lú(ghwih)tis,(gf) dan(g)te(ghg) Dó(fe)mi(de)no,(e) (;)\r\ntri(f)num(e) per(d)féc(e)t<i>e</i>() et(dc) ú(d!ewf)ni(d)cum(d,)\r\ni(d)psum(f) de(e)vó(g)ti(ghg) psál(fe)li(de)mus.(e) (::)\r\n2. Sa(f)crum(e) De(d)i(e) my(dc)sté(de)ri(e)um(e) (,)\r\npu(g)ro(ghwih) te(gf)nén(g)tes(ghg) pé(fe)cto(de)re,(e) (;)\r\nPe(f)tri(e) ma(d)gí(e)stri(dc) ré(d!ewf)gu(d)la(d,)\r\nsi(d)gno(f) sa(e)lú(g)tis(ghg) pró(fe)di(de)ta,(e) (::)\r\n3. Et(f) nos(e) psal(d)lá(e)mus(dc) spí(de)ri(e)tu,(e) (,)\r\nhæ(g)rén(ghwih)tes(gf) sic(g) a(ghg)pó(fe)sto(de)lis,(e) (;)\r\nut(f) plan(e)tas(d) ad(e)huc(dc) dé(d!ewf)bi(d)les(d,)\r\nChri(d)sti(f) vir(e)tú(g)te(ghg) dí(fe)ri(de)gant.(e) (::)\r\n4. De(f)o(e) Pa(d)tri(e) sit(dc) gló(de)ri(e)a(e) (,)\r\ne(g)iús(ghwih)que(gf) so(g)li(ghg) Fí(fe)li(de)o(e) (;)\r\ncum(f) Spí(e)ri(d)tu(e) Pa(dc)rá(d!ewf)cli(d)to,(d,)\r\nin(d) sem(f)pi(e)tér(g)na(ghg) sæ(fe)cu(de)la.(e) (::)\r\nA(efe)men.(de) (::)",
    office: "hy",
    mode: "4",
    pages: [
    { page: "13", sequence: 0, extent: 1 }
  ...
  },
  {
    ...
    gabc: "(f3)Ve(f)ni,(f) red(f)ém(e)ptor(f) gén(h)ti(g)um,(f_') (,)\r\no(h)stén(i)de(i) par(i)tum(h) Vír(i)gi(i)nis ;(j.) (;)\r\nmi(j)ré(j)tur(i) om(j)ne(h) sǽ(i)cu(h)lum :(f_') (,)\r\nta(f)lis(e) de(f)cet(h) par(i)tus(f) De(e)um.(f.) (::)\r\n2. Non(f) ex(f) vi(f)rí(e)li(f) sé(h)mi(g)ne,(f_') (,)\r\nsed(h) mý(i)sti(i)co(i) spi(h)rá(i)mi(i)ne(j.) (;)\r\nVer(j)bum(j) De(i)i(j) fa(h)ct<i>um</i>(h) est(i) ca(h)ro(f_') (,)\r\nfru(f)ctús(e)que(f) ven(h)tris(i) fló(f)ru(e)it.(f.) (::)\r\n3. Al(f)vus(f) tu(f)mé(e)scit(f) Vír(h)gi(g)nis,(f_') (,)\r\nclau(h)strum(i) pu(i)dó(i)ris(h) pér(i)ma(i)net,(j.) (;)\r\nve(j)xíl(j)la(i) vir(j)tú(h)tum(i) mi(h)cant,(f_') (,)\r\nver(f)sá(e)tur(f) in(h) tem(i)plo(f) De(e)us.(f.) (::)\r\n4. Pro(f)cé(f)dat(f) e(e) thá(f)l<i>a</i>()mo(h) su(g)o,(f_') (,)\r\npu(h)dó(i)ris(i) au(i)la(h) ré(i)gi(i)a,(j.) (;)\r\ngé(j)<i>mi</i>()næ(j) gi(i)gas(j) subs(h)tán(i)ti(h)æ(f_') (,)\r\na(f)lá(e)cris(f) ut(h) cur(i)rat(f) vi(e)am.(f.) (::)\r\n5. Æ(f)quá(f)lis(f) æ(e)tér(f)no(h) Pa(g)tri,(f_') (,)\r\ncar(h)nis(i) tro(i)pǽ(i)o(h) cín(i)ge(i)re,(j.) (;)\r\nin(j)fír(j)ma(i) no(j)stri(h) cór(i)po(h)ris(f_') (,)\r\nvir(f)tú(e)te(f) fir(h)mans(i) pér(f)pe(e)ti.(f.) (::)\r\n6. Præ(f)sé(f)pe(f) iam(e) ful(f)get(h) tu(g)um(f_') (,)\r\nlu(h)mén(i)que(i) nox(i) spi(h)rat(i) no(i)vum,(j.) (;)\r\nquod(j) nul(j)la(i) nox(j) in(h)tér(i)po(h)let(f_') (,)\r\nfi(f)dé(e)que(f) iu(h)gi(i) lú(f)ce(e)at.(f.) (::)\r\n7. Sit,(f) Chri(f)ste,(f) rex(e) pi(f)ís(h)si(g)me,(f_') (,)\r\nti(h)bi(i) Pa(i)trí(i)que(h) gló(i)ri(i)a(j.) (;)\r\ncum(j) Spí(j)ri(i)tu(j) Pa(h)rá(i)cli(h)to,(f_') (,)\r\nin(f) sem(e)pi(f)tér(h)na(i) sǽ(f)cu(e)la.(f.) (::)\r\nA(fgf)men.(e.f.) (::)",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Fit(h) por(hhg)ta(ed) Chri(g)sti(hj) pér(ji)vi(hi)a(i_') (,)\r\nom(k)ni(kj) re(i)fér(ji)ta(h) grá(ih)ti(gh)a,(h.) (;)\r\ntrans(k)ít(k)que(i) rex,(k) et(klk) pér(j)ma(i)net(hiHG_') (,)\r\nclau(i)s<i>a</i>,() ut(jk) fu(i)it,(ji) per(h) s<sp>'ae</sp>(ih)cu(gh)la.(h.) (::)\r\n2. Sum(h)mi(hhg) Pa(ed)rén(g)tis(hj) Fí(ji)li(hi)us(i_') (,)\r\npro(k)cés(kj)sit(i) au(ji)la(h) Vír(ih)gi(gh)nis,(h.) (;)\r\nspon(k)sus,(k) red(i)ém(k)ptor,(klk) cón(j)di(i)tor(hiHG_') (,)\r\nsu(i)æ(jk) gi(i)gas(ji) Ec(h)clé(ih)si(gh)æ :(h.) (::)\r\n3. Ho(h)nor(hhg) ma(ed)tris(g) et(hj) gáu(ji)di(hi)um,(i_') (,)\r\nim(k)mén(kj)sa(i) spes(ji) cre(h)dén(ih)ti(gh)um,(h.) (;)\r\nla(k)pis(k) de(i) mon(k)te(klk) vé(j)ni(i)ens(hiHG_') (,)\r\nmun(i)dúm(jk)que(i) re(ji)plens(h) grá(ih)ti(gh)a.(h.) (::)\r\n4. Ex(h)súl(hhg)tet(ed) om(g)nis(hj) á(ji)ni(hi)ma,(i_') (,)\r\nquod(k) nunc(kj) sal(i)vá(ji)tor(h) gén(ih)ti(gh)um(h.) (;)\r\nad(k)vé(k)nit(i) mun(k)di(klk) Dó(j)mi(i)nus(hiHG_') (,)\r\nred(i)í(jk)me(i)re(ji) quos(h) cón(ih)di(gh)dit.(h.) (::)\r\n5. Chri(h)sto(hhg) sit(ed) om(g)nis(hj) gló(ji)ri(hi)a,(i_') (,)\r\nquem(k) Pa(kj)ter(i) De(ji)um(h) gé(ih)nu(gh)it,(h.) (;)\r\nquem(k) Vir(k)go(i) ma(k)ter(klk) é(j)di(i)dit(hiHG_') (,)\r\nfe(i)cún(jk)da(i) San(ji)cto(h) Spí(ih)ri(gh)tu.(h.) (::)\r\nA(hih)men.(gh..) (::)",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)SOm(d)no(e) re(f)fé(g)ctis(eg) ár(f)tu(e)bus,(f) (,)\r\nspre(d)to(e) cu(f)bí(g)li,(eg) súr(f)gi(e)mus :(ded) (;)\r\nno(e)bis,(c) Pa(e)ter,(gh) ca(hi)nén(h)ti(g)bus(h) (,)\r\nad(f)es(h)se(h) te(g) de(ef)pó(g)sci(f)mus.(e) (::)\r\n\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Con(d)sors(e) pa(f)tér(g)ni(eg) lú(f)mi(e)nis,(f) (,)\r\nlux(d) i(e)pse(f) lu(g)cis(eg) et(f) di(e)es,(ded) (;)\r\nno(e)ctem(c) ca(e)nén(gh)do(hi) rúm(h)pi(g)mus :(h) (,) \r\nas(f)sí(h)ste(h) pos(g)tu(ef)lán(g)ti(f)bus.(e) (::) ",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)NOX(d) a(e)tra(f) ré(g)rum(eg) cón(f)te(e)git(f) (,)\r\nter(d)ræ(e) co(f)ló(g)res(eg) óm(f)ni(e)um :(ded) (;)\r\nnos(e) con(c)fi(e)tén(gh)tes(hi) pó(h)sci(g)mus(h) (,) \r\nte,(f) iu(h)ste(h) iu(g)dex(ef) cór(g)di(f)um,(e) (::) ",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)TU,(d) Tri(e)ni(f)tá(g)tis(eg) Ú(f)ni(e)tas,(f) (,)\r\nor(d)bem(e) po(f)tén(g)ter(eg) qui(f) re(e)gis,(ded) (;)\r\nat(e)tén(c)de(e) lau(gh)dum(hi) cán(h)ti(g)ca(h) (,) \r\nquæ(f) ex(h)cu(h)bán(g)tes(ef) psál(g)li(f)mus.(e) (::) ",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)SUm(d)mæ(e) De(f)us(g) cle(eg)mén(f)ti(e)æ(f) (,)\r\nmun(d)dí(e)que(f) fa(g)ctor(eg) má(f)chi(e)næ,(ded) (;)\r\nqui(e) tri(c)nus(e) al(gh)mo(hi) nú(h)mi(g)ne(h) (,) \r\nu(f)nús(h)que(h) fír(g)mas(ef) óm(g)ni(f)a,(e) (::) ",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Fe(f)lix(e) per(d) om(c!de)nes(e) (,) fe(e)stum(f) mun(g)di(fe) cár(d)di(cd)nes(d) (;)\r\na(f)po(gh)sto(h)ló(gh)rum(dc) (,) præ(f)pól(gh)let(g) a(fe)lá(d)cri(e)ter,(e) (:)\r\nPe(g)tri(h) be(j)á(j)ti,(jh) (,) Pau(h)li(hi) sa(g)cra(gf)tís(e)si(fg)mi,(g) (;)\r\nquos(g) Chri(hi)stus(h) al(gh)mo(h) (,) con(h)se(hi)crá(g)vit(ge) sán(f)gui(ed)ne,(de) (;)\r\nec(c)cle(d)si(f)á(ef)rum(d) (,) de(e)pu(f)tá(gh)vit(g) prín(fe)ci(de)pes.(e) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)A(f)po(f)sto(f)ló(fe)rum(dc) pás(de)si(e)o(e) (,)\r\n\r\ndi(g)em(gh) sa(hg)crá(hih)vit(gf) sæ(g)cu(gf)li,(e) (;)\r\n\r\nPe(f)tri(e) tri(fg)úm(gf)phum(dc) nó(de)bi(dc)lem,(c) (,)\r\n\r\nPau(g)li(g) co(f)ró(g)nam(ghg) præ(fe)fe(de)rens.(e) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
    { page: "390", sequence: 0, extent: 1 }
  ...
  },
  {
    ...
    gabc: "(f3)IN(ff)cli(e)tos(f!gwh) Chri(hg)sti(fg) fá(f)mu(f)los(e) ca(f)ná(h)mus,(h) (;)\r\nquos,(ih) fi(i)de(j) cla(ih)ros(hi) ni(i)ti(h)dís(f)que(g) ge(ff)stis,(e) (:)\r\nhac(f!gwhivHG) di(f)e(e) tel(h)lus(h) (,) so(i)ci(j)á(i)ta(h) cæ(ih)lo(fe) (,)\r\n        láu(h)di(g)bus(h) or(fe)nat.(f) (::)\r\n \r\n",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)MO-(h)le(hhg) gra(ed)vá(g)ti(hj) crí(ji)mi(hi)num(i_\\') (,)ad(k) te,(kj) re(i)gí(ji)na(h) c<sp>'ae</sp>(ih)li(gh)tum,(h.) (;)con(k)fu(k)gi(i)én(k)tes,(klk) pó(j)sci(i)mus(hiHG\\'_) (,)no(i)stris(jk) ut(i) ad(ji)sis(h) pré(ih)ci(gh)bus.(h.) (::)",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Ber(h)nár(hg)de,(ed) gem(g)ma(hj) cæ(ji)li(hi)tum,(i) (,)\r\nlau(k)des,(kj) ti(i)bi(ji) quas(h) pán(ih)gi(gh)mus,(h) (;)\r\nin(k) no(k)stra(i) ver(k)te(klk) gáu(j)di(i)a(hiHG) (,)\r\nsa(i)lú(jk)tis(i) at(ji)que(h) mú(ih)ne(gh)ra.(h) (::)",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)RE(g)rum(g) su(f)pré(e)m<i>o</i>() in(d) vér(fhg)ti(fg)ce(g) (,)\r\nre(h!iwji)gí(h)na,(g) Vir(h)go,(ig) sí(h)ste(g)ris,(f) (;)\r\nex(f)u(g)be(f)rán(g)ter(h) óm(j)ni(g)um(hih) (,)\r\ndi(h)tá(h)ta(g) pul(e)chri(f)tú(hg)di(fg)ne.(g) (::)\r\n",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)SI(h)gnum(hhg) cru(ed)cis(g) mi(h)rá(hi)bi(hg)le(h) (,)\r\nto(e)tum(eh) per(g) or(gf)bem(d) prǽ(e!fg)ni(fe)tet,(e) (;)\r\nin(ed) qua(c) pe(e)pén(g)dit(h) ín(hi)no(hg)cens(h) (,)\r\nChri(e)stus,(eh) red(g)ém(gf)ptor(d) óm(e!fg)ni(fe)um.(e) (::)\r\n\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Æ(ed)tér(g)ne(hj) re(j)rum(ij) cón(k)di(j)tor,(ih) (,)\r\nqui(g) ma(hj)re,(j) so(i)lum,(ji) æ(h)the(gi)ra(i) (;)\r\ngu(i)bér(g)nas,(hi) iu(i)stus(hj) réd(g)di(gf)tor(e) (,)\r\ncun(f)ctis(g) se(f)cún(g)dum(ghg) ó(fe)pe(de)ra,(e) (::)",
    office: "hy",
    mode: "3",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) IU(f)bi(f)lé(-fg)mus(f) De(f!gwh)o(-ghg) (,) sa(f)lu(gh)tá(gvFD)ri(fg) nos(g)tro.(f) (::) ",
    office: "an",
    mode: "6",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) TE(gh) lu(f)cis(g) an(g)te(h) tér(f)mi(g)num(g'_) (,) re(g)rum(h) cre(i)á(j)tor,(ih) pós(g)ci(i)mus,(i.) (;)\r\nut(h!iwj) só(i)li(h)ta(g) cle(h)mén(f)ti(h)a(h'_) (,) sis(g) præ(f)sul(h) ad(h) cus(g)tó(f)di(g)am.(g.) (::)",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) TE(h) lu(j)cis(j) an(j)te(j) tér(k)mi(j)num(i) (,)\r\nre(h)rum(h) cre(h)á(h)tor,(h) pós(i)ci(h)mus,(g) (;)\r\nut(i) só(i)li(h)ta(g) cle(f)mén(g)ti(h)a(h) (,)\r\nsis(h) præ(j)sul(j) ad(i) cus(h)tó(i)di(h)am.(g) (::)",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3)CHris(g)te,(g) qui,(fe) splen(f)dor(g) et(h) di(g)es(f'_) (,)\r\nNoc(f)tis(f) te(h)né(g)bras(e) dé(f)te(h)gis,(g.) (;)\r\nLu(h)cís(i)que(h) lu(g)men(f) cré(h)de(g)ris,(f'_) (,)\r\nLu(g)men(g) be(fe)á(f)tis(g) prǽ(h)di(g)cans,(f.) (::)\r\n\r\n2. Pre(g)cá(g)mur,(fe) sanc(f)te(g) Dó(h)mi(g)ne,(f'_) (,)\r\nHac(f) noc(f)te(h) nos(g) cus(e)tó(f)di(h)as;(g.) (;)\r\nSit(h) no(i)bis(h) in(g) te(f) ré(h)qui(g)es,(f'_) (,)\r\nQui(g)é(g)tas(fe) ho(f)ras(g) trí(h)bu(g)e.(f.) (::)\r\n\r\n3. Som(g)no(g) si(fe) dan(f)tur(g) ó(h)cu(g)li,(f'_) (,)\r\nCor(f) sem(f)per(h) ad(g) te(e) ví(f)gi(h)let;(g.) (;)\r\nTu(h)á(i)que(h) dex(g)tra(f) pró(h)te(g)gas(f'_) (,)\r\nFi(g)dé(g)les,(fe) qui(f) te(g) dí(h)li(g)gunt.(f.) (::)\r\n\r\n4. De(g)fén(g)sor(fe) nos(f)ter,(g) á(h)spi(g)ce,(f'_) (,)\r\nIn(f)si(f)di(h)án(g)tes(e) ré(f)pri(h)me,(g.) (;)\r\nGu(h)bér(i)na(h) tu(g)os(f) fá(h)mu(g)los,(f'_) (,)\r\nQuos(g) sán(g)gui(fe)ne(f) mer(g)cá(h)tus(g) es.(f.) (::)\r\n\r\n5. Sit,(g) Chris(g)te,(fe) rex(f) pi(g)ís(h)si(g)me,(f'_) (,)\r\nTi(f)bi(f) Pa(h)trí(g)que(e) gló(f)ri(h)a,(g.) (;)\r\nCum(h) Spí(i)ri(h)tu(g) Pa(f)rá(h)cli(g)to,(f'_) (,)\r\nIn(g) sem(g)pi(fe)tér(f)na(g) sǽ(h)cu(g)la.(f.) (::)\r\nA(ghg)men.(fg..) (::)",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c3) CHris(d)te,(e) qui,(fh) splen(h)dor(e) et(f) di(d)es(e'_) (,)\r\nnoc(h)tis(hg) te(f)né(h)bras(e) dé(fe)te(de)gis,(e.) (;)\r\nlu(h)cís(h)que(i) lum(j)en(h) cré(i)de(h)ris,(fe'__) (,)\r\nlu(e)men(e) be(d)á(c)tis(d) pr<sp>'æ</sp>(fe)di(de)cans,(e.) (::)\r\n2. Pre(d)cá(e)mur,(fh) sanc(h)te(e) Dó(f)mi(d)ne,(e'_) (,)\r\nHac(h) noc(hg)te(f) nos(h) cus(e)tó(fe)di(de)as;(e.) (;)\r\nSit(h) no(h)bis(i) in(j) te(h) ré(i)qui(h)es,(fe'__) (,)\r\nQui(e)é(e)tas(d) ho(c)ras(d) trí(fe)bu(de)e.(e.) (::)\r\n\r\n3. Som(d)no(e) si(fh) dan(h)tur(e) ó(f)cu(d)li,(e'_) (,)\r\nCor(h) sem(hg)per(f) ad(h) te(e) ví(fe)gi(de)let;(e.) (;)\r\nTu(h)á(h)que(i) dex(j)tra(h) pró(i)te(h)gas(fe'__) (,)\r\nFi(e)dé(e)les,(d) qui(c) te(d) dí(fe)li(de)gunt.(e.) (::)\r\n\r\n4. De(d)fén(e)sor(fh) nos(h)ter,(e) á(f)spi(d)ce,(e'_) (,)\r\nIn(h)si(hg)di(f)án(h)tes(e) ré(fe)pri(de)me,(e.) (;)\r\nGu(h)bér(h)na(i) tu(j)os(h) fá(i)mu(h)los,(fe'__) (,)\r\nQuos(e) sán(e)gui(d)ne(c) mer(d)cá(fe)tus(de) es.(e.) (::)\r\n\r\n5. Sit,(d) Chris(e)te,(fh) rex(h) pi(e)ís(f)si(d)me,(e'_) (,)\r\nTi(h)bi(hg) Pa(f)trí(h)que(e) gló(fe)ri(de)a,(e.) (;)\r\nCum(h) Spí(h)ri(i)tu(j) Pa(h)rá(i)cli(h)to,(fe'__) (,)\r\nIn(e) sem(e)pi(d)tér(c)na(d) sǽ(fe)cu(de)la.(e.) (::)\r\nA(efe)men.(de..) (::)",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)CHrist(d)um(dfd~) Dó(e)mi(e)num,(e/fgf/eeof/ded.) (,) pro(dfe) no(fg)bis(g) ten(g)tá(gh)tum(g) et(f) pas(ghGF)sum,(efEDd) (;) ve(c)ní(c!dwe/fv)te,(ed__) ad(-dfe)o(fg)ré(g_hGFg)mus.(fe..) (::)",
    office: "an",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3)HO(fhg)di(g)e,(g_') si(g) vo(gh)cem(g') Dó(g)mi(g)ni(hs<hs<hs<) au(hf~)di(-fhg)é(h)ri(i_h_iwjij)tis,(j.i.) (;) no(g_h)lí(i)te(h') ob(g)du(fe)rá(f)re(fs<hs<hs<iffe.) (,) cor(ggohf~)da(h) ve(hi)stra.(g.) (::)",
    office: "an",
    mode: "e",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Chri(c)stum,(de) De(edffe)i(dc) Fí(de)li(e)um,(e.) (,) qui(d) su(dh)o(hg) nos(hi) red(h)é(gh)mit(g) sán(fe>)gui(de)ne,(efe.) (;) ve(ef!gvFE)ní(de)te,(dc__) ad(gf__/gh_GFf)o(de)ré(e.)mus.(e.) (::)",
    office: "an",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)SUr(d)ré(f_0fg)xit(f) Dó(g)mi(fe)nus(f) ve(g_0h)re,(ixh_0i!/ggf.) (;) al(f!gwh>//)le(//ghffvED)lú(f!gwhgh>)ia.(gf..) (::) Ve(f_h)ni(j)te,(j) (::)",
    office: "an",
    mode: "6",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c3) Re(e_0f>_0)gem(e) an(e)ge(e)ló(eg)rum(h) Dó(ggf)mi(hf__@gwhGFE)num,(e/fge cco@dv.) (;) ve(b/ceof)ní(f)te,(hf__@gwhGFE.) ad(eec)o(de)ré(ec__do@ev)mus.(dc..) (::)",
    office: "an",
    mode: "3",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Fe(ed)stí(g)va(hj) vos,(j) ar(ij)chán(k)ge(j)li,(ih__) (,) \r\nhæc(g) nos(hj)tra(j) tol(i)lunt(ji) cán(h)ti(gi)ca,(i.) (;) \r\nquos(i) in(g) su(hi)pér(i)na(hj) cú(g)ri(gf)a(e'_) (,)\r\nin(f)sí(g)gnit(f) in(g)gens(ghg) gló(fVe)ri(de)a.(e.) (::)",
    office: "hy",
    mode: "3",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)CAp(f)tá(f)tor(f) o(fe)lim(dc) pí(de)sci(e)um,(e) (,)\r\niam(g) nunc(gh) pi(hg)scá(hih)tor(gf) hó(g)mi(gf)num,(e) (;)\r\ntu(f)is,(e) An(fg)dré(gf)a,(dc) ré(de)ti(dc)bus(c) (,)\r\nmun(g)di(g) nos(f) ra(g)pe(ghg) flú(fe)cti(de)bus.(e) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)VE(dh)ní(gh)te,(gf/gf/fe) ex(e)sul(f)té(g)mus(h) Dó(h)mi(g)no,(g_') (,) iu(g)bi(g)lé(g)mus(h) De(h)o,(g') sa(g)lu(f)tá(gh)ri(g) no(e_f)stro.(eed.) (;) Præ(d)oc(f)cu(d)pé(e)mus(f) fá(g)ci(g)em(h) e(h)ius(g_') (,) in(g) con(f)fes(gh)si(g)ó(e_f)ne,(fe..) (;) et(f) in(de~) psal(ef~)mis(e') (,) iu(e)bi(f)lé(ed)mus(f) e(ecd)i.(d/eed.::Z)\r\n\r\nQuó(dh)ni(gh)am(gf/gf/fe) De(e)us(f) ma(g)gnus(h) Dó(h)mi(g)nus,(g_') (,) et(g) rex(gh) ma(h)gnus(g') su(g)per(f) om(gh)nes(g) de(e_f)os.(eed.) (;) Quó(f)ni(d)am(e) non(f) re(g)pél(g)let(g) Dó(g)mi(g)nus(g) ple(g)bem(h) su(h)am,(g_') (,) qui(e)a(f) in(g) ma(g)nu(h) e(h)ius(g_') (,) sunt(h) om(g)nes(f) fi(gh)nes(g) ter(e_f)ræ,(fe..) (;) et(f) al(de~)ti(e)tú(e)di(e)nes(e) món(ef~)ti(e)um(e_') (,) i(f)pse(ed) cón(f)spi(ecd)cit.(d/eed.::Z)\r\n\r\nQuó(dh)ni(gh)am(gf/gf/fe) i(e)psí(f)us(g) est(g) ma(g)re,(g_') et(g) i(g)pse(g) fe(g)cit(h) il(h)lud,(g_') (,) et(e) á(f)ri(g)dam(g) fun(g)da(h)vé(g)runt(f) ma(gh)nus(g) e(e_f)ius.(eed.) (;) Ve(d)ní(f)te,(d) ad(e)o(f)ré(g)mus,(g_') et(g) pro(g)ci(g)dá(g)mus(g) an(g)te(h) De(h)um,(g_') (,) plo(e)ré(f)mus(g) co(g)ram(g) Dó(g)mi(g)no,(g) qui(h) fe(h)cit(g) nos,(g_') (,) qui(e)a(f) i(g)pse(g) est(h) Dó(h)mi(g)nus,(f) De(gh)us(g) no(e_f)ster,(fe..) (;) nos(f) au(de~)tem(e) pó(e)pu(e)lus(e) e(ef~)ius,(e_') (,) et(e) o(ef)ves(e) pá(f)scu(ed)æ(f) e(ecd)ius.(d/eed.::Z)\r\n\r\nHó(dh)di(gh)e,(gf/gf/fe) si(e) vo(f)cem(g) e(g)ius(g) au(g)di(h)é(h)ri(g)tis:(g_') (,) «No(e)lí(f)te(g) ob(g)du(h)rá(g)re(f) cor(gh)da(g) ve(e_f)stra,(eed.) (;) si(f)cut(d) in(e) ex(f)a(g)cer(g)ba(g)ti(g)ó(g)ne(g_') se(g)cún(g)dum(h) di(h)em(g_') (,) ten(e)ta(f)ti(g)ó(g)nis(g) in(g) de(h)sér(h)to:(g_') (,) u(e)bi(f) ten(g)ta(h)vé(h)runt(g) me(f) pa(gh)tres(g) ve(e_f)stri:(fe..) (;) pro(f)ba(de~)vé(e)runt(e) et(e) vi(e)dé(ef~)runt(e_') (,) ó(f)pe(ed)ra(f) me(ecd)a.(d/eed.::Z)\r\n\r\nQua(dh)dra(h)gín(gh)ta(gf/gf/fe) an(f)nis(g) pró(g)xi(g)mus(h) fu(h)i(g_') (,) ge(e)ne(f)ra(g)ti(h)ó(h)ni(g) hu(g)ic,(h_') (,) et(g) di(g)xi:(g') (`) Sem(h)per(g) hi(f) er(gh)rant(g) cor(e_f)de.(eed.) (;) I(f)psi(d) ve(e)ro(f) non(g) co(g)gno(g)vé(g)runt(g) vi(g)as(h) me(h)as:(g_') (,) qui(gh)bus(g') iu(h)rá(h)vi(g) in(f) i(gh)ra(g) me(e_f)a:(fe..) (;) Si(f) in(de~)tro(e)í(ef~)bunt(e_') (,) in(e) ré(f)qui(ed)em(f) me(ecd)am.»(d/eed.::Z)\r\n\r\nGló(dh)ri(gh)a(gf/gf/fe) Pa(ef)tri,(g) et(h) Fí(h)li(g)o,(g_') (,) et(h) Spi(g)rí(f)tu(gh)i(g) San(e_f)cto.(eed.) (;) Si(f)cut(d) e(e)rat(f) in(g) prin(h)cí(h)pi(g)o,(g_') (,) et(f) nunc,(gh) et(g) sem(e_f)per,(fe..) (;) et(f) in(de~) s{<sp>'ae</sp>}(ef)cu(e)la(e) sæ(e)cu(f)ló(ed)rum.(f) A(ecd)men.(d/eed.::Z)",
    office: "ps",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3)VE(f)ní(e)te,(f) ex(h)sul(h)té(h)mus(i) Dó(i)mi(h)no,(h_') (,) ju(f)bi(h)lé(h)mus(i) De(i)o,(h') sa(g)lu(f)tá(g)ri(h) no(gg)stro.(f.) (;) Præ(f)oc(e)cu(f)pé(h)mus(h) fá(h)ci(h)em(i) e(i)jus(h_') (,) in(g) con(f)fes(g)si(h)ó(gg)ne,(f.) (;) et(f) in(ec~) psal(ef~)mis(f_') (,) ju(f)bi(h)lé(gf)mus(h) e(gef)i.(f/ggf.) (::Z)\r\n\r\nQuó(f)ni(e)am(f) De(h)us(h) ma(h)gnus(i) Dó(i)mi(h)nus,(h_') (,) et(h) rex(hi) ma(i)gnus(h) su(g)per(f) om(g)nes(h) de(gg)os.(f.) (;) Quó(f)ni(e)am(f) non(h) re(h)pél(h)let(h) Dó(h)mi(h)nus(h) ple(h)bem(i) su(i)am,(h_') (,) qui(f)a(h) in(h) ma(h)nu(i) e(i)jus(h_') (,) sunt(h) om(g)nes(f) fi(g)nes(h) ter(gg)ræ,(f.) (;) et(f) al(ec~)ti(e)tú(ef)di(f)nes(f) món(fg~)ti(f)um(f_') (,) i(h)pse(gf) cón(h)spi(gef)cit.(f/ggf.) (::Z)\r\n\r\nQuó(f)ni(e)am(f) i(h)psí(h)us(h) est(i) ma(i)re,(h_') (,) et(f) i(h)pse(h) fe(h)cit(i) il(i)lud,(h_') (,) et(h) á(hi)ri(h)dam(h') fun(h)da(h)vé(g)runt(f) ma(g)nus(h) e(gg)jus.(f.) (;) Ve(f)ní(e)te,(f) a(h)do(h)ré(h)mus,(h_') et(h) pro(h)ci(h)dá(h)mus(h) an(h)te(i) De(i)um,(h_') (,) plo(f)ré(h)mus(h) co(h)ram(h) Dó(h)mi(h)no,(h) qui(i) fe(i)cit(h) nos,(h_') (,) qui(f)a(h) i(hi)pse(h) est(h_') Dó(h)mi(g)nus,(f) De(g)us(h) no(gg)ster,(f.) (;) nos(f) au(ec~)tem(e) pó(ef)pu(f)lus(f) e(fg~)jus,(f_') (,) et(f) o(fg)ves(f') pá(h)scu(gf)æ(h) e(gef)jus.(f/ggf.) (::Z)\r\n\r\nHó(f)di(e)e,(f) si(h) vo(h)cem(h) e(h)jus(h) au(h)di(i)é(i)ri(h)tis:(h_') (,) «No(h)lí(hi)te(h') ob(h)du(h)rá(g)re(f) cor(g)da(h) ve(gg)stra,(f.) (;) si(f)cut(e) in(f) e(h)xa(h)cer(h)ba(h)ti(h)ó(h)ne(h_') se(h)cún(h)dum(i) di(i)em(h_') (,) ten(f)ta(h)ti(h)ó(h)nis(h) in(h) de(i)sér(i)to:(h_') (,) u(hi)bi(h_') ten(h)ta(h)vé(h)runt(g) me(f) pa(g)tres(h) ve(gg)stri:(f.) (;) pro(f)ba(ec)vé(ef)runt(f) et(f) vi(f)dé(fg)runt(f_') (,) ó(h)pe(gf)ra(h) me(gef)a.(f/ggf.) (::Z)\r\n\r\nQua(f)dra(e)gín(f)ta(h) an(h)nis(h') pró(h)xi(h)mus(i) fu(i)i(h_') (,) ge(f)ne(h)ra(h)ti(i)ó(i)ni(h) hu(h)ic,(i') (,) et(h) di(i)xi:(h_) (`) Sem(h)per(g) hi(f) er(g)rant(h) cor(gg)de.(f.) (;) I(f)psi(e) ve(f)ro(h) non(h) co(h)gno(h)vé(h)runt(h) vi(h)as(i) me(i)as:(h_') (,) qui(hi)bus(h_') ju(h)rá(h)vi(g) in(f) i(g)ra(h) me(gg)a:(f.) (;) Si(f) in(ec~)tro(e)í(ef)bunt(f_') (,) in(f) ré(h)qui(gf)em(h) me(gef)am.»(f/ggf.) (::Z)\r\n\r\nGló(f)ri(e)a(f) Pa(h)tri,(h) et(i) Fí(i)li(h)o,(h_') (,) et(h) Spi(g)rí(f)tu(g)i(h) San(gg)cto.(f.) (;) Si(f)cut(e) e(f)rat(h) in(h) prin(i)cí(i)pi(h)o,(h_') (,) et(gf~) nunc,(g) et(h) sem(gg)per,(f.) (;) et(f) in(ec~) sǽ(ef)cu(f)la(f) sæ(f)cu(h)ló(gf)rum.(h) A(gef)men.(f/ggf.) (::)\r\n",
    office: "ps",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c3) Re(f)gem(d) ven(fh~)tú(h)rum(hf__) Dó(f_h/ihih)mi(g_hGF)num,(f!gwh_GEde!fvfe.) (;) ve(d)ní(fef)te,(f!gwhg/hih) a(ffe)do(e_f)ré(fvEDC____/dw@ed@e)mus.(ed..) (::) Ps. V{e}(h)ní(h)t{e}, <i>p. 146.</i>(hi/hshsfgf) (::)",
    office: "an",
    mode: "5",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) Re(f)gem(f) ven(f)tú(fg)rum(g) Dó(gf)mi(g)num,(gh..) (;) ve(h)ní(gf)te,(gh) a(g_h_GF__)do(fg)ré(g.)mus.(f.) (::) Ps. V{e}(h)ní(g)t{e}, <i>p. 149.</i>(h) (::)",
    office: "an",
    mode: "6",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) U{R}bs(e) Ie(ed)rú(f)sa(dc)lem(d) be(f)á(fd)ta,(e.) (,) di(d)cta(f) pa(h)cis(g) ví(fe)si(d)o,(e.) (;) quæ(e) con(g)strú(h)i(g)tur(hj) in(g) cæ(hvGF)lis(e.) (,) vi(d)vis(f) ex(h) la(g)pí(fe)di(d)bus,(e.) (:)  an(e)ge(ed)lís(f)que(dc) co(d)ro(f)ná(fd)ta(e.) (,) sic(d)ut(f) spon(h)sa(g) có(fe)mi(d)te,(e.) \r\n\r\n2.(::) No(e)va(ed) vé(f)ni(dc)ens(d) e(f) cæ(fd)lo,(e.) (,) nup(d)ti(f)á(h)li(g) thá(fe)la(d)mo(e.) (;) præ(e)pa(g)rá(h)ta,(g) ut(hj) in(g)tác(hvGF)ta(e.) (,) co(d)pu(f)lé(h)tur(g) Dó(fe)mi(d)no.(e.) (:) Pla(e)té(ed)æ(f) et(dc) mu(d)ri(f) e(fd)ius(e.) (,) ex(d) au(f)ro(h) pu(g)rís(fe)si(d)mo ;(e.) \r\n\r\n3.(::) Por(e)tæ(ed) ni(f)tent(dc) mar(d)ga(f)rí(fd)tis,(e.) (,) á(d)dy(f)tis(h) pa(g)tén(fe)ti(d)bus,(e.) (;) et(e) vir(g)tú(h)te(g) me(hj)ri(g)tó(hvGF)rum(e.) (,) il(d)luc(f) in(h)tro(g)dú(fe)ci(d)tur(e.) (:) o(e)mnis(dc) qui(f) ob(dc) Chri(d)sti(f) no(fd)men(e.) (,) hic(d) in(f) mun(h)do(g) pré(fe)mi(d)tur.(e.) \r\n\r\n4.(::) Tun(e)si(ed)ó(f)ni(dc)bus,(d) pres(f)sú(fd)ris(e.) (,) ex(d)po(f)lí(h)ti(g) lá(fe)pi(d)des(e.) (;) su(e)is(g) co(h)ap(g)tán(hj)tur(g) lo(hvGF)cis(e.) (,) per(d) ma(f)num(h) ar(g)tí(fe)fi(d)cis ;(e.) (:) di(e)spo(ed)nún(f)tur(dc) per(d)man(f)sú(fd)ri(e.) (,) sa(d)cris(f) æ(h)di(g)fí(fe)ci(d)is.(e.) \r\n\r\n5.(::) Gló(e)ri(ed)a(f) et(dc) ho(d)nor(f) De(fd)o(e.) (,) us(d)que(f)qu{á}(h)qu<i>e</i> {a}l(g)tís(fe)si(d)mo,(e.) (;) u(e)na(g) Pa(h)tri(g) Fi(hj)li(g)ó(hvGF)que(e.) (,) at(d)que(f) Sanc(h)to(g) Flá(fe)mi(d)ni,(e.) (:) qui(e)bus(ed) laud(f)es(dc) et(d) po(f)té(fd)stas(e.) (,) per(d) æ(f)tér(h)na(g) s<sp>'ae</sp>(fe)cu(d)la.(e.) (::) A(efe)men.(de..) (::)",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Ad(h)ór(hhg)na,(ed) Si(g)on,(h) thá(hi)la(hg)mum,(h'_) (,)\r\nquæ(e) præ(eh)sto(g)lá(gf)ris(d) Dó(e/fg)mi(fe)num;(e.) (;) \r\nspon(ed)sum(c) et(e) spon(g)sam(h) sú(hi)sci(hg)pe(h'_) (,)\r\nvi(e)gil(eh) fí(g)de(gf)i(d) lú(e/fg)mi(fe)ne.(e.) (:)",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)A(g)gnós(g)cat(f) om(e)ne(d) sǽ(fhg)cu(fg)lum(g.) (,)\r\nve(hiwji)nís(h)se(g) vi(h)tæ(ig) prǽ(h)mi(g)um;(f.) (;) \r\npost(f) hos(g)tis(f) ás(g)pe(h)ri(j) iu(g)gum(hih_') (,) \r\nap(h)pá(h)ru(g)it(e) red(f)émp(hg)ti(fg)o.(g.) (::)",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c3)CHris(e)te,(ef) splen(fe)dor(dc) Pa(de)tris,(e.) (,)\r\nDe(f)i(h) ma(hg)ter(fe) Vir(de)go,(e.) (;)\r\nIo(h)seph,(ij) tam(j) sa(ih)cró(i)rum(ivHFE.) (,)\r\nPí(fh)gno(f)rum(fe) ser(dc)vá(de)tor.(e.) (::)\r\n2. Ni(e)tet(ef) ves(fe)tra(dc) do(de)mus(e.) (,)\r\nFló(f)ri(h)bus(hg) vir(fe)tú(de)tum,(e.) (;)\r\nUn(h)de(ij) gra(j)ti(ih)á(i)rum(ivHFE.) (,)\r\nFons(fh) pro(f)má(fe)nat(dc) ip(de)se.(e.) (::)\r\n3. An(e)ge(ef)li(fe) stu(dc)pén(de)tes(e.) (,)\r\nNa(f)tum(h) De(hg)i(fe) cer(de)nunt(e.) (;)\r\nSer(h)vi(ij) for(j)<i>ma</i>() ind(ih)ú(i)tum(ivHFE.) (,)\r\nSer(fh)vis(f) fa(fe)mu(dc)lán(de)tem.(e.) (::)\r\n4. I(e)mus(ef) præ(fe)es,(dc) Io(de)seph,(e.) (,)\r\nHu(f)mi(h)lís(hg)que(fe) iu(de)bes;(e.) (;)\r\nIu(h)bes(ij) et(j) Ma(ih)rí(i)a(ivHFE.) (,)\r\nEt(fh) u(f)trí(fe)que(dc) ser(de)vis.(e.) (::)\r\n5. Cunc(e)tis(ef) præ(fe)stant(dc) au(de)lis(e.) (,)\r\nHæc(f) e(h)gé(hg)na(fe) sæp(de)ta,(e.) (;)\r\nSa(h)lus(ij) un(j)de(ih) cœ(i)pit(ivHFE.) (,)\r\nGé(fh)ne(f)ris(fe) hu(dc)má(de)ni.(e.) (::)\r\n6. Ie(e)su,(ef) Ma(fe)ter,(dc) Io(de)seph,(e.) (,)\r\nMan(f)si(h)ó(hg)nis(fe) ves(de)træ(e.) (;)\r\nNos(h)tras(ij) da(j)te(ih) se(i)des(ivHFE.) (,)\r\nDo(fh)nis(f) fru(fe)i(dc) sanc(de)tis.(e.) (::)\r\n7. Ti(e)bi(ef) lau(fe)des,(dc) Chris(de)te,(e.) (,)\r\nSpem(f) qui(h) no(hg)bis(fe) præ(de)bes,(e.) (;)\r\nTu(h)os(ij) per(j) pa(ih)rén(i)tes(ivHFE.) (,)\r\nCæ(fh)l<i>i</i>() ad(f)í(fe)re(dc) do(de)mum.(e.) (::)\r\nA(efe)men.(de..) (::)",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)CO(f)hors(f) be(f)á(fe)ta(dc) Sé(de)ra(e)phim(e_) (,)\r\nQuem(g) Chris(gh)tus(hg) arc(hih)te(gf) dí(g)li(gf)git(e.) (;)\r\nLau(f)det,(e) cho(fg)rús(gf)que(dc) cán(de)ti(dc)cis(c_) (,)\r\nNos(g)ter(g) re(f)súl(g)tet(ghg) ǽ(fe)mu(de)lis.(e.) (::)\r\n2. Hic(f) di(f)scit,(f) al(fe)mus(dc) é(de)do(e)cet(e_) (,)\r\nHic(g) un(gh)de(hg) Ver(hih)bum(gf) pród(g)e(gf)at,(e.) (;)\r\nSi(f)núm(e)que(fg) ma(gf)tris(dc) ím(de)ple(dc)at,(c_) (,)\r\nSi(g)num(g) Pa(f)tris(g) non(ghg) dé(fe)se(de)rens.(e.) (::)\r\n3. Fe(f)lix(f) Io(f)án(fe)nes,(dc) dí(de)li(e)git(e_) (,)\r\nEt(g) te(gh) Ma(hg)gís(hih)ter(gf) pró(g)vi(gf)dus,(e.) (;)\r\nUt(f) cla(e)ra(fg) Tha(gf)bor(dc) lú(de)mi(dc)na(c_) (,)\r\nHor(g)tí(g)que(f) cer(g)nas(ghg) tǽ(fe)di(de)a.(e.) (::)\r\n4. Tu,(f) rap(f)tus(f) in(fe) sub(dc)lí(de)mi(e)a,(e_) (,)\r\nAr(g)cá(gh)na(hg) cæ(hih)li(gf) cón(g)spi(gf)cis,(e.) (;)\r\nA(f)gni(e) sed(fg) et(gf) mys(dc)té(de)ri(dc)a(c_) (,)\r\nEc(g)cle(g)si(f)ǽ(g)que(ghg) pér(fe)ci(de)pis.(e.) (::)\r\n5. O(f) di(f)gne(f) fi(fe)li(dc) Vír(de)gi(e)ne,(e_) (,)\r\nSuc(g)cés(gh)sor(hg) al(hih)ti(gf) nó(g)mi(gf)nis,(e.) (;)\r\nNos(f) ad(e)de(fg) Ma(gf)tri(dc) fí(de)li(dc)os,(c_) (,)\r\nNos(g) con(g)de(f) Chris(g)t<i>i</i>() in(ghg) péc(fe)to(de)re.(e.) (::)\r\n6. Ver(f)bo(f) sit(f) in(fe)gens(dc) gló(de)ri(e)a,(e_) (,)\r\nCa(g)ro(gh) quod(hg) est(hih) et(gf) cré(g)di(gf)tur,(e.) (;)\r\nCum(f) Pa(e)tr<i>e</i>() et(fg) al(gf)mo(dc) Spí(de)ri(dc)tu(c_) (,)\r\nIn(g) sem(g)pi(f)tér(g)na(ghg) sǽ(fe)cu(de)la.(e.) (::)\r\nA(efe)men.(de..) (::)",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) AU(f)dit(f) ty(gh)rán(h)nus(gh) án(g)xi(gf)us(f_) (,)\r\nad(h)és(j)se(k) re(j)gum(ij) prín(h)ci(g)pem,(hg..) (;)\r\nqui(f) no(f)men(g) Is(d)ra(c)el(fg) re(gf)gat(f.) (,)\r\nt{e}n<i>e</i>(f)át(f)que(gh) Da(h)vid(gh) ré(g)gi(gf)am.(f.) (::)\r\n\r\n2. Ex(f)clá(f)mat(gh) a(h)mens(gh) nún(g)ti(gf)o :(f_) (,) \r\n«Suc(h)cés(j)sor(k) in(j)stat,(ij) pél(h)li(g)mur ;(hg..) (;)\r\nsa(f)tél(f)les,(g) i,(d) fer(c)rum(fg) ra(gf)pe,(f.) (,)\r\nper(f)fún(f)de(gh) cu(h)nas(gh) sán(g)gui(gf)ne!»(f.) (::)\r\n\r\n3. Quo(f) pró(f)fi(gh)cit(h) tan(gh)tum(g) ne(gf)fas ?(f_) (,)\r\nQuid(h) cri(j)men(k) He(j)ró(ij)dem(h) iu(g)vat ?(hg..) (;)\r\nU(f)nus(f) tot(g) in(d)ter(c) fú(fg)ne(gf)ra(f.) (,)\r\nim(f)pú(f)ne(gh) Chris(h)tus(gh) tól(g)li(gf)tur.(f.) (::)\r\n\r\n4. Sal(f)vé(f)te,(gh) flo(h)res(gh) már(g)ty(gf)rum,(f_) (,)\r\nquos(h) lu(j)cis(k) {i}ps<i>o</i>(j) in(ij) lí(h)mi(g)ne(hg..) (;)\r\nChr{i}st<i>i</i>(f) in(f)se(g)cú(d)tor(c) sús(fg)tu(gf)lit. (f.)(,)\r\nceu(f) tur(f)bo(gh) na(h)scén(gh)tes(g) ro(gf)sas.(f.) (::)\r\n\r\n5. Vos(f) pri(f)ma(gh) Chris(h)ti(gh) víc(g)ti(gf)ma,(f_) (,)\r\ngrex(h) im(j)mo(k)la(j)tó(ij)rum(h) te(g)ner,(hg..) (;)\r\na(f)ram(f) sub(g) ip(d)sam(c) sím(fg)pli(gf)ces(f.) (,)\r\np{a}lm<i>a</i>(f) et(f) co(gh)ró(h)nis(gh) lú(g)di(gf)tis.(f.) (::)\r\n\r\n6. Ie(f)su,(f) ti(gh)bi(h) sit(gh) gló(g)ri(gf)a,(f_) (,)\r\nqui(h) na(j)tus(k) es(j) de(ij) Vír(h)gi(g)ne,(hg..) (;)\r\ncum(f) P{a}tr<i>e</i>(f) et(g) al(d)mo(c) Spí(fg)ri(gf)tu,(f.) (,)\r\nin(f) sem(f)pi(gh)tér(h)na(gh) sǽ(g)cu(gf)la.(f.) (::)\r\nA(fgf)men.(ef..) (::)",
    office: "hy",
    mode: "6",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)QUos(ghg) De(e)i(f) vi(ed)vax(de) pé(c)ni(e)tus(g) re(h)vín(h.)xit(g.) (;)\r\ncá(ghg)ri(e)tas(f) o(ed)lim(de) te(c)nu(e)ít(g)qu<i>e</i>() a(h)mí(h.)cos,(g.) (:)\r\nu(ji)na(h) vos(j) in(ih)gens(gf) si(h)mul,(j) o(i) be(h)á(g)ti,(hih_1',)\r\ngló(g_)ri(e)a(f) cin(g.)git.(g.) (::)",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3) MA(e)ter(ef)ni(f)tá(f/ghf)tem(fe__) Vír(f)gi(hg)nis(hfgff) Ma(ef)rí(f/ghf)æ(fe__) ce(f)le(hg)bré(h_iHG)mus : (g.) *(;) Chri(i)stum(ij) e(kxj/kij>)jus(hg) Fí(hi)li(hv_GF)um(f/ghf/gffe.) (,) ad(h)o(gf)ré(fiih)mus(gf) Dó(ghf)mi(ef)num.(f.) (::)",
    office: "an",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)DUM(ed) sa(g)cer(hi)dó(i_')tum(i_) (,) cé(j)le(h)brant(gf) fi(de)dé(e.)les(e.) (;)\r\nFes(ijh)ta(g) sol(hi)lém(i'_)ni(i_) (,) ve(j)ne(h)rán(gh)da(ef) cul(g.)tu,(g.) (:)\r\nIn(g) tu(h)as(ih) lau(i'_)des(i_) (,) ho(k)nor(ji) hic(g) red(f)ún(gh)dat,(h.) (,)\r\nSum(hg)me(fe) Sa(de)cér(e.)dos.(e.) (::)\r\n\r\n2. Cu(ed)ius(g) ex(hi) do(i_')no(i_) (,) pot(j)u(h)é(gf)re(de) pa(e.)tres(e.) (;)\r\nSé(ijh)mi(g)tas(hi) lu(i'_)cis(i_) (,) pó(j)pu(h)los(gh) do(ef)cé(g.)re,(g.) (:)\r\nMó(g)ri(h)bus(ih) sanc(i'_)tis(i_) (,) ré(k)ge(ji)r<i>e</i>() at(g)que(f) ver(gh)bo(h.) (,)\r\nPá(hg)sce(fe)re(de) vi(e.)tæ.(e.) (::)\r\n\r\n3. Sed(ed) nec(g) ad(hi)vér(i_')sis(i_) (,) pót(j)e(h)rant(gf) mo(de)vé(e.)ri(e.) (;)\r\nA(ijh) tu(g)æ(hi) cer(i'_)to(i_) (,) fí(j)de(h)i(gh) te(ef)nó(g.)re,(g.) (:)\r\nQuos(g) fu(h)tu(ih)ró(i'_)rum(i_) (,) ra(k)ta(ji) præ(g)mi(f)ó(gh)rum(h.) (,)\r\nSpes(hg) a(fe)ni(de)má(e.)bat.(e.) (::)\r\n\r\n4. Un(ed)de(g) post(hi) vi(i_')tæ(i_) (,) frá(j)gi(h)lis(gf) la(de)bó(e.)res(e.) (;)\r\nRi(ijh)te(g) de(hi)cúr(i'_)sos,(i_) (,) pá(j)tri(h)as(gh) ad(ef)ép(g.)ti(g.) (:)\r\nCǽ(g)li(h)tus(ih) se(i'_)des,(i_) (,) só(k)li(ji)da(g) be(f)á(gh)ti(h.) (,)\r\nPa(hg)ce(fe) fru(de)ún(e.)tur.(e.) (::)\r\n\r\n5. Gló(ed)ri(g)æ(hi) sum(i_')mum(i_) (,) de(j)cus(h) at(gf)que(de) lau(e.)dis,(e.) (;)\r\nRex,(ijh) ti(g)bi,(hi) re(i'_)gum,(i_) (,) Dé(j)i(h)tas(gh) per(ef)én(g.)nis,(g.) (:)\r\nQuic(g)quid(h) est(ih) re(i'_)rum(i_) (,) cé(k)le(ji)bret(g) per(f) om(gh)ne(h.) (,)\r\nTem(hg)pus(fe) et(de) æ(e.)vum.(e.) (::)\r\nA(efe)men.(de..) (::)",
    office: "hy",
    mode: "3",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) IM(dh)plén(g)te(h) mu(ji)nus(hh) dé(g)bi(h)tum(h.) (,)\r\nJo(hg)án(e)ne,(gf) re(ed)rum(dg) cón(hg)di(f)tor(e.) (;)\r\nJor(dh)dá(h)ne(gj) mer(jji)sus(hg) hac(f) di(g)e(hvGFED.) (,)\r\nA(fg)quam(h) la(f)ván(gf)do(ed) dí(ghg)lu(fe)it,(d.) (::)\r\n\r\n2. Non(dh) ip(g)se(h) mun(ji)dá(hh)ri(g) vo(h)lens(h.) (,)\r\nDe(hg) ven(e)tre(gf) na(ed)tus(dg) Vír(hg)gi(f)nis,(e.) (;)\r\nPec(dh)cá(h)ta(gj) sed(jji) mor(hg)tá(f)li(g)um(hvGFED.) (,)\r\nSu(fg)o(h) la(f)vá(gf)cro(ed) tól(ghg)le(fe)re.(d.) (::)\r\n\r\n3. Di(dh)cén(g)te(h) Pa(ji)tre(hh) quod(g) me(h)us(h.) (,)\r\nDi(hg)léc(e)tus(gf) hic(ed) est(dg) Fí(hg)li(f)us,(e.) (;)\r\nSu(dh)mén(h)te(gj) Sanc(jji)to(hg) Spí(f)ri(g)tu(hvGFED.) (,)\r\nFor(fg)mam(h) co(f)lúm(gf)bæ(ed) cǽ(ghg)li(fe)tus,(d.) (::)\r\n\r\n4. Hoc(dh) mýs(g)ti(h)co(ji) sub(hh) nó(g)mi(h)ne(h.) (,)\r\nMi(hg)cat(e) sa(gf)lus(ed) Ec(dg)clé(hg)si(f)æ;(e.) (;)\r\nPer(dh)só(h)na(gj) tri(jji)na(hg) cóm(f)ma(g)net(hvGFED.) (,)\r\nU(fg)nus(h) De(f)us(gf) per(ed) óm(ghg)ni(fe)a.(d.) (::)\r\n\r\n5. O(dh) Chris(g)te,(h) vi(ji)ta,(hh) vé(g)ri(h)tas,(h.) (,)\r\nTi(hg)bi(e) sit(gf) om(ed)nis(dg) gló(hg)ri(f)a,(e.) (;)\r\nQuem(dh) Pa(h)tris(gj) at(jji)que(hg) Spí(f)ri(g)tus(hvGFED.) (,)\r\nSplen(fg)dor(h) re(f)vé(gf)lat(ed) cǽ(ghg)li(fe)tus.(d.) (::)\r\nA(ded)men.(cd) (::)",
    office: "hy",
    mode: "1",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) Æ(g)tér(g!hwih)ne(gf) Rex(hg) al(h!iwji)tís(hg)si(fg)me,(g.) (;)\r\nRed(g)émp(ih)tor(jk) et(k) fi(ji)dé(hg)li(hj)um,(j.) (:)\r\nQuo(j) mors(h) so(i)lú(g)ta(gh) dé(hg)per(fg)it,(g.) (;)\r\nDa(f)tur(hg) tri(hj)úm(ji)phus(hg) grá(hg)ti(fg)æ.(g.) (::)\r\n\r\n2. Scan(g)dis(g!hwih) tri(gf)bú(hg)nal(h!iwji) déx(hg)te(fg)ræ(g.) (;)\r\nPa(g)tris,(ih) ti(jk)bí(k)que(ji) cǽ(hg)li(hj)tus(j.) (:)\r\nFer(j)tur(h) pot(i)és(g)tas(gh) óm(hg)ni(fg)um,(g.) (;)\r\nQuæ(f) non(hg) e(hj)rat(ji) hu(hg)má(hg)ni(fg)tus.(g.) (::)\r\n\r\n3. Ut(g) tri(g!hwih)na(gf) re(hg)rum(h!iwji) má(hg)chi(fg)na,(g.) (;)\r\nCæ(g)lés(ih)ti(jk)um,(k) ter(ji)rés(hg)tri(hj)um,(j.) (:)\r\nEt(j) in(h)fe(i)ró(g)rum(gh) cón(hg)di(fg)ta,(g.) (;)\r\nFlec(f)tat(hg) ge(hj)nu(ji) iam(hg) súb(hg)di(fg)ta.(g.) (::)\r\n\r\n4. Tre(g)munt(g!hwih) vi(gf)dén(hg)tes(h!iwji) án(hg)ge(fg)li(g.) (;)\r\nVer(g)sam(ih) vi(jk)cem(k) mor(ji)tá(hg)li(hj)um:(j.) (:)\r\nCul(j)pat(h) ca(i)ro,(g) pur(gh)gat(hg) ca(fg)ro,(g.) (;)\r\nRe(f)gnat(hg) ca(hj)ro(ji) Ver(hg)bum(hg) De(fg)i.(g.) (::)\r\n\r\n5. Tu,(g) Chris(g!hwih)te,(gf) nos(hg)trum(h!iwji) gáu(hg)di(fg)um,(g.) (;)\r\nMa(g)nens(ih) per(jk)én(k)ne(ji) prǽ(hg)mi(hj)um,(j.) (:)\r\nMun(j)di(h) re(i)gis(g) qui(gh) fá(hg)bri(fg)cam,(g.) (;)\r\nMun(f)dá(hg)na(hj) vin(ji)cens(hg) gáu(hg)di(fg)a.(g.) (::)\r\n\r\n6. Hinc(g) te(g!hwih) pre(gf)cán(hg)tes,(h!iwji) quǽ(hg)su(fg)mus,(g.) (;)\r\nI(g)gnó(ih)sce(jk) cul(k)pis(ji) óm(hg)ni(hj)bus,(j.) (:)\r\nEt(j) cor(h)da(i) sur(g)sum(gh) súb(hg)le(fg)va(g.) (;)\r\nAd(f) te(hg) su(hj)pér(ji)na(hg) grá(hg)ti(fg)a.(g.) (::)\r\n\r\n7. Ut,(g) cum(g!hwih) ru(gf)bén(hg)te(h!iwji) cœ(hg)́per(fg)is(g.) (;)\r\nCla(g)ré(ih)re(jk) nu(k)be(ji) iú(hg)di(hj)cis,(j.) (:)\r\nPœ(j)nas(h) re(i)pél(g)las(gh) dé(hg)bi(fg)tas,(g.) (;)\r\nRed(f)das(hg) co(hj)ró(ji)nas(hg) pér(hg)di(fg)tas.(g.) (::)\r\n\r\n8. Ie(g)su,(g!hwih) ti(gf)bi(hg) sit(h!iwji) gló(hg)ri(fg)a,(g.) (;)\r\nQui(g) scan(ih)dis(jk) ad(k) cæ(ji)lés(hg)ti(hj)a,(j.) (:)\r\nCum(j) Pa(h)tr<i>e</i>,() et(i) al(g)mo(gh) Spí(hg)ri(fg)tu,(g.) (;)\r\nIn(f) sem(hg)pi(hj)tér(ji)na(hg) sǽ(hg)cu(fg)la.(g.) (::)\r\nA(ghg)men.(fg..) (::)",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)JE(ed)su,(g) auc(hj)tor(jji) cle(hg)mén(hi)ti(hg)æ,(g.) (,)\r\nTo(g)tí(i!jk)us(j) spes(ji) læ(hg)tí(h)ti(gf)æ,(ed..) (;)\r\nDul(dh)có(h)ris(g) fons(h!iwji) et(hg) grá(hi)ti(hg)æ,(g.) (,)\r\nVe(h)ræ(h) cor(g)dis(fe) de(d)lí(e!fg)ci(fe)æ.(e.) (::)\r\n\r\n2. Je(ed)su,(g) spes(hj) pæ(jji)ni(hg)tén(hi)ti(hg)bus,(g.) (,)\r\nQuam(g) pi(i!jk)us(j) es(ji) pe(hg)tén(h)ti(gf)bus,(ed..) (;)\r\nQuam(dh) bo(h)nus(g) te(h!iwji) quæ(hg)rén(hi)ti(hg)bus;(g.) (,)\r\nSed(h) quid(h) in(g)ve(fe)ni(d)én(e!fg)ti(fe)bus?(e.) (::)\r\n\r\n3. Tu(ed)a,(g) Je(hj)su,(jji) di(hg)léc(hi)ti(hg)o,(g.) (,)\r\nGra(g)ta(i!jk) men(j)tis(ji) re(hg)féc(h)ti(gf)o,(ed..) (;)\r\nRe(dh)plet(h) si(g)ne(h!iwji) fas(hg)tí(hi)di(hg)o,(g.) (,)\r\nDans(h) fa(h)mem(g) de(fe)si(d)dé(e!fg)ri(fe)o.(e.) (::)\r\n\r\n4. O(ed) Je(g)su(hj) di(jji)lec(hg)tís(hi)si(hg)me,(g.) (,)\r\nSpes(g) su(i!jk)spi(j)rán(ji)tis(hg) á(h)ni(gf)mæ,(ed..) (;)\r\nTe(dh) quæ(h)runt(g) pi(h!iwji)æ(hg) lá(hi)cri(hg)mæ,(g.) (,)\r\nTe(h) cla(h)mor(g) men(fe)tis(d) ín(e!fg)ti(fe)mæ.(e.) (::)\r\n\r\n5. Ma(ed)ne(g) no(hj)bís(jji)cum,(hg) Dó(hi)mi(hg)ne,(g.) (,)\r\nMa(g)ne(i!jk) no(j)vum(ji) cum(hg) lú(h)mi(gf)ne,(ed..) (;)\r\nPul(dh)sa(h) noc(g)tis(h!iwji) ca(hg)lí(hi)gi(hg)ne(g.) (,)\r\nMun(h)dum(h) re(g)plens(fe) dul(d)cé(e!fg)di(fe)ne.(e.) (::)\r\n\r\n6. Je(ed)su,(g) sum(hj)ma(jji) be(hg)ní(hi)gni(hg)tas,(g.) (,)\r\nMi(g)ra(i!jk) cor(j)dis(ji) ju(hg)cún(h)di(gf)tas,(ed..) (;)\r\nIn(dh)com(h)pre(g)hén(h!iwji)sa(hg) bó(hi)ni(hg)tas,(g.) (,)\r\nTu(h)a(h) nos(g) strin(fe)git(d) cá(e!fg)ri(fe)tas.(e.) (::)\r\n\r\n7. Je(ed)su,(g) flos(hj) Ma(jji)tris(hg) vír(hi)gi(hg)nis,(g.) (,)\r\nA(g)mor(i!jk) nos(j)træ(ji) dul(hg)cé(h)di(gf)nis,(ed..) (;)\r\nLaus(dh) ti(h)bi(g) si(h!iwji)ne(hg) tér(hi)mi(hg)nis,(g.) (,)\r\nRe(h)gnum(h) be(g)a(fe)ti(d)tú(e!fg)di(fe)nis.(e.) (::)\r\nA(efe)men.(de..) (::)",
    office: "hy",
    mode: null,
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)CHris(ed)te(g) pas(hi)tó(i'_)rum(i_) (,) ca(j)put(h) at(gf)que(de) prin(e.)ceps,(e.) (;)\r\nGés(ijh)ti(g)ens(hi) hu(i'_)jus(i_) (,) ce(j)le(h)brá(gh)re(ed) fes(g.)tum,(g.) (:)\r\nDé(g)bi(h)tas(ih) sa(i'_)cro(i_) (,) pi(k)a(ji) tur(g)ba(f) psal(gh)lit(h.) (,)\r\nCár(hg)mi(fe)ne(de) lau(e.)des.(e.) (::)\r\n\r\n2. Hunc(ed) ti(g)b<i>i</i>() e(hi)léc(i'_)tum(i_) (,) fá(j)ci(h)ens(gf) mi(de)nís(e.)trum(e.) (;)\r\nAc(ijh) sa(g)cer(hi)dó(i'_)tem(i_) (,) só(j)ci(h)ans,(gh) de(ed)dís(g.)ti(g.) (:)\r\nDux(g) ut(h) a(ih)stá(i'_)ret(i_) (,) pó(k)pu(ji)lo(g) fi(f)dé(gh)lis(h.) (,)\r\nAc(hg) bo(fe)nus(de) al(e.)tor.(e.) (::)\r\n\r\n3. Hic(ed) gre(g)gis(hi) duc(i'_)tor(i_) (,) fu(j)it(h) at(gf)que(de) for(e.)ma,(e.) (;)\r\nLux(ijh) e(g)rat(hi) cæ(i'_)co,(i_) (,) mí(j)se(h)ro(gh) le(ed)vá(g.)men,(g.) (:)\r\nPró(g)vi(h)dus(ih) cunc(i'_)tis(i_) (,) pa(k)ter(ji) om(g)ni(f)bús(gh)que(h.) (,)\r\nOm(hg)ni(fe)a(de) fac(e.)tus.(e.) (::)\r\n\r\n4. Chris(ed)te,(g) qui(hi) sanc(i'_)tis(i_) (,) mé(j)ri(h)tam(gf) co(de)ró(e.)nam(e.) (;)\r\nRed(ijh)dis(g) in(hi) cæ(i'_)lis,(i_) (,) dó(j)ci(h)li(gh) ma(ed)gís(g.)trum(g.) (:)\r\nFac(g) se(h)qui(ih) vi-(i'_)ta,(i_) (,) si(k)mi(ji)lí(g)que(f) tan(gh)dem(h.) (,)\r\nFi(hg)ne(fe) po(de)tí(e.)ri.(e.) (::)\r\n\r\n5. Æ(ed)qua(g) laus(hi) sum(i'_)mum(i_) (,) cé(j)le(h)bret(gf)\r\nPa(de)rén(e.)tem(e.) (;) te(ijh)que,(g) Sal(hi)vá(i'_)tor,(i_) (,) pi(j)e(h) rex,(gh)\r\nPer(ed) æ(g.)vum;(g.) (:) Spí(g)ri(h)tus(ih) Sanc(i'_)ti(i_) (,) ré(k)so(ji)net(g)\r\nPer(f) om(gh)nem(h.) (,) gló(hg)ri(fe)a(de) mun(e.)dum.(e.) (::)\r\nA(efe)men.(de..) (::)",
    office: "hy",
    mode: "3",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)CHris(ed)te(g) pas(hi)tó(i'_)rum(i_) (,) ca(j)put(h) at(gf)que(de) prin(e.)ceps,(e.) (;)\r\nGés(ijh)ti(g)ens(hi) hu(i'_)jus(i_) (,) ce(j)le(h)brá(gh)re(ed) fes(g.)tum,(g.) (:)\r\nDé(g)bi(h)tas(ih) sa(i'_)cro(i_) (,) pi(k)a(ji) tur(g)ba(f) psal(gh)lit(h.) (,)\r\nCár(hg)mi(fe)ne(de) lau(e.)des.(e.) (::)\r\n\r\n2. Stré(ed)nu(g)um(hi) bel(i'_)lo(i_) (,) pú(j)gi(h)lem(gf) su(de)pér(e.)ni(e.) (;)\r\nChrís(ijh)ma(g)tis(hi) ple(i'_)no(i_) (,) tu(j)us(h) un(gh)xit(ed) in(g.)tus(g.) (:)\r\nSpí(g)ri(h)tus(ih) do(i'_)no,(i_) (,) po(k)su(ji)ít(g)que(f) sanc(gh)tam(h.) (,)\r\nPá(hg)sce(fe)re(de) gen(e.)tem.(e.) (::)\r\n\r\n3. Hic(ed) gre(g)gis(hi) duc(i'_)tor(i_) (,) fu(j)it(h) at(gf)que(de) for(e.)ma,(e.) (;)\r\nLux(ijh) e(g)rat(hi) cæ(i'_)co,(i_) (,) mí(j)se(h)ro(gh) le(ed)vá(g.)men,(g.) (:)\r\nPró(g)vi(h)dus(ih) cunc(i'_)tis(i_) (,) pa(k)ter(ji) om(g)ni(f)bús(gh)que(h.) (,)\r\nOm(hg)ni(fe)a(de) fac(e.)tus.(e.) (::)\r\n\r\n4. Chris(ed)te,(g) qui(hi) sanc(i'_)tis(i_) (,) mé(j)ri(h)tam(gf) co(de)ró(e.)nam(e.) (;)\r\nRed(ijh)dis(g) in(hi) cæ(i'_)lis,(i_) (,) dó(j)ci(h)li(gh) ma(ed)gís(g.)trum(g.) (:)\r\nFac(g) se(h)qui(ih) vi-(i'_)ta,(i_) (,) si(k)mi(ji)lí(g)que(f) tan(gh)dem(h.) (,)\r\nFi(hg)ne(fe) po(de)tí(e.)ri.(e.) (::)\r\n\r\n5. Æ(ed)qua(g) laus(hi) sum(i'_)mum(i_) (,) cé(j)le(h)bret(gf)\r\nPa(de)rén(e.)tem(e.) (;) te(ijh)que,(g) Sal(hi)vá(i'_)tor,(i_) (,) pi(j)e(h) rex,(gh)\r\nPer(ed) æ(g.)vum;(g.) (:) Spí(g)ri(h)tus(ih) Sanc(i'_)ti(i_) (,) ré(k)so(ji)net(g)\r\nPer(f) om(gh)nem(h.) (,) gló(hg)ri(fe)a(de) mun(e.)dum.(e.) (::)\r\nA(efe)men.(de..) (::)",
    office: "hy",
    mode: "3",
    pages: [
    { page: "290", sequence: 1, extent: 3 }
  ...
  },
  {
    ...
    gabc: "(c4)CHris(ed)te(g) pas(hi)tó(i'_)rum(i_) (,) ca(j)put(h) at(gf)que(de) prin(e.)ceps,(e.) (;)\r\nGés(ijh)ti(g)ens(hi) hu(i'_)jus(i_) (,) ce(j)le(h)brá(gh)re(ed) fes(g.)tum,(g.) (:)\r\nDé(g)bi(h)tas(ih) sa(i'_)cro(i_) (,) pi(k)a(ji) tur(g)ba(f) psal(gh)lit(h.) (,)\r\nCár(hg)mi(fe)ne(de) lau(e.)des.(e.) (::)\r\n\r\n2. Quas(ed) o(g)ves(hi) Pe(i'_)tro(i_) (,) dé(j)de(h)ras,(gf) o(de)ví(e.)le(e.) (;)\r\nOr(ijh)bis(g) ut(hi) to(i'_)tus(i_) (,) fí(j)e(h)ret(gh) sa(ed)crá(g.)tum,(g.) (:)\r\nHic(g) tu(h)o(ih) nu(i'_)tu(i_) (,) pó(k)si(ji)tus(g) su(f)pré(gh)mo(h.) (,)\r\nCúl(hg)mi(fe)ne(de) re(e.)xit.(e.) (::)\r\n\r\n3. Hic(ed) gre(g)gis(hi) duc(i'_)tor(i_) (,) fu(j)it(h) at(gf)que(de) for(e.)ma,(e.) (;)\r\nLux(ijh) e(g)rat(hi) cæ(i'_)co,(i_) (,) mí(j)se(h)ro(gh) le(ed)vá(g.)men,(g.) (:)\r\nPró(g)vi(h)dus(ih) cunc(i'_)tis(i_) (,) pa(k)ter(ji) om(g)ni(f)bús(gh)que(h.) (,)\r\nOm(hg)ni(fe)a(de) fac(e.)tus.(e.) (::)\r\n\r\n4. Chris(ed)te,(g) qui(hi) sanc(i'_)tis(i_) (,) mé(j)ri(h)tam(gf) co(de)ró(e.)nam(e.) (;)\r\nRed(ijh)dis(g) in(hi) cæ(i'_)lis,(i_) (,) dó(j)ci(h)li(gh) ma(ed)gís(g.)trum(g.) (:)\r\nFac(g) se(h)qui(ih) vi-(i'_)ta,(i_) (,) si(k)mi(ji)lí(g)que(f) tan(gh)dem(h.) (,)\r\nFi(hg)ne(fe) po(de)tí(e.)ri.(e.) (::)\r\n\r\n5. Æ(ed)qua(g) laus(hi) sum(i'_)mum(i_) (,) cé(j)le(h)bret(gf)\r\nPa(de)rén(e.)tem(e.) (;) te(ijh)que,(g) Sal(hi)vá(i'_)tor,(i_) (,) pi(j)e(h) rex,(gh)\r\nPer(ed) æ(g.)vum;(g.) (:) Spí(g)ri(h)tus(ih) Sanc(i'_)ti(i_) (,) ré(k)so(ji)net(g)\r\nPer(f) om(gh)nem(h.) (,) gló(hg)ri(fe)a(de) mun(e.)dum.(e.) (::)\r\nA(efe)men.(de..) (::)",
    office: "hy",
    mode: "3",
    pages: [
    { page: "290", sequence: 1, extent: 3 }
  ...
  },
  {
    ...
    gabc: "(c4)Fúl(h_)get(g) in(h) cæ(gf)lis(dc) cé(g)le(g)bris(f) sa(g)cér(h.)dos,(h.) (;)\r\nStel(h_)la(j) doc(k)tó(jvIH)rum(h.) (,) rú(i)ti(g)lat(f) co(g)rús(h.)ca,(h.) (:)\r\nLu(h_)men(g) in(h)tác(gf)tum(dc) fí(g)de(g)i(f) per(gh) or(hvGF)bis(f.) (,)\r\nClí(f!gwhg)ma(e)ta(fe) spar(d.)gens.(d.) (::)\r\n\r\n2. Ci(h_)ve(g) tam(h) cla(gf)ro,(dc) Si(g)on(g) o(f) su(g)pér(h.)na,(h.) (;)\r\nLæ(h_)ta(j) dic(k) lau(jvIH)des(h.) (,) Dó(i)mi(g)no(f) sa(g)lú(h.)tis,(h.) (:)\r\nQui(h_) mo(g)dis(h) mi(gf)ris(dc) si(g)bi(g) vin(f)xit(gh) ip(hvGF)sum(f.) (,)\r\nLú(f!gwhg)mi(e)ne(fe) com(d.)plens.(d.) (::)\r\n\r\n3. Hic(h_) fi(g)dem(h) sa(gf)cram(dc) vi(g)gil(g) us(f)que(g) fir(h.)mat,(h.) (;)\r\nAr(h_)m<i>a</i>() et(j) er(k)ró(jvIH)rum(h.) (,) súb(i)i(g)git(f) pot(g)én(h.)ter,(h.) (:)\r\nSór(h_)di(g)dos(h) mo(gf)res(dc) la(g)vat(g) et(f) re(gh)pél(hvGF)lit(f.) (,)\r\nDóg(f!gwhg)ma(e)te(fe) cla(d.)ro.(d.) (::)\r\n\r\n4. Laus,(h_) ho(g)nor,(h) vir(gf)tus(dc) Tri(g)á(g)di(f) be(g)á(h.)tæ,(h.) (;)\r\nCu(h_)ius(j) in(k) ter(jvIH)ris(h.) (,) stu(i)du(g)ís(f)t<i>i</i>() a(g)mán(h.)ter(h.) (:)\r\nAl(h_)ta(g) scru(h)tá(gf)ri(dc) ni(g)ti(g)dá(f)qu<i>e</i>() in(gh) as(hvGF)tris(f.) (,)\r\nLu(f!gwhg)ce(e) po(fe)tí(d.)ris.(d.) (::)\r\nA(ded)men.(cd..) (::)",
    office: "hy",
    mode: "1",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Je(g)su,(d) co(g)ró(g)na(ghg) cǽ(ge)li(fg)tum,(g.) (,)\r\nMa(h!iwji)rí(h)a,(g) cæ(h)li(gf) gáu(e)di(f)um,(g.) (;)\r\nDe(g)o(i) fru(j)én(k)tes(klk) An(j)ge(i)li,(hig.) (,)\r\nAu(g)dí(d)te(g) vo(g)ta(ghg) súp(ge)pli(fg)cum.(g.) (::)\r\n\r\n2. Vos,(g) Pa(d)tri(g)ar(g)chá(ghg)rum(ge) cho(fg)ri,(g.) (,)\r\nVa(h!iwji)túm(h)que(g) tur(h)mæ(gf) nó(e)bi(f)les,(g.) (;)\r\nVos,(g) prín(i)ci(j)pes(k) A(klk)pós(j)to(i)li,(hig.) (,)\r\nVos,(g) pur(d)pu(g)rá(g)ti(ghg) már(ge)ty(fg)res,(g.) (::)\r\n\r\n3. Vos,(g) junc(d)ta(g) con(g)fes(ghg)só(ge)ri(fg)bus(g.) (,)\r\nA(h!iwji)mœ(h)́na(g) cas(h)tra(gf) vír(e)gi(f)num,(g.) (;)\r\nA(g)na(i)cho(j)ri(k)tá(klk)rum(j) gre(i)ges,(hig.) (,)\r\nNos(g)tris(d) fa(g)vé(g)te(ghg) pláu(ge)si(fg)bus.(g.) (::)\r\n\r\n4. Ves(g)tris(d) e(g)nim(g) con(ghg)cí(ge)vi(fg)bus,(g.) (,)\r\nNos(h!iwji)tram(h) pro(g)fés(h)sis(gf) ré(e)gu(f)lam,(g.) (;)\r\nHæc(g) ju(i)bi(j)lán(k)tis(klk) ór(j)di(i)nis(hig.) (,)\r\nDi(g)cá(d)ta(g) sunt(g) sol(ghg)lém(ge)ni(fg)a.(g.) (::)\r\n\r\n5. His(g) ín(d)cly(g)tis(g) pa(ghg)rén(ge)ti(fg)bus(g.) (,)\r\nCon(h!iwji)gra(h)tu(g)lá(h)mur(gf) fí(e)li(f)i,(g.) (;)\r\nIl(g)lús(i)tre(j) quos(k) con(klk)sór(j)ti(i)um(hig.) (,)\r\nVes(g)tri(d) be(g)at(g) col(ghg)lé(ge)gi(fg)i.(g.) (::)\r\n\r\n6. Sit(g) laus(d) Pa(g)tri(g) cum(ghg) Fí(ge)li(fg)o,(g.) (,)\r\nEt(h!iwji) u(h)tri(g)ús(h)que(gf) Flá(e)mi(f)ni,(g.) (;)\r\nQuos(g) ves(i)tra(j) fe(k)lix(klk) cí(j)vi(i)tas(hig.) (,)\r\nHym(g)no(d) cé(g)le(g)brat(ghg) pér(ge)pe(fg)ti.(g.) (::)\r\nA(ghg)men.(fg..) (::)",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3)IN(ff)cli(e)tos(f!gwh) Chris(hg)ti(fg) fá(f)mu(f)los(e) ca(f)ná(h.)mus,(h.) (;)\r\nQuos,(ih) fi(i)de(j) cla(ih)ros(hi) ni(i)ti(h)dís(f)que(g) ges(ff)tis,(e.) (:)\r\nHac(f!gwh!ivHG) di(f)e(e) tel(h.)lus(h.) (,) so(i)ci(j)á(i)ta(h) cæ(ih)lo(fe__) (,)\r\nLáu(h)di(g)bus(h) or(fe)nat.(f.) (::)\r\n\r\n2. Quip(ff)pe(e) qui(f!gwh) mi(hg)tes,(fg) hú(f)mi(f)les,(e) pu(f)dí(h.)ci,(h.) (;)\r\nNé(ih)sci(i)am(j) cul(ih)pæ(hi) co(i)lu(h)é(f)re(g) vi(ff)tam,(e.) (:)\r\nDo(f!gwh!ivHG)nec(f) e(e) ter(h.)ris(h.) (,) á(i)ni(j)mus(i) vo(h)lá(ih)vit(fe__) (,)\r\nLi(h)ber(g) ad(h) as(fe)tra.(f.) (::)\r\n\r\n3. In(ff)de(e) iam(f!gwh) gau(hg)dent(fg) mí(f)se(f)ris(e) ad(f)és(h.)se,(h.) (;)\r\nFlén(ih)ti(i)um(j) ter(ih)gunt(hi) lá(i)cri(h)mas,(f) me(g)dén(ff)tur(e.) (:)\r\nMén(f!gwh!ivHG)ti(f)um(e) pla(h.)gis,(h.) (,) vi(i)ti(j)á(i)ta(h) red(ih)dunt(fe__) (,)\r\nMem(h)bra(g) sa(h)lú(fe)ti.(f.) (::)\r\n\r\n4. Nos(ff)tra(e) laus(f!gwh) er(hg)go(fg) ré(f)so(f)net(e) be(f)ní(h.)gnis(h.) (;)\r\nHis(ih) De(i)i(j) ser(ih)vis(hi) re(i)fe(h)rát(f)que(g) gra(ff)tes,(e.) (:)\r\nQui(f!gwh!ivHG) pi(f)a(e) per(h.)gant(h.) (,) o(i)pe(j) nos(i) iu(h)vá(ih)re(fe__) (,)\r\nRe(h)bus(g) in(h) arc(fe)tis.(f.) (::)\r\n\r\n5. Sit(ff) De(e)o(f!gwh) so(hg)li(fg) de(f)cus(f) et(e) pot(f)és(h.)tas,(h.) (;)\r\nLaus(ih) in(i) ex(j)cél(ih)sis(hi) ho(i)nor(h) ac(f) per(g)én(ff)nis,(e.) (:)\r\nQui(f!gwh!ivHG) su(f)is(e) to(h.)tum(h.) (,) mó(i)de(j)rans(i) gu(h)bér(ih)nat(fe__) (,)\r\nLé(h)gi(g)bus(h) or(fe)bem.(f.) (::)\r\nA(ghg)men.(fg..) (::)",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Præ(f)clá(f')ra(f) qua(fe) tu(dc) gló(de)ri(e)a,(e'_) (,)\r\nLe(g)vi(gh) be(hg)á(hih)te,(gf) cín(g)ge(gf)ris,(e.) (;)\r\nlaus(f) est(e) De(fg)i(gf) cle(dc)mén(de)ti(dc)æ,(c'_) (,)\r\nspes(g) nos(g')tr<i>a</i>(fr) ad(f) in(g)dul(ghg)gén(fe)ti(de)am.(e.) (::)",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3)VE(g/goh)ní(fg)te,(f/fe) ex(f)sul(g)té(g)mus(f) Dó(fg)mi(f)no,(f_') (,) ju(f)bi(f)lé(f)mus(f) De(fg)o,(f') sa(f)lu(e)tá(f)ri(h) no(g_h)stro.(g.) (;) Præ(g)oc(g)cu(h)pé(ij)mus(i') fá(i)ci(g)em(g) e(h)jus(g_') (,) in(f) con(e)fes(f)si(h)ó(g_h)ne,(hg..) (;) et(e) in(fg~) psal(gh~)mis(g_') (,) ju(g)bi(g)lé(g)mus(hi) e(g)i.(f_gFE.) (::Z)\r\n\r\nQuó(g/goh)ni(fg)am(f/fe~) De(f)us(g) ma(g)gnus(g) Dó(fg)mi(f)nus,(f_') (,) et(f) rex(f) ma(fg)gnus(f') su(f)per(e) om(f)nes(h) de(g_h)os.(g.) (;) Quó(g)ni(g)am(g) non(g) re(g)pél(g)let(h) Dó(ij)mi(i)nus(i') ple(i)bem(g) su(h)am,(g_') (,) qui(g)a(g) in(g) ma(g)nu(f) e(g)jus(f_') (,) sunt(fg) om(f)nes(e) fi(f)nes(h) ter(g_h)ræ,(hg..) (;) et(e) al(fg)ti(g)tú(g)di(g)nes(g) món(gh~)ti(g)um(g_') (,) i(g)pse(g) cón(hi)spi(g)cit.(f_gFE.) (::Z)\r\n\r\nQuó(g/goh)ni(fg)am(f/fe~) i(f)psí(g)us(g) est(g) ma(g)re,(g_') et(g) i(g)pse(g) fe(g)cit(f) il(g)lud,(f_') (,) et(f) á(fg)ri(f)dam(f') fun(f)da(g)vé(f)runt(e) ma(f)nus(h) e(g_h)jus.(g.) (;) Ve(g)ní(g)te,(g) a(g)do(h)ré(ij)mus,(i'_) (,) et(i) pro(i)ci(i)dá(i)mus(i) an(i)te(g) De(h)um,(g_') (,) plo(g)ré(g)mus(f) co(f)ram(f) Dó(fg)mi(f)no,(f_') qui(f) fe(fg)cit(f) nos,(f'_) (,) qui(f)a(f) i(fg)pse(f) est(f') Dó(g)mi(f)nus,(e) De(f)us(h) no(g_h)ster,(hg..) (;) nos(e) au(fg~)tem(g) pó(g)pu(g)lus(g) e(gh~)jus,(g_') (,) et(g) o(gh)ves(g') pá(g)scu(g)æ(hi) e(g)jus.(f_gFE.) (::Z)\r\n\r\nHó(g/goh)di(fg)e,(f/fe) si(f) vo(g)cem(g) e(h)jus(g') au(g)di(f)é(fg)ri(f)tis:(f_') (,) \r\n«No(f)lí(fg)te(f') ob(f)du(g)rá(f)re(e) cor(f)da(h) ve(g_h)stra,(g.) (;) si(g)cut(g) in(g) e(g)xa(g)cer(g)ba(g)ti(h)ó(ij)ne(i') se(i)cún(i)dum(g) di(h)em(g') ten(g)ta(g)ti(g)ó(h)nis(g') in(g) de(f)sér(g)to:(f_') (,) u(f)bi(f) ten(f)ta(f)vé(fg)runt(f) me(e) pa(f)tres(h) ve(g_h)stri:(hg..) (;) pro(e)ba(fg)vé(g)runt(g) et(g) vi(g)dé(gh)runt(g_') (,) ó(g)pe(g)ra(hi) me(g)a.(f_gFE.) (::Z)\r\n\r\nQua(g)dra(g)gín(g/goh)ta(f/fe) an(f)nis(g') pró(g)xi(g)mus(h) fu(h)i(g_') (,) ge(f)ne(f)ra(f)ti(g)ó(g)ni(f) hu(f)ic,(g_') (,) et(f) di(f)xi:(f) (`) Sem(fg~)per(f') hi(e) er(f)rant(h) cor(g_h)de.(g.) (;) I(g)psi(h) ve(ij)ro(i') non(i) co(i)gno(i)vé(i)runt(i) vi(i)as(g) me(h)as:(g') (,) qui(g)bus(f) ju(f)rá(fg)vi(f') in(e) i(f)ra(h) me(g_h)a:(hg..) (;) Si(e) in(fg~)tro(g)í(gh)bunt(g_') (,) in(g) ré(g)qui(g)em(hi) me(g)am.»(f_gFE.) (::Z)\r\n\r\nGló(g/goh)ri(fg)a(f/fe) Pa(f)tri,(g) et(g) Fí(fg)li(f)o,(f_') (,) et(g) Spi(f)rí(e)tu(f)i(h) San(g_h)cto.(g.) (;) Si(g)cut(h) e(ij)rat(i') in(i) prin(g)cí(h)pi(h)o,(g') (,) et(fe~) nunc,(f) et(h) sem(g_h)per,(hg..) (;) et(e) in(fg~) s<sp>'ae</sp>(gh)cu(g)la(g') sæ(g)cu(g)ló(g)rum.(hi) A(g)men.(f_gFE.) (::)\r\n",
    office: "ps",
    mode: "e",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)VE(h)ní(g)te,(h) ex(h)sul(h)té(h)mus(h) Dó(h)mi(h)no,(h'_) (,) iu(g)bi(h)lé(h)mus(h) De(h)o,(h) sa(g)lu(f)tá(g)ri(h) no(f)stro.(g.) (;) Præ(h)oc(g)cu(h)pé(h)mus(h) fá(h)ci(h)em(h) e(h)ius(h_') (,) in(h) con(g)fes(h)si(g)ó(g)ne,(gf..) (;) et(g) in(g) psal(h)mis(g') iu(f)bi(f)lé(f_g)mus(gf) e(g)i.(gh..) (::Z)\r\n\r\nQuó(h)ni(g)am(h) De(h)us(h) ma(h)gnus(h) Dó(h)mi(h)nus,(h'_) (,) et(g) rex(h) ma(h)gnus(h) su(g)per(f) om(g)nes(h) de(f)os.(g.) (;) Quó(h)ni(g)am(h) non(h) re(h)pél(h)let(h) Dó(h)mi(h)nus(h) ple(h)bem(h) su(h)am,(h_') (,) qui(g)a(h) in(h) ma(h)nu(h) e(h)ius(h_') sunt(h) om(h)nes(g) fi(h)nes(g) ter(g)ræ,(gf..) (;) et(g) al(g)ti(g)tú(h)di(g)nes(f) món(g)ti(f)um(f.) (,) i(f_g)pse(g) cón(gf~)spi(g)cit.(gh..) (::Z)\r\n\r\nQuó(h)ni(g)am(h) i(h)psí(h)us(h) est(h) ma(h)re,(h'_) et(h) i(h)pse(h) fe(h)cit(h) il(h)lud,(h_') (,) et(g) á(h)ri(g)dam(g) fun(g)da(h)vé(g)runt(f) ma(g)nus(h) e(f)ius.(g.) (;) Ve(h)ní(g)te,(h) a(h)do(h)ré(h)mus,(h_') et(h) pro(h)ci(h)dá(h)mus(h) an(h)te(h) De(h)um,(h_') (,) plo(g)ré(h)mus(h) co(h)ram(h) Dó(h)mi(h)no,(h) qui(g) fe(h)cit(g) nos,(g_') (,) qui(g)a(g) i(h)pse(g) est(g') Dó(h)mi(g)nus,(g') De(h)us(g) no(g)ster,(gf..) (;) nos(g) au(g)tem(g) pó(h)pu(g)lus(f) e(g)ius,(f_') (,) et(f) o(f_g)ves(f) pá(f_g)scu(g)æ(gf) e(g)ius.(gh..) (::Z)\r\n\r\nHó(h)di(g)e,(h_') si(h) vo(h)cem(h) e(h)ius(h) au(h)di(h)é(h)ri(h)tis:(h_')  \r\n«(,)No(g)lí(h)te(g) ob(g)du(h)rá(g)re(f) cor(g)da(h) ve(f)stra,(g.) (;) si(h)cut(g) in(h) e(h)xa(h)cer(h)ba(h)ti(h)ó(h)ne(h_') se(h)cún(h)dum(h) di(h)em(h_') (,) ten(g)ta(h)ti(h)ó(h)nis(h) in(h) de(g)sér(h)to:(g.) (,) u(g)bi(g) ten(g)ta(g)vé(h)runt(g) me(g') pa(h)tres(g) ve(g)stri:(gf..) (;) pro(g)ba(g)vé(h)runt(g') et(f) vi(f)dé(g)runt(f.) (,) ó(f_g)pe(g)ra(gf) me(g)a.(gh..) (::Z)\r\n\r\nQua(h)dra(g)gín(h)ta(h) an(h)nis(h) pró(h)xi(h)mus(h) fu(h)i(h_') (,) ge(g)ne(h)ra(h)ti(h)ó(h)ni(g) hu(g)ic,(h_') (,) et(g) di(g)xi:(g') (`) Sem(h)per(g) hi(f) er(g)rant(h) cor(f)de.(g.) (;) I(h)psi(g) ve(h)ro(h) non(h) co(h)gno(h)vé(h)runt(h) vi(h)as(h) me(h)as:(h_') (,) qui(g)bus(h) iu(h)rá(h)vi(h) in(g) i(h)ra(g) me(g)a:(gf..) (;) Si(g) in(g)tro(g)í(h)bunt(g') in(f) ré(f_g)qui(g)em(gf~) me(g)am.»(gh..) (::Z)\r\n\r\nGló(h)ri(g)a(h) Pa(h)tri,(h) et(h) Fí(h)li(h)o,(h_') (,) et(h) Spi(g)rí(f)tu(g)i(h) San(f)cto.(g.) (;) Si(h)cut(g) e(h)rat(h) in(h) prin(h)cí(h)pi(h)o,(h_') (,) et(g) nunc,(h) et(g) sem(g)per,(gf..) (;) et(g) in(g)  s<sp>'ae</sp>(h)cu(g)la(g') sæ(f)cu(f_g)ló(g)rum.(gf) A(g)men.(gh..) (::Z)\r\n",
    office: "ps",
    mode: "6",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Je(h)sus(hhg) re(ed)fúl(g)sit(h) óm(hi)ni(hg)um(h'_) (,)\r\nPi(e)us(eh) red(g)émp(gf)tor(d) gén(efg)ti(fe)um;(e.) (;)\r\nTo(ed)tum(c) ge(e)nus(g) fi(h)dé(hi)li(hg)um(h'_) (,)\r\nLau(e)dis(eh) cé(g)le(gf)bret(d) cán(efg)ti(fe)cum.(e.) (::)\r\n\r\n2. De(h)nis(hhg) ter(ed) æ(g)vi(h) cír(hi)cu(hg)lis(h'_) (,)\r\nJam(e) par(eh)te(g) vi(gf)vens(d) cór(efg)po(fe)ris,(e.) (;)\r\nLym(ed)pham(c) pe(e)tit(g) bap(h)tís(hi)ma(hg)tis(h'_) (,)\r\nCunc(e)tis(eh) ca(g)rens(gf) con(d)tá(efg)gi(fe)is.(e.) (::)\r\n\r\n3. Fe(h)lix(hhg) Jo(ed)án(g)nes(h) mér(hi)ge(hg)re(h'_) (,)\r\nIl(e)lum(eh) tre(g)mé(gf)scit(d) flú(efg)mi(fe)ne,(e.) (;)\r\nPot(ed)est(c) su(e)o(g) qui(h) sán(hi)gui(hg)ne(h'_) (,)\r\nPec(e)cá(eh)ta(g) mun(gf)di(d) tér(efg)ge(fe)re.(e.) (::)\r\n\r\n4. Vox(h) er(hhg)go(ed) Pro(g)lem(h) de(hi) po(hg)lis(h'_) (,)\r\nTes(e)tá(eh)tur(g) ex(gf)cél(d)si(efg) Pa(fe)tris,(e.) (;)\r\nFlu(ed)ít(c)que(e) vir(g)tus(h) Spí(hi)ri(hg)tus(h'_) (,)\r\nSanc(e)ti(eh) da(g)trix(gf) cha(d)rís(efg)ma(fe)tis.(e.) (::)\r\n\r\n5. Nos,(h) Chris(hhg)te,(ed) vo(g)ce(h) súp(hi)pli(hg)ci(h'_) (,)\r\nPre(e)cá(eh)mur,(g) om(gf)nes(d) pró(efg)te(fe)ge,(e.) (;)\r\nAc(ed) men(c)te(e) fac(g) ni(h)té(hi)sce(hg)re(h'_) (,)\r\nTi(e)bí(eh)que(g) mun(gf)dos(d) ví(efg)ve(fe)re.(e.) (::)\r\n\r\n6. O(h) Chris(hhg)te,(ed) vi(g)ta,(h) vé(hi)ri(hg)tas,(h'_) (,)\r\nTi(e)bi(eh) sit(g) om(gf)nis(d) gló(efg)ri(fe)a,(e.) (;)\r\nQuem(ed) Pa(c)tris(e) at(g)que(h) Spí(hi)ri(hg)tus(h'_) (,)\r\nSplen(e)dor(eh) re(g)vé(gf)lat(d) cǽ(efg)li(fe)tus.(e.) (::)\r\nA(efe)men.(de..) (::)",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c3)VE(i)ní(h)te,(i) ex(i)sul(i)té(i)mus(h) Dó(hi)mi(i)no,(i_') (,) iu(h)bi(i)lé(i)mus(i) De(i)o,(i') sa(i)lu(h)tá(hj)ri(j) no(i.)stro.(i.) (;) Præ(i)oc(h)cu(i)pé(i)mus(i) fá(i)ci(i)em(h) e(hi~)ius(i_') (,) in(i) con(h)fes(hj)si(j)ó(i.)ne,(i.) (;) et(h) in(i) psal(i)mis(i') iu(i)bi(i)lé(j)mus(i) e(h)i.(gf..) (::Z)\r\n\r\nQuó(i)ni(h)am(i) De(i)us(i) ma(i)gnus(h) Dó(hi)mi(i)nus,(i_') (,) et(h) rex(i_) ma(i)gnus(i') su(i)per(h) om(hj)nes(j) de(i.)os.(i.) (;) Quó(i)ni(h)am(i) non(i) re(i)pél(i)let(i) Dó(i)mi(i)nus(i) ple(i)bem(h) su(hi)am,(i_') (,) qui(h)a(i) in(i) ma(i)nu(i) e(i)ius(i') sunt(i) om(i)nes(h) fi(hj)nes(j) ter(i.)ræ,(i.) (;) et(h) al(i)ti(i)tú(i)di(i)nes(i) món(i)ti(i)um(i') i(j)pse(i) cón(h)spi(h)cit.(gf..) (::Z)\r\n\r\nQuó(i)ni(h)am(i) i(i)psí(i)us(i) est(i) ma(i)re,(i'_) et(i) i(i)pse(i) fe(i)cit(h) il(hi)lud,(i_') (,) et(h) á(i)ri(i)dam(i) fun(i)da(i)vé(i)runt(h) ma(hj)nus(j) e(i.)ius.(i.) (;) Ve(i)ní(h)te,(i) a(i)do(i)ré(i)mus,(i_') et(i) pro(i)ci(i)dá(i)mus(i) an(i)te(h) De(hi)um,(i_') (,) plo(h)ré(i)mus(i) co(i)ram(i) Dó(i)mi(i)no,(i) qui(h) fe(hi)cit(i) nos,(i'_) (,) qui(h)a(i) i(i)pse(i) est(i') Dó(i)mi(i)nus,(h) De(hj)us(j) no(i.)ster,(i.) (;) nos(h) au(i)tem(i) pó(i)pu(i)lus(i) e(i)ius,(i_') et(i) o(i)ves(i) pá(j)scu(i)æ(i) e(h)ius.(gf..) (::Z)\r\n\r\nHó(i)di(h)e,(i) si(i) vo(i)cem(i) e(i)ius(i) au(i)di(h)é(hi)ri(i)tis:(i_')  (,)\r\n« No(h)lí(i)te(i) ob(i)du(i)rá(i)re(h) cor(hj)da(j) ve(i.)stra,(i.) (;) si(i)cut(h) in(i) e(i)xa(i)cer(i)ba(i)ti(i)ó(i)ne(i_') se(i)cún(i)dum(h) di(hi)em(i_') (,) ten(h)ta(i)ti(i)ó(i)nis(i) in(i) de(h)sér(hi)to:(i'_) (,) u(h)bi(i) ten(i)ta(i)vé(i)runt(i) me(h) pa(hj)tres(j) ve(i.)stri:(i.) (;) pro(h)ba(i)vé(i)runt(i) et(i) vi(i)dé(i)runt(i') ó(j)pe(i)ra(i) me(h)a.(gf..) (::Z)\r\n\r\nQua(i)dra(h)gín(i)ta(i) an(i)nis(i) pró(i)xi(i)mus(h) fu(hi)i(i_') (,) ge(h)ne(i)ra(i)ti(i)ó(i)ni(h) hu(hi)ic,(i_') et(h) di(i)xi:(i') (`) Sem(i)per(i) hi(h) er(hj)rant(j) cor(i.)de.(i.) (;) I(i)psi(h) ve(i)ro(i) non(i) co(i)gno(i)vé(i)runt(i) vi(i)as(h) me(hi)as:(i_') (,) qui(h)bus(i) iu(i)rá(i)vi(i) in(h) i(hj)ra(j) me(i.)a:(i.) (;) Si(h) in(i)tro(i)í(i)bunt(i') in(i) ré(j)qui(i)em(i) me(h)am. »(gf..) (::Z)\r\n\r\nGló(i)ri(h)a(i) Pa(i)tri,(i) et(h) Fí(hi)li(i)o,(i_') (,) et(i) Spi(i)rí(h)tu(hj)i(j) San(i.)cto.(i.) (;) Si(i)cut(h) e(i)rat(i) in(i) prin(h)cí(hi)pi(i)o,(i'_) (,) et(h) nunc,(hj) et(j) sem(i.)per,(i.) (;) et(h) in(i) s<sp>'ae</sp>(i)cu(i)la(i') sæ(i)cu(i)ló(j)rum.(i) A(h)men.(gf..) (::)",
    office: "ps",
    mode: "d",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Quæ (h)ca(hhg)ri(ed)tá(g)tis(hj) fúl(ji)gi(hi)dum(i_') (,) es(k) as(kj)trum,(i) Vir(ji)go,(h) sú(ih)pe(gh)ris,(h.) (;) spe(k)i(k) no(i)bis(k) mor(klk)tá(j)li(i)bus(hiHG_') (,) fons(i) vi(jk)vax(i) es(ji) et(h) pró(ih)flu(gh)us.(h.) (::)",
    office: "hy",
    mode: null,
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)COR(dfd) Ie(e)su(e/fgf/eeo1f/ded.) (,) a(dfe)mó(fg)re(g) no(gh)stri(g') vul(g)ne(f)rá(ghGF)tum,(efEDd) (;)\r\nve(c)ní(c!dwefv)te,(ed__) a(-dfe)do(fg)ré(g_hGFg)mus.(fe..) (::)",
    office: "an",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Mat(e)thí(e)a,(ed) sa(g)cra(gh)tís(j)si(j)mo(ih__) (,)\r\nA(i)pos(j)to(i)ló(h)rum(g) cœ(hiwji)tu(hg)i(g.) (;)\r\nquam(gh) mi(j)ro(i) tu(h) con(g)sí(i)li(g)o(hg__) (,)\r\na(hi)scríp(g)tus(h) es(gf) di(d)ví(fgwhg)ni(fe)tus!(e.) (::)",
    office: "hy",
    mode: "3",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c3)VE(h)ní(h)te,(hi/hssfgf) ex(f)sul(g)té(h)mus(h) Dó(hi)mi(h)no,(h'_) (,) iu(f)bi(g)lé(h)mus(h) De(h)o,(h') sa(g)lu(f)tá(h)ri(i) no(h)stro.(i.) (;) Præ(h)oc(h)cu(gh)pé(f)mus(f) fá(f)ci(d)em(f) e(h)ius(h') in(g) con(f)fes(h)si(i)ó(h_i)ne,(ih..) (;) et(d) in(f) psal(hi~)mis(h_') (,) iu(h)bi(h/hg)lé(gf)mus(ho1i) e(hg/hih)i.(f!gwh_GEdefv/fe.) (::Z)\r\n\r\nQuó(h)ni(h)am(hi/hssfgf) De(f)us(g) ma(h)gnus(h) Dó(hi)mi(h)nus,(h'_) (,) et(f) rex(gh) ma(h)gnus(h') su(g)per(f) om(h)nes(i) de(h)os.(i.) (;) Quó(h)ni(gh)am(f) non(d) re(f)pél(h)let(h) Dó(h)mi(h)nus(h) ple(i)bem(h) su(i)am,(h'_) (,) qui(f)a(g) in(h) ma(h)nu(h) e(h)ius(h') sunt(h) om(g)nes(f) fi(h)nes(i) ter(h_i)ræ,(ih..) (;) et(d) al(f)ti(h)tú(h)di(h)nes(h) món(hi~)ti(h)um(h'_) (,) i(h/hg)pse(gf) cón(ho1i)spi(hg/hih)cit.(f!gwh_GEdefv/fe.) (::Z)\r\n\r\nQuó(h)ni(h)am(hi/hssfgf) i(f)psí(g)us(h) est(h) ma(h)re,(h') et(h) i(h)pse(h) fe(i)cit(h) il(i)lud,(h'_) (,) et(f) á(g)ri(h)dam(h) fun(h)da(h)vé(g)runt(f) ma(h)nus(i) e(h)ius.(i.) (;) Ve(h)ní(gh)te,(f) a(d)do(f)ré(h)mus,(h'_) et(h) pro(h)ci(h)dá(h)mus(h) an(i)te(h) De(i)um,(h'_) (,) plo(f)ré(g)mus(h) co(h)ram(h) Dó(h)mi(h)no,(h) qui(i) fe(i)cit(h) nos,(h') (,) qui(f)a(g) i(h)pse(h) est(h') Dó(h)mi(g)nus,(f) De(h)us(i) no(h_i)ster,(ih..) (;) nos(d) au(f)tem(h) pó(h)pu(h)lus(h) e(hi~)ius,(h'_) (,) et(h) o(hi)ves(h) pá(h/hg)scu(gf)æ(ho1i) e(hg/hih)ius.(f!gwh_GEdefv/fe.) (::Z)\r\n\r\nHó(h)di(h)e,(hi/hssfgf) si(f) vo(g)cem(h) e(h)ius(h) au(i)di(h)é(i)ri(h)tis:(h'_) (,) \r\n« No(f)lí(g)te(h) ob(h)du(h)rá(g)re(f) cor(h)da(i) ve(h)stra,(i.) (;) si(h)cut(gh) in(f) e(f)xa(d)cer(f)ba(h)ti(h)ó(h)ne(h') se(h)cún(i)dum(h) di(i)em(h'_) (,) ten(f)ta(g)ti(h)ó(h)nis(h) in(i) de(h)sér(i)to:(h'_) (,) u(f)bi(g) ten(h)ta(h)vé(h)runt(g) me(f) pa(h)tres(i) ve(h_i)stri:(ih..) (;) pro(d)ba(f)vé(h)runt(h) et(h) vi(h)dé(hi)runt(h'_) (,) ó(h/hg)pe(gf)ra(ho1i) me(hg/hih)a.(f!gwh_GEdefv/fe.) (::Z)\r\n\r\nQua(h)dra(h)gín(h)ta(hi/hssfgf) an(g)nis(h') pró(h)xi(h)mus(h) fu(hi)i(h'_) (,) ge(f)ne(g)ra(h)ti(i)ó(i)ni(h) hu(h)ic,(i'_) (,) et(h) di(h)xi:(h') (`) Sem(h)per(g) hi(f) er(h)rant(i) cor(h)de.(i.) (;) I(h)psi(gh) ve(f)ro(f) non(f) co(d)gno(f)vé(h)runt(h) vi(i)as(h) me(i)as:(h'_) (,) qui(f)bus(g) iu(h)rá(h)vi(g) in(f) i(h)ra(i) me(h_i)a:(ih..) (;) Si(d) in(f)tro(h)í(hi)bunt(h'_) (,) in(h) ré(h/hg)qui(gf)em(ho1i) me(hg/hih)am. »(f!gwh_GEdefv/fe.) (::Z)\r\n\r\nGló(h)ri(h)a(hi/hssfgf) Pa(f)tri,(g) et(h) Fí(hi)li(h)o,(h'_) (,) et(h) Spi(g)rí(f)tu(h)i(i) San(h)cto.(i.) (;) Si(h)cut(gh) e(f)rat(f) in(d) prin(f)cí(h)pi(h)o,(h'_) (,) et(f) nunc,(h) et(i) sem(h_i)per,(ih..) (;) et(d) in(f) sǽ(hi)cu(h)la(h'_) sæ(h)cu(h/hg)ló(gf)rum.(ho1i) A(hg/hih)men.(f!gwh_GEdefv/fe.) (::)",
    office: "ps",
    mode: "5",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)LÆ(gh)tá(e)re,(fg) cæ(g)lum,(ghg) dé(e)su(fg)per,(g) (,)\r\nap(g)pláu(h)de,(j) tel(ji)lus(h) ac(g) ma(gh)re:(h) (;)\r\nChri(hj)stus(I) re(h)súr(h!iwj)gens(hg) post(f) cru(gh)cem(h) (,)\r\nvi(g)tam(f) de(gh)dit(h) mor(g)tá(e)li(fg)bus.(g) \r\n\r\n\r\n",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3)CO(f/fef/ghGFghf/f)me(ef)dé(hvGFgvEC.gfh)tis(gvFEf.) <v>\\greheightstar</v>(,)\r\ncar(hf/hfg/hiHGh)nes,(gvFEf/ghg.) (;)\r\net(gvFEf) sa(ced)tu(ef)ra(f!gwhf/gef/egivHGivHGh)bí(f)mi(gh)ni(g) pá(fe)ni(f!gwh)bus:(gf..) (:)\r\n<v>\\greheightstar</v>()\r\nI(gi)ste(g) est(hvGFf) pa(e)nis(fg) quem(gf/hhg) de(gvFE)dit(h) vo(gf)bis(f_) (,)\r\nDó(f)mi(gh!ivHGh)nus(fg) ad(f)\r\nve(fe)scén(f_hGE.f!gwhGF.gighGF.,hjIHijg./hifhvGEf.,cffvEDef/ehGFEC.efe~)dum.(f_hGEf.) (::)\r\n\r\n<sp>V/</sp>.\r\nNon(f) Moy(e_f!gwhhi>)ses(h) de(ij)dit(i) vo(hi)bis(h) pa(hg)nem(hi>) de(gh) cæ(f!gwh_g_)lo,(gf..) (;)\r\nsed(fc) Pa(ef)ter(f) me(f)us(fe) dat(fgf) vo(ef)bis(f.) (,)\r\npa(hi)nem(f) de(ge) cæ(fg)lo(f.) ve(hjIF_hvGEC.efe)rum.(f_hGEf.) (::)\r\n\r\n<v>\\greheightstar</v>() I(gi)ste.(g) (::)\r\n",
    office: "re",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c3)PA(-ehg)nem(h) vi(ih__iwjij)tæ(ji..) (,) Chri(ijIH)stum(h) Dó(hg/hoi)mi(fe)num,(e_f_!gw_h_e_fveed.) (;) \r\nve(df)ní(h_!iji___/h!ioj)te,(hhg) a(f)do(fiHG)ré(efe___)mus.(e.) (::) \r\nPs. Ve(i)ní(i/jki)te, p. 160(hhg) (::)\r\n",
    office: "an",
    mode: "7",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c3)VE(g/goh)ní(fg)te,(gvFE) ex(f)sul(g)té(h)mus(g) Dó(fg)mi(f)no,(f_') (,) iu(f)bi(f)lé(f)mus(g) De(g)o,(f') sa(f)lu(e)tá(f)ri(h) no(g_h)stro.(g.) (;) Præ(g)oc(g)cu(h)pé(ij)mus(i') fá(i)ci(h)em(g) e(hi)ius(g_') (,) in(g) con(fe~)fes(f)si(h)ó(g_h)ne,(hg..) (;) et(fe) in(fg~) psal(gh~)mis(g_') (,) iu(g)bi(hghf/ghg)lé(fe)mus(e_f!gwh) e(hf__!gwhG__'FE)i.(e/fge/cdc.) (::Z)\r\n\r\nQuó(g/goh)ni(fg)am(gvFE~) De(f)us(g) ma(h)gnus(g) Dó(fg)mi(f)nus,(f_') (,) et(f) rex(f_g) ma(g)gnus(f') su(f)per(e) om(f)nes(h) de(g_h)os.(g.) (;) Quó(g)ni(g)am(g) non(g) re(g)pél(g)let(h) Dó(ij)mi(i)nus(i') ple(i)bem(g) su(hi)am,(g_') (,) qui(g)a(g) in(g) ma(h)nu(f) e(g)ius(f_') (,) sunt(g) om(f)nes(e) fi(f)nes(h) ter(g_h)ræ,(hg..) (;) et(fe) al(fg~)ti(g)tú(g)di(g)nes(g) món(gh~)ti(g)um(g_') (,) i(hghf/ghg)pse(fe) cón(e_f!gwh)spi(hf__!gwh_G_'FE)cit.(e/fge/cdc.) (::Z)\r\n\r\nQuó(g/goh)ni(fg)am(gvFE~) i(f)psí(g)us(h) est(g) ma(fg)re,(f_') (,) et(f) i(f)pse(f) fe(f)cit(g) il(g)lud,(f_') (,) et(f) á(fg)ri(f)dam(f') fun(f)da(g)vé(f)runt(e) ma(f)nus(h) e(g_h)ius.(g.) (;) Ve(g)ní(g)te,(g) a(g)do(h)ré(ij)mus,(i_') (,) et(i) pro(i)ci(g)dá(hi)mus(g') an(g)te(g) De(h)um,(g_',) plo(g)ré(g)mus(g) co(g)ram(g) Dó(gh)mi(g)no,(g') qui(f) fe(g)cit(f) nos,(f_') (,) qui(f)a(f) i(fg)pse(f) est(f') Dó(g)mi(f)nus,(e) De(f)us(h) no(g_h)ster,(hg..) (;) nos(fe) au(fg~)tem(g) pó(g)pu(g)lus(g) e(gh~)ius,(g_',) et(g) o(gh)ves(g) pá(hghf/ghg)scu(fe)æ(e_f!gwh) e(hf__!gwh_G_'FE)ius.(e/fge/cdc.) (::Z)\r\n\r\nHó(g/goh)di(fg)e,(gvFE) si(f) vo(g)cem(g) e(h)ius(g') au(g)di(f)é(fg)ri(f)tis:(f_') (,)« No(f)lí(fg)te(f') ob(f)du(g)rá(f)re(e) cor(f)da(h) ve(g_h)stra,(g.) (;) si(g)cut(g) in(g) e(g)xa(g)cer(g)ba(g)ti(h)ó(ij)ne(i_') (,) se(i)cún(i)dum(g) di(hi)em(g_') (,) ten(g)ta(g)ti(g)ó(h)nis(g') in(g) de(f)sér(fg)to:(f_') (,) u(fg)bi(f') ten(f)ta(f)vé(g)runt(f) me(e) pa(f)tres(h) ve(g_h)stri:(hg..) (;) pro(fe)ba(fg)vé(g)runt(g) et(g) vi(g)dé(gh)runt(g_') (,) ó(hghf/ghg)pe(fe)ra(e_f!gwh) me(hf__!gwh_G'_FE)a.(e/fge/cdc.) (::Z)\r\n\r\nQua(g)dra(g)gín(g/goh)ta(ffe) an(f)nis(g') pró(h)xi(g)mus(f) fu(fg)i(f'_) (,) ge(f)ne(f)ra(f)ti(g)ó(g)ni(f) hu(f)ic,(g_') (,) et(f) di(f)xi:(f') (`) Sem(g)per(f) hi(e) er(f)rant(h) cor(g_h)de.(g.) (;) I(g)psi(h) ve(ij)ro(i') non(i) co(i)gno(g)vé(hi)runt(g') vi(g)as(g) me(h)as:(g_') (,) qui(g)bus(f) iu(f)rá(g)vi(f') in(e) i(f)ra(h) me(g_h)a:(hg..) (;) Si(fe) in(fg~)tro(g)í(gh)bunt(g_') (,) in(g) ré(hghf/ghg)qui(fe)em(e_f!gwh) me(hf__!gwh_G_'FE)am. »(e/fge/cdc.) (::Z)\r\n\r\nGló(g/goh)ri(fg)a(gvFE) Pa(fg)tri,(h) et(g) Fí(fg)li(f)o,(f_') (,) et(g) Spi(f)rí(e)tu(f)i(h) San(g_h)cto.(g.) (;) Si(g)cut(h) e(ij)rat(i') in(i) prin(g)cí(hi)pi(h)o,(h_g_) (,) et(fe~) nunc,(f) et(h) sem(g_h)per,(hg..) (;) et(fe) in(fg~) sǽ(gh)cu(g)la(g_') sæ(g)cu(hghf/ghg)ló(fe)rum.(e_f!gwh) A(hf__!gwh_G'_FE)men.(e/fge/cdc.) (::)\r\n",
    office: "ps",
    mode: "3",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c3)RE(e_0!f>_0)gem(e) A(e)po(e)sto(e)ló(eg)rum(h) Dó(ggf)mi(hf__!gwhG__FE)num,(e/fge/ccod.) (;) ve(b/c@eof)ní(f)te,(hf__!gwhG__FE.) a(eec)do(d_e)ré(ec__doe)mus.(dc..) (::) Ve(g/goh)ní(fg)te. <i>p.135.</i>(gvFE) (::)",
    office: "an",
    mode: "3",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)\r\nCHri(d_)ste,(c) lux(d) ve(fg)ra,(f'_) (,)\r\nbó(g)ni(h)tas(g) et(f) vi(g.)ta,(h.) (;)\r\ngáu(gh)di(i)um(h) mun(gf)di,(e'_) (,)\r\npí(d)e(f)tas(e) im(f)mén(d.)sa,(c.) (:)\r\nqui(d_) nos(c) a(d) mor(fg)te(f'_) (,)\r\nví(g)vi(h)do(g) sal(f)vá(e.)sti(d.) (,)\r\nsán(f_)gui(e)ne(f) tu(dc)o.(d.) (::)",
    office: "hy",
    mode: "1",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)\r\nAD(d_) pre(c)ces(d) no(fg)stras(f'_) (,)\r\nde(g)i(h)tá(g)tis(f) au(g.)res,(h.) (;)\r\nDe(gh)us,(i) in(h)clí(gf)na(e'_) (,)\r\npi(d)e(f)tá(e)te(f) so(d.)la;(c.) (:)\r\nsúp(d_)pli(c)cum(d) vo(fg)ta(f'_) (,)\r\nsú(g)sci(h)pe,(g) pre(f)cá(e.)mur(d.) (,)\r\nfá(f_)mu(e)li(f) tu(dc)i.(d.) (::)",
    office: "hy",
    mode: "1",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3)\r\nA(f)mó(e)ris(f) sen(h)sus(i) é(h)ri(g)ge(f'_) (,)\r\nad(i) te,(i) lar(h)gí(i)tor(j) vé(h)ni(g)æ,(f.) (;)\r\nut(f) fi(f)as(g) cle(e)mens(c) cór(e)di(f)bus(f'_) (,)\r\npur(f)gá(e)tis(f) in(h)de(i) sór(h)di(g)bus.(f.) (::)\r\n",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)\r\nAD(d)é(e)sto,(f) Chri(g)ste,(eg) cór(f)di(e)bus,(f'_) (,)\r\ncel(d)sa(e) re(f)dém(g)ptis(eg) cá(f)ri(e)tas;(ded.) (;)\r\nin(e)fún(c)de(e) no(gh)stris(hi) fér(h)vi(g)dos(h'_) (,)\r\nfle(f)tus,(h) ro(h)gá(g)mus,(ef) vó(g)ci(f)bus.(e.) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3)LAu(ef~)dé(f)mus(f/ghf/fe) De(f)um(hg~) no(h_iHG)strum,(g.) (;) in(i) fe(kxij)sti(j/kij)vi(hg/hi)tá(hv_GF)te(f/ghf/gf/fe.) (,) pa(h)tris(gf) no(fi/ih)stri(gf) Be(gh)ne(f)dí(ef)cti.(f.) (::)\r\nPs. Ve(f)ní(e)te. p. 133(f) (::)",
    office: "an",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)\r\nSAl(g)ve(g) di(h)es,(g') di(h)é(i)rum(g) gló(h)ri(f)a,(g.) (,)\r\ndi(h)es(j) fe(i)lix(g') Chri(h)sti(i) vi(g)ctó(h)ri(i)a,(i.) (;)\r\ndi(j)es(k) di(jvIH)gna(g') iu(h)gi(f) læ(g)tí(f)ti(e)a,(d.) (,)\r\ndi(e)es(g) pri(h)ma.(g.) (::)\r\n",
    office: "hy",
    mode: "7",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)\r\nTE(f) no(f)stra(f) læ(fe)tis(dc) láu(de)di(e)bus,(e'_) (,)\r\nIa(g)có(gh)be,(hg) tol(hih)lunt(gf) cán(g)ti(gf)ca,(e.) (;)\r\nquem(f) Chri(e)stus(fg) ar(gf)t<i>e</i> {e}x(dc) ré(de)ti(dc)um(c'_) (,)\r\nad(g) tan(g)ta(f) ve(g)xit(ghg) cúl(fe)mi(de)na.(e.) (::)",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)\r\nO(e) sem(e)pi(ed)tér(g)næ(gh) cú(j)ri(j)æ(ih__) (,)\r\nre(i)gis(j) su(i)pér(h)ni(g) prín(h!iwji)ci(hg)pes,(g.) (;)\r\nquos(gh) i(j)pse(i) Ie(h)sus(g) é(i)do(g)cens(hg__) (,)\r\ndo(hi)ná(g)vit(h) or(gf)b<i>i</i> {A}(d)pó(f!gwhg)sto(fe)los.(e.) (::)\r\n",
    office: "hy",
    mode: "3",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)DI(d)es(e) æ(f)tás(g)que(eg) cé(f)te(e)ris(f) (,)\r\no(d)ctá(e)va(f) splen(g)det(eg) sán(f)cti(e)or(ded) (;)\r\nin(e) te(c) quam,(e) Ie(gh)su,(hi) cón(h)se(g)cras,(h) (,)\r\npri(f)mí(h)ti(h)æ(g) sur(ef)gén(g)ti(f)um.(e) \r\n\r\n2.(::) Tu(d) ti(e)bi(f) no(g)stras(eg) á(f)ni(e)mas(f) (,)\r\nnunc(d) pri(e)mo(f) con(g)re(eg)sú(f)sci(e)ta;(ded) (;)\r\nti(e)bi(c) con(e)súr(gh)gant(hi) cór(h)po(g)ra(h) (,)\r\nse(f)cún(h)da(h) mor(g)te(ef) lí(g)be(f)ra.(e) \r\n\r\n3.(::) Ti(d)bí(e)que(f) mox(g) in(eg) nú(f)bi(e)bus,(f) (,)\r\nChri(d)ste,(e) fe(f)rá(g)mur(eg) ób(f)vi(e)am(ded) (;)\r\nte(e)cum(c) vi(e)ctú(gh)ri(hi) pér(h)pe(g)tim:(h) (,)\r\ntu(f) vi(h)ta,(h) re(g)sur(ef)ré(g)cti(f)o.(e) \r\n\r\n4.(::) Cu(d)ius(e) vi(f)dén(g)tes(eg) fá(f)ci(e)em,(f) (,)\r\ncon(d)fi(e)gu(f)ré(g)mur(eg) gló(f)ri(e)æ;(ded) (;)\r\nte(e) co(c)gno(e)scá(gh)mus(hi) si(h)cut(g) es,(h) (,)\r\nlux(f) ve(h)ra(h) et(g) su(ef)á(g)vi(f)tas.(e) \r\n\r\n5.(::) Re(d)gnum,(e) cum(f) Pa(g)tri(eg) trá(f)di(e)tos,(f) (,)\r\nple(d)nos(e) sep(f)té(g)no(eg) chrís(f)ma(e)te,(ded) (;)\r\nin(e) te(c)met(e) nos(gh) læ(hi)tí(h)fi(g)cas,(h) (,)\r\ncon(f)súm(h)met(h) san(g)cta(ef) Trí(g)ni(f)tas.(e) (::)\r\nA(efe)men.(de) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)\r\nDUl(h)cis(h) Ie(h)su(h) me(d)mó(f)ri(e)a,(d'_) (,)\r\ndans(h) ve(h)ra(i) cor(g)di(h) gáu(j)di(i)a,(h.) (;)\r\nsed(h) su(i)per(j) mel(k) et(j) óm(h)ni(j)a(ivHG'_) (,)\r\ne(h)ius(h) dul(i)cis(g) præ(e)sén(g)ti(h)a.(h.) (::)",
    office: "hy",
    mode: "d",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)\r\nIN(d) már(e)ty(f)ris(g) Lau(gvFE)rén(d)ti(de)i(e'_) (,)\r\nnon(e) in(e)cru(ed)én(g)to(gh) prœ́(h)li(gh)o,(h.) (;)\r\nar(hi)má(j)ta(ivHG) pu(h)gná(g)vit(h) Fi(gvFE)des(e'_) (,)\r\npró(e)pr<i>i</i>i(g) cru(gh)ó(g)ris(g) pró(fe)di(de)ga.(e.) (::)",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)MAr(ghg)ty(f)ris(g) Chri(gh)sti(gf__) (,) có(h)li(h)mus(h/iwjh) tri(ih)úm(g.)phum,(g.) (;)\r\ndo(j_)na(i) qui(k) mun(ji)di(i_j) (,) pe(h)ri(g)tú(h)ra(i) sper(h.)nit,(g.) (:) \r\nfert(gh) o(i)pem(h) nu(ghg)dis,(e_f) (,) a(g)li(h)mén(g)ta,(f)\r\nnum(ef)mos(d.) (,) tra(ghg)dit(f) e(g)gé(gh)nis.(g.) \r\n",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)RE(c!dwe/fv)gem(e) már(e)ty(e)rum(fg~) Dó(ge)mi(f)num,(deDC__) (;) ve(c_e!fw_g)ní(g)te,(g_h) a(hv_GF)do(g)ré(gv_FE)mus.(e.) (::) \r\n\r\nPs. Ve(dh)ní(gh)te. <i>p.141</i>(gf/gf/fe) (::)",
    office: "an",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)\r\nAU(g)ró(g)ra(f) ve(e)lut(d) fúl(fhg)gi(fg)da,(g.) (,) \r\nad(h!iwji) cæ(h)li(g) me(h)at(ig) cúl(h)mi(g)na(f.) (;) \r\nut(f) sol(g) Ma(f)rí(g)a(h) splén(j)di(g)da,(hih'_15) (,) \r\ntam(h)quam(h) lu(g)na(e) pul(f)chér(hg)ri(fg)ma.(g.) (::)",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)\r\nSO(d!ewfd)lis,(dc) o(cd) Vir(d.)go,(d.) (,)\r\nrá(f)di(e)is(d) a(e)mí(e.)cta,(d.) (;)\r\nbis(dh/iv) ca(h)put(h) se(hg)nis(g_h) re(f)di(gh)mí(g)ta(fg) stel(gvFE)lis,(d.) (:)\r\nlu(dg)na(fe) cu(dc)<i>i</i> pr{æ}(dd)bet(c.) (,)\r\npé(fe)di(fg)bus(fe) sca(dc)bél(de)lum,(ed__) (,)\r\nín(d!ewfd)cli(dc)ta(cd) ful(d.)ges.(d.) (::)",
    office: "hy",
    mode: "1",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)\r\nO(h) san(hhg)cta(ed) mun(g)di(hj) dó(ji)mi(hi)na,(i'_) (,)\r\nre(k)gí(kj)na(i) cæ(ji)li(h) ín(ih)cli(gh)ta,(h.) (;)\r\no(k) stel(k)la(i) ma(k)ris(klk) fúl(j)gi(i)da,(hiHG'_) (,)\r\nvir(i)go(jk) ma(i)ter(ji) mi(h)rí(ih)fi(gh)ca.(h.) (::)",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Com(f)mú(f)ne(f) vos,(fe) a(dc)pós(de)to(e)li,(e_) (,)\r\nex(g)tól(gh)lat(hg) hym(hih)ni(gf) iú(g)bi(gf)lum,(e.) (;)\r\nquos(f) ád(e)vo(fg)cat(gf) par(dc) grá(de)ti(dc)a,(c_) (,)\r\nco(g)ró(g)nat(f) u(g)na(ghg) gló(fe)ri(de)a.(e.) 2.(::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
    { page: "483", sequence: 0, extent: 1 }
  ...
  },
  {
    ...
    gabc: "(c4)CHri(d!ewfd)ste,(dc) cæ(cd)ló(d.)rum(d.) (,)\r\nha(f)bi(e)tá(d)tor(e) al(e.)me,(d.) (;)\r\nvi(dh/iv)ta(h) san(h)ctó(hg)rum,(g_h) vi(f)a(gh) spes(g) sa(fg)lús(gvFE)que,(d.) (:)\r\nhó(dg)sti(fe)am(dc) cle(dd)mens,(c.) (,)\r\nti(fe)bi(fg) quam(fe) li(dc)tá(de)mus,(ed__) (,)\r\nsú(d!ewfd)sci(dc)pe(cd) lau(d.)dis.(d.) (::)",
    office: "hy",
    mode: "1",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)\r\nHYm(ege)num(e) ca(g)nén(gh)tes(hg) már(fe)ty(de)rum(e'_) (,)\r\ndi(f)cá(d)mus(e) In(fg)no(fe)cén(d)ti(cd)um,(d.) (;)\r\nquos(fe) ter(d)ra(c) de(ed)flens(ff) pér(d)di(ce)dit,(e.) (,)\r\ngau(ef)dens(g) sed(f!gh) æ(hg)thra(fe) sú(d)sci(de)pit;(e.) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    id: "gregobase:13356",
    incipit: "Candor aeternae",
    gabc: "(c4)\r\nCAn(e_)dor(d) æ(e)tér(gh)næ(gvFE'_) (,) \r\nDe(d)i(e!fg)tá(fe)tis(de) al(e.)me,(e.) (;)\r\nChri(e)ste,(gh) tu(h) lu(gh)men,(h'_) (,)\r\nvé(j)ni(hg)<i>a</i> {a}t(h)que(gvFE) vi(de)ta(e.) (:)\r\nád(e)ve(e)nis,(ed) mor(f)bis(dc__) (,) \r\nhó(d)mi(ed)num(efe) me(fd)dé(f!gh)la,(h'_) (,)\r\npor(g)ta(fe) sa(de)lú(e.)tis.(e.) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c3) CHris(e_f)tum,(e) pas(e)tó(eg)rum(h) prín(ggf)ci(h_f_!gwh_G_FE)pem,(e/fgeccod.) (;) ve(b/c@eo@fv)ní(f)te,(h_f_!gwh_G_FE.) a(eec)do(de)ré(e_c_doe)mus.(dc..) (::) <i>Ps.</i> Ve(g/goh)ní(fg)te,(gvFE) (::)",
    office: "an",
    mode: "3",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c3)POpulus(f e f) Dómini(h hi i'_,) et(i) o(h')ves(i) pás(j)cu(i)æ(h) eius,(i. i. ;) ve(jk)ní(j)te(i) a(j)do(ih)ré(ij)mus(j) e(i.)um.(i.) (::) Veníte,(i hi i) (::)",
    office: "an",
    mode: "d",
    pages: [
  ...
  },
  {
    id: "gregobase:15059",
    incipit: "Venite exsultemus VI**",
    gabc: "(c4)Ve(f_h)ní(j)te,(j) ex(j)sul(h)té(h)mus(i) Dó(i)mi(h)no;(h'_) (,)\r\niu(h)bi(h)lé(h)mus(i) De(i)o(h') sa(h)lu(g)tá(h)ri(f) no(gg)stro.(f.) (;)\r\nPræ(f_h)oc(j)cu(j)pé(j)mus(h) fá(h)ci(h)em(i) e(i)ius(h'_) (,)\r\nin(h) con(g)fes(h)si(f)ó(gg)ne,(f.) (;)\r\net(d) in(f) psal(fg~)mis(f'_) (,)\r\niu(f)bi(g)lé(fe)mus(f) e(gh)i.(ixh_i/ggf.) (::Z)\r\n\r\nQuó(f_h)ni(j)am(j) De(j)us(h) ma(h)gnus(i) Dó(i)mi(h)nus,(h'_) (,)\r\net(h) rex(h_i) ma(i)gnus(h') su(h)per(g) om(h)nes(f) de(gg)os.(f.) (;)\r\nQuó(f_h)ni(j)am(j) non(j) re(h)pél(h)let(h) Dó(h)mi(h)nus(h) ple(h)bem(i) su(i)am,(h'_) (,)\r\nqui(h)a(h) in(h) ma(h)nu(i) e(i)ius(h') sunt(h) om(h)nes(g) fi(h)nes(f) ter(gg)ræ,(f.) (;)\r\net(d) al(f)ti(f)tú(f)di(f)nes(f) món(fg~)ti(f)um(f'_) (,) i(g)pse(fe) cón(f)spi(gh)cit.(ixh_i/ggf.) (::Z)\r\n\r\nQuó(f_h)ni(j)am(j) i(j)psí(h)us(i) est(i) ma(h)re,(h'_) (,)\r\net(h) i(h)pse(h) fe(h)cit(i) il(i)lud,(h'_) (,)\r\net(h) á(h_i)ri(i)dam(h') fun(h)da(h)vé(h)runt(g) ma(h)nus(f) e(gg)ius.(f.) (;)\r\nVe(f_h)ní(i)te,(i) a(i)do(i)ré(i)mus(h'_) (,) et(h) pro(h)ci(h)dá(h)mus(h) an(h)te(i) De(i)um,(h'_) (,)\r\nplo(h)ré(hi)mus(h') co(h)ram(h) Dó(h)mi(h)no,(h) qui(i) fe(i)cit(h) nos,(h'_) (,)\r\nqui(h)a(h) i(h_i)pse(h) est(h') Dó(h)mi(h)nus(g) De(h)us(f) no(gg)ster,(f.) (;)\r\nnos(d) au(f)tem(f) pó(f)pu(f)lus(f) e(fg~)ius(f'_) (,)\r\net(f) o(fg)ves(f) pa(g)scu(fe)æ(f) e(gh)ius.(ixh_i/ggf.) (::Z)\r\n\r\nHó(f_h)di(j)e,(j) si(j) vo(j)cem(j) e(j)ius(h) au(h)di(i)é(i)ri(h)tis:(h'_) (,)\r\n« No(h)lí(hi)te(h') ob(h)du(h)rá(h)re(g) cor(h)da(f) ve(gg)stra,(f.) (;)\r\nsi(f_h)cut(j) in(j) e(j)xa(j)cer(j)ba(j)ti(j)ó(j)ne(h'_) se(h)cún(h)dum(i) di(i)em(h'_) (,)\r\nten(h)ta(h)ti(h)ó(h)nis(h) in(h) de(i)sér(i)to,(h_) (,)\r\nu(hi)bi(h') ten(h)ta(h)vé(h)runt(h) me(g) pa(h)tres(f) ve(gg)stri:(f.) (;)\r\npro(d)ba(f)vé(f)runt(f) et(f) vi(f)dé(fg)runt(f'_) (,)\r\nó(g)pe(fe)ra(f) me(gh)a.(ixh_i/ggf.) (::Z)\r\n\r\nQua(f_h)dra(j)gín(j)ta(j) an(j)nis(h') pró(h)xi(h)mus(i) fu(i)i(h'_) (,)\r\nge(h)ne(h)ra(h)ti(i)ó(i)ni(h) hu(h)ic,(i'_) (,)\r\net(h) di(i)xi:(h') (`) sem(h)per(h) hi(hg) er(h)rant(f) cor(gg)de.(f.) (;)\r\nI(f_h)psi(j) ve(j)ro(h') non(h) co(h)gno(h)vé(h)runt(h) vi(h)as(i) me(i)as,(h_) (,)\r\nqui(hi)bus(h') iu(h)rá(h)vi(h) in(g) i(h)ra(f) me(gg)a:(f.) (;)\r\nSi(d) in(f)tro(f)í(fg)bunt(f'_) (,)\r\nin(f) ré(g)qui(fe)em(f) me(gh)am. »(ixh_i/ggf.) (::Z)\r\n\r\nGló(f_h)ri(j)a(j) Pa(j)tri,(h) et(i) Fí(i)li(h)o,(h'_) (,)\r\net(h) Spi(h)rí(g)tu(h)i(f) San(gg)cto.(f.) (;)\r\nSi(f_h)cut(j) e(j)rat(h') in(h) prin(i)cí(i)pi(h)o,(h'_) (,)\r\net(g) nunc(h) et(f) sem(gg)per,(f.) (;)\r\net(d) in(f) s<sp>'ae</sp>(fg)cu(f)la(f) sæ(f)cu(g)ló(fe)rum.(f) A(gh)men.(ixh_i/ggf.) (::Z)",
    office: "ps",
    mode: "6",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Au(g)ró(h)ra(g) lu(h)cis(i) rú(j)ti(h)lat,(i) (,)\r\ncæ(i)lum(i) re(j)súl(h)tat(g) láu(h)di(j)bus,(ijwkJI) (;)\r\nmun(h)dus(i) ex(j)súl(k)tans(i) iú(j)bi(j)lat,(i) (,)\r\nge(h)mens(i) in(j)fér(i)nus(h) ú(i)lu(h)lat.(g) \r\n\r\n2.(::)\r\nCum(g) rex(h) il(g)le(h) for(i)tís(j)si(h)mus,(i) (,)\r\nmor(i)tis(i) con(j)frá(h)ctis(g) ví(h)ri(j)bus,(ijwkJI) (;)\r\npe(h)de(i) con(j)cúl(k)cans(i) tár(j)ta(j)ra(i) (,)\r\nsol(h)vit(i) ca(j)té(i)na(h) mí(i)se(h)ros.(g)\r\n\r\n(::Z-) 3.\r\nIl(g)le,(h) quem(g) clau(h)sum(i) lá(j)pi(h)de(i) (,)\r\nmi(i)les(i) cu(j)stó(h)dit(g) á(h)cri(j)ter,(ijwkJI) (;)\r\ntri(h)úm(i)phans(j) pom(k)pa(i) nó(j)bi(j)li(i) (,)\r\nvi(h)ctor(i) sur(j)git(i) de(h) fú(i)ne(h)re.(g)\r\n\r\n4.(::)\r\nIn(g)fér(h)ni(g) iam(h) ge(i)mí(j)ti(h)bus(i) (,)\r\nso(i)lú(i)tis(j) et(h) do(g)ló(h)ri(j)bus,(ijwkJI) (;)\r\nqui(h)a(i) sur(j)ré(k)xit(i) Dó(j)mi(j)nus(i) (,)\r\nres(h)plén(i)dens(j) cla(i)mat(h) án(i)ge(h)lus.(g)\r\n\r\n5.(::)\r\nE(g)sto(h) pe(g)rén(h)ne(i) mén(j)ti(h)bus(i) (,)\r\npas(i)chá(i)le,(j) Ie(h)su,(g) gáu(h)di(j)um(ijwkJI) (;)\r\net(h) nos(i) re(j)ná(k)tos(i) grá(j)ti(j)æ(i) (,)\r\ntu(h)is(i) tri(j)úm(i)phis(h) ág(i)gre(h)ga.(g)\r\n\r\n6.(::)\r\nIe(g)su,(h) ti(g)bi(h) sit(i) gló(j)ri(h)a,(i) (,)\r\nqui(i) mor(i)te(j) vi(h)cta(g) prǽ(h)ni(j)tes,(ijwkJI) (;)\r\ncum(h) Pa(i)tr<i>e</i>() et(j) al(k)mo(i) Spí(j)ri(j)tu,(i) (,)\r\nin(h) sem(i)pi(j)tér(i)na(h) sǽ(i)cu(h)la.(g) (::)\r\nA(ghg)men.(fg) (::)\r\n",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Aptata virgo;\r\nbook: Liber Hymnarius, p. 308;\r\noccasion: Commune Unius Virginis;\r\noffice-part: Ad Laudes H;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 8;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c4)Ap(g)tá(g)ta,(fd) vir(e)go,(f) lám(gh)pa(h)de(g'_) (,)\r\nad(f) núp(g)ti(h)as(ji) in(hg)grés(hi)sa(hg) es(g.) (;)\r\næ(j)tér(k)ni(i) re(j)gis(h) gló(j)ri(i)æ,(ghGF'_) (,)\r\nquem(f) lau(g)dant(h) tur(ji)bæ(hg) cǽ(hi)li(hg)cæ.(g.) (::)\r\n\r\n\r\n",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c3) Al(d/fh~)le(h)lú(Hs/0Hs/0Hs<)ja,(hih___/jvI'HGhf__ ,) Spí(fg)ri(f)tus(f) Dó(fg)mi(f)ni(f'_ ,) re(f)plé(fg)vit(f) or(f!gw!h>)bem(e) ter(f!gwh)rá(h)rum,(gf..) (;)\r\nve(f!gwh)ni(e)te,(f!gwh) a(h)do(g)ré(h)mus,(f.) (,)\r\nal(f!gw!h>)le(evd/eo1!fv)lú(fe/ede)ja.(ed..) (::)",
    office: "an",
    mode: "5",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Trinitas summo;\r\nbook: Liber Hymnarius p. 108;\r\noccasion: Sanctissimae Trinitatis;\r\noffice-part: Ad Officium lectionis H;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 1;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c4)Trí(d!efd)ni(dc)tas,(cd) sum(d.)mo(d.) (,) só(f)li(e)o(d) co(e)rú(e.)scans,(d.) (;)\r\ngló(dhiv)ri(h)æ(h) car(hg)men(g_h) ti(f)bi(gh) sit(g) pe(fg)rén(gvFE)ne,(d.) (:)\r\nquæ(dg) te(fe)nes(dc) no(dd)stri(c.) (,) ve(fe)he(fg)mén(fe)t<i>i</i>() a(dc)mó(de)re(e_d_) (,)\r\npé(d!efd)cto(dc)ris(cd) i(d.)ma.(d.) \r\n\r\n2.(::)\r\nCón(d!efd)di(dc)tor(cd) re(d.)rum,(d.) (,) Pa(f)ter,(e) al(d)ma(e) vir(e.)tus,(d.) (;)\r\nquos(dhiv) tu(h)æ(h) vi(hg)tæ(g_h) fa(f)cis(gh) at(g)que(fg) for(gvFE)mæ(d.) (:)\r\nes(dg)se(fe) con(dc)sór(dd)tes,(c.) (,) fí(fe)de(fg)i(fe) fac(dc) us(de)que(e_d_) (,)\r\ndo(d!efd)na(dc) me(cd)ré(d.)ri.(d.) \r\n\r\n3.(::)\r\nCan(d!efd)dor(dc) æ(cd)tér(d.)næ(d.) (,) spe(f)cu(e)lúm(d)que(e) lu(e.)cis,(d.) (;)\r\nNa(dhiv)te,(h) quos(h) di(hg)cis(g_h) so(f)ci(gh)ás(g)que(fg) fra(gvFE)tres,(d.) (:)\r\npál(dg)mi(fe)tes(dc) vi(dd)ti(c.) (,) ti(fe)bi(fg) nos(fe) i(dc)nés(de)se(e_d_) (,)\r\nda(d!efd) vi(dc)ri(cd)dán(d.)tes.(d.) \r\n\r\n4.(::)\r\nCá(d!efd)ri(dc)tas,(cd) i(d.)gnis,(d.) (,) pí(f)e(e)tas,(d) po(e)tén(e.)ti(d.) (;)\r\nlú(dhiv)mi(h)n<i>e</i>() ac(h) blan(hg)do(g_h) mó(f)de(gh)rans(g) cre(fg)á(gvFE)ta,(d.) (:)\r\nSpí(dg)ri(fe)tus,(dc) men(dd)tem(c.) (,) ré(fe)no(fg)va,(fe) fo(dc)vé(de)to(e_d_) (,)\r\nín(d!efd)ti(dc)ma(cd) cor(d.)dis.(d.) \r\n\r\n5.(::)\r\nHo(d!efd)spes(dc) o(cd) dul(d.)cis,(d.) (,) Tri(f)as(e) ob(d)se(e)crán(e.)da,(d.) (;)\r\nnos(dhiv) ti(h)bi(h) iu(hg)gi(g_h) fac(f) a(gh)mó(g)re(fg) ne(gvFE)xos,(d.) (:)\r\npér(dg)pe(fe)tes(dc) do(dd)nec(c.) (,) mo(fe)du(fg)lé(fe)mur(dc) hym(de)nos(e_d_) (,)\r\nte(d!efd)que(dc) fru(cd)á(d.)mur.(d.) (::)\r\nA(ded)men.(cd..) (::)\r\n",
    office: "hy",
    mode: "1",
    pages: [
  ...
  },
  {
    id: "gregobase:15456",
    incipit: "Deum verum",
    gabc: "initial-style: 1;\r\nname: Deum verum;\r\nbook: Liber Hymnarius p. 106;\r\noccasion: Sanctissimae Trinitatis;\r\noffice-part: Ad Invitatorium;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 4;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c4)De(cdefv)um(e) ve(dffe)rum,(d_c_) (,) u(de)num(e') in(e>) Tri(c)ni(de)tá(efg)te(ffe.) (;) et(e) Tri(g)ni(gh)tá(h_g_/hv_GFg)tem(ffe.) (,) in(e) U(dc)ni(de)tá(efg_FE)te,(ddoe.) (;) ve(c_d)ní(e)te,(fg) ad(g_f_/g_1hGFf)o(de)ré(e.)mus.(e.) (::)\r\n",
    office: "an",
    mode: "4",
    pages: [
  ...
  },
  {
    id: "gregobase:15508",
    incipit: "Venite exsultemus IV",
    gabc: "initial-style: 1;\r\nname: Venite exsultemus IV;\r\nbook: Liber Hymnarius p. 138;\r\noccasion: ;\r\noffice-part: Invitatorium;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 4;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c4)Ve(e)ní(g)te,(h) ex(h)sul(h)té(h)mus(g) Dó(hi)mi(hg)no,(h'_) (,) iu(e)bi(g)lé(h)mus(h) De(h)o,(h) sa(g)lu(fv_ED)tá(e)ri(g) no(e_f)stro.(e.) (;) Præ(e)oc(g)cu(h)pé(h)mus(h) fá(h)ci(h)em(g) e(hi)ius(h'_) (,) in(g) con(fv_ED~)fes(e)si(g)ó(e_f)ne,(ed..) (;) et(c) in(de~) psal(fe~)mis(d') iu(e)bi(f)lé(g)mus(gh) e(g)i.(fe..) (::Z-)\r\n\r\nQuó(e)ni(g)am(h) De(h)us(h) ma(h)gnus(g) Dó(hi)mi(hg)nus,(h'_) (,) et(e) rex(g_h) ma(h)gnus(h) su(g)per(fv_ED) om(e)nes(g) de(e_f)os.(e.) (;) Quó(e)ni(g)am(h) non(h) re(h)pél(h)let(h) Dó(h)mi(h)nus(h) ple(h)bem(g) su(hi)am,(h'_) (,) qui(e)a(g) in(h) ma(h)nu(h) e(h)ius(h'_) (,) sunt(h) om(g)nes(fv_ED) fi(e)nes(g) ter(e_f)ræ,(ed..) (;) et(c) al(de~)ti(e)tú(e)di(e)nes(e) món(f)ti(fe)um(d') i(e)pse(f) cón(gh)spi(g)cit.(fe..) (::Z-)\r\n\r\nQuó(e)ni(g)am(h) i(h)psí(h)us(h) est(h) ma(h)re,(h'_) et(h) i(h)pse(h) fe(h)cit(g) il(hi)lud,(h'_) (,) et(e) á(g)ri(h)dam(h) fun(h)da(h)vé(g)runt(fv_ED) ma(e)nus(g) e(e_f)ius.(e.) (;) Ve(e)ní(g)te,(h) a(h)do(h)ré(h)mus,(h'_) (,) et(h) pro(h)ci(h)dá(h)mus(h) an(h)te(g) De(hi)um,(h'_) (,) plo(e)ré(g)mus(h) co(h)ram(h) Dó(h)mi(h)no,(h) qui(g) fe(hi)cit(hg) nos,(h.) (,) qui(e)a(g) i(h)pse(h) est(h) Dó(h)mi(g)nus(fv_ED) De(e)us(g) no(e_f)ster,(ed..) (;) nos(c) au(de~)tem(e) pó(e)pu(e)lus(e) e(ef~)ius,(e'_) (,) et(e) o(fe)ves(d') pá(e)scu(f)æ(gh) e(g)ius.(fe..) (::Z-)\r\n\r\nHó(e)di(g)e,(h) si(h) vo(h)cem(h) e(h)ius(h) au(h)di(g)é(hi)ri(hg)tis:(h'_)   «(,)No(e)lí(g)te(h) ob(h)du(h)rá(g)re(fv_ED) cor(e)da(g) ve(e_f)stra,(e.) (;) si(e)cut(g) in(h) e(h)xa(h)cer(h)ba(h)ti(h)ó(h)ne(h) se(h)cún(h)dum(g) di(hi)em(h'_) (,) ten(e)ta(g)ti(h)ó(h)nis(h) in(h) de(g)sér(hi)to,(h'_) (,) u(e)bi(g) ten(h)ta(h)vé(h)runt(g) me(fv_ED) pa(e)tres(g) ve(e_f)stri:(ed..) (;) pro(c)ba(de)vé(e)runt(e) et(e) vi(e)dé(fe)runt(d') ó(e)pe(f)ra(gh) me(g)a.(fe..) (::Z-)\r\n\r\nQua(e)dra(g)gín(h)ta(h) an(h)nis(h) pró(h)xi(h)mus(g) fu(hi)i(h'_) (,) ge(e)ne(g)ra(h)ti(h)ó(h)ni(h) hu(g)ic,(h'_) (,) et(h) di(h)xi:(h') (`) Sem(h)per(g) hi(fv_ED) er(e)rant(g) cor(e_f)de.(e.) (;) I(e)psi(g) ve(h)ro(h) non(h) co(h)gno(h)vé(h)runt(h) vi(h)as(g) me(hi)as,(h'_) (,) qui(e)bus(g) iu(h)rá(h)vi(g) in(fv_ED) i(e)ra(g) me(e_f)a:(ed..) (;) Si(c) in(de~)tro(e)í(fe)bunt(d') in(d) ré(e)qui(f)em(gh) me(g)am.»(fe..) (::Z-)\r\n\r\nGló(e)ri(g)a(h) Pa(h)tri,(h) et(g) Fí(hi)li(hg)o,(h'_) (,) et(h) Spi(g)rí(fv_ED)tu(e)i(g) San(e_f)cto.(e.) (;) Si(e)cut(g) e(h)rat(h) in(h) prin(g)cí(hi)pi(hg)o,(h_g_) et(fv_ED~) nunc,(e) et(g) sem(e_f)per,(ed..) (;) et(c) in(de~) sǽ(f)cu(fe)la(d') sæ(e)cu(f)ló(g)rum.(gh) A(g)men.(fe..) (::Z-)\r\n",
    office: "ps",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) VE(h)ni(hhg)ens(ed) ma(g)ter(hj) ín(ji)cli(hi)ta,(i)\r\n(;) cum(k) Sanc(kj)ti(i) do(ji)no(h) Spí(ih)ri(gh)tus,(h)\r\n(:) nos(k) ut(k) Io(i)án(k)nem(klk) ví(j)si(i)ta(hiHG)\r\n(;) in(i) hui(jk)us(i) car(ji)nis(h) sé(ih)di(gh)bus.(h)\r\n(::)",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Verbum supernum prodiens;\r\nbook: Liber Hymnarius p. 115;\r\noccasion: Sanctissimae Corporis et Sanguinis Christi;\r\noffice-part: Laudes H;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 8;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c4)Ver(g)bum(ghwih) su(gf)pér(hg)num(hiwji) pród(hg)i(fg)ens(g.) (;)\r\nnec(g) Pa(ih)tris(jk) lin(k)quens(ji) déx(hg)te(hj)ram,(j.) (:)\r\nad(j) o(h)pus(i) su(g)um(gh) éx(hg)i(fg)ens(g.) (;)\r\nve(f)nit(hg) ad(hj) vi(ji)tæ(hg) vé(hg)spe(fg)ram.(g.) \r\n\r\n2.(::)\r\nIn(g) mor(ghwih)tem(gf) a(hg) di(hiwji)scí(hg)pu(fg)lo(g.) (;)\r\nsu(g)is(ih) tra(jk)dén(k)dus(ji) ǽ(hg)mu(hj)lis,(j.) (:)\r\npri(j)us(h) in(i) vi(g)tæ(gh) fér(hg)cu(fg)lo(g.) (;)\r\nse(f) trá(hg)di(hj)dit(ji) di(hg)scí(hg)pu(fg)lis.(g.) \r\n(::) (Z)\r\n\r\n3. Qui(g)bus(ghwih) sub(gf) bi(hg)na(hiwji) spé(hg)ci(fg)e(g.) (;)\r\ncar(g)nem(ih) de(jk)dit(k) et(ji) sán(hg)gui(hj)nem,(j.) (:)\r\nut(j) dú(h)pli(i)cis(g) sub(gh)stán(hg)ti(fg)æ(g.) (;)\r\nto(f)tum(hg) ci(hj)bá(ji)ret(hg) hó(hg)mi(fg)nem.(g.) \r\n\r\n(::)\r\n4. Se(g) na(ghwih)scens(gf) de(hg)dit(hiwji) só(hg)ci(fg)um,(g.) (;)\r\ncon(g)vé(ih)scens(jk) in(k) e(ji)dú(hg)li(hj)um,(j.) (:)\r\nse(j) mó(h)ri(i)ens(g) in(gh) pré(hg)ti(fg)um,(g.) (;)\r\nse(f) re(hg)gnans(hj) dat(ji) in(hg) prǽ(hg)mi(fg)um.(g.) \r\n(::)\r\n5. O(g) sa(ghwih)lu(gf)tá(hg)ris(hiwji) hó(hg)sti(fg)a,(g.) (;)\r\nquæ(g) cæ(ih)li(jk) pan(k)dis(ji) ó(hg)sti(hj)um,(j.) (:)\r\nbel(j)la(h) pre(i)munt(g) ho(gh)stí(hg)li(fg)a:(g.) (;)\r\nda(f) ro(hg)bur,(hj) fer(ji) au(hg)xí(hg)li(fg)um.(g.) \r\n\r\n(::)\r\n6. U(g)ni(ghwih) tri(gf)nó(hg)que(hiwji) Dó(hg)mi(fg)no(g.) (;)\r\nsit(g) sem(ih)pi(jk)tér(k)na(ji) gló(hg)ri(hj)a,(j.) (:)\r\nqui(j) vi(h)tam(i) si(g)ne(gh) tér(hg)mi(fg)no(g.) (;)\r\nno(f)bis(hg) do(hj)net(ji) in(hg) pá(hg)tri(fg)a.(g.) (::)\r\nA(ghg)men.(fg..) (::)\r\n",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Dominum qui fecit nos;\r\nbook: Liber Hymnarius p. 179;\r\noccasion: Tempore Per Annum in Feriis IV;\r\noffice-part: Ad Invitatorium;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 6;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c4)Dó(f)mi(f)num(fg) qui(g) fe(gf)cit(g) nos,(gh..) (;) ve(h)ní(gf)te,(gh) ad(g_0_1h_G_F_)o(fg)ré(g.)mus.(f.) (::)\r\n",
    office: "an",
    mode: "6",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Adoremus Dominum;\r\nbook: Liber Hymnarius p. 180;\r\noccasion: Tempore Per Annum in Feriis V;\r\noffice-part: Ad Invitatorium;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: E;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(f3)Ad(e)o(g_i_h_)ré(fgh)mus(g_h/ffe) Dó(fg)mi(g)num(g.) (,) qui(g_f_!gwh) fe(g)cit(gihh) nos.(hg..) (::)\r\n",
    office: "an",
    mode: "e",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Dominum Deum nsotrum;\r\nbook: Liber Hymnarius p. 180;\r\noccasion: Tempore Per Annum in Feriis VI;\r\noffice-part: Ad Invitatorium;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: E;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(f3)Dó(e)mi(fg)num(g) De(gh)um(g) no(h)strum,(fgF_E_) (;) ve(gh)ni(i)te(h) ad(ih)o(fg)re(g.)mus.(g.) (::)\r\n",
    office: "an",
    mode: "e",
    pages: [
  ...
  },
  {
    id: "gregobase:15600",
    incipit: "Populus Domini",
    gabc: "initial-style: 1;\r\nname: Populus Domini;\r\nbook: Liber Hymnarius p. 180;\r\noccasion: Tempore Per Annum in Sabbatis;\r\noffice-part: Ad Invitatorium;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: D;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c3)Pó(f)pu(e)lus(f) Dó(h)mi(hi)ni(i'_) (,) et(i) o(h')ves(i) pá(j)scu(i)æ(h) e(i.)ius,(i.) (;) ve(jk)ní(j)te(i') ad(j)o(ih)ré(ij)mus(j) e(i.)um.(i.) (::)\r\n",
    office: "an",
    mode: "d",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Nunc Sancte nobis Spiritus;\r\nbook: Liber Hymnarius, p. 185;\r\noccasion: Tempore Per Annum Diebus Dominicis i & III;\r\noffice-part: Ad Tertiam H;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 2;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(f3)Nunc,(f) San(e)cte,(f) no(h)bis,(g) Spí(f)ri(f)tus,(e'_) (,)\r\nu(f)num(e) Pa(f)tri(h) cum(g) Fí(f)li(e)o,(eh..) (;)\r\ndi(h)gná(j)re(i) prom(j)ptus(h) ín(i)ge(hg)ri(f'_) (,)\r\nno(e)stro(f) re(h)fú(hi)sus(hg) pé(f)cto(ef)ri.(f.) \r\n\r\n2.(::)\r\nOs,(f) lin(e)gua,(f) mens,(h) sen(g)sus,(f) vi(f)gor(e'_) (,)\r\ncon(f)fes(e)si(f)ó(h)nem(g) pér(f)so(e)nent,(eh..) (;)\r\nflam(h)mé(j)scat(i) i(j)gne(h) cá(i)ri(hg)tas,(f'_) (,)\r\nac(e)cén(f)dat(h) ar(hi)dor(hg) pró(f)xi(ef)mos.(f.) \r\n\r\n3.(::)\r\nPer(f) te(e) sci(f)á(h)mus(g) da(f) Pa(f)trem,(e'_) (,)\r\nno(f)scá(e)mus(f) at(h)que(g) Fí(f)li(e)um,(eh..) (;)\r\nte(h) u(j)tri(i)ús(j)que(h) Spí(i)ri(hg)tum(f'_) (,)\r\ncre(e)dá(f)mus(h) om(hi)ni(hg) tém(f)po(ef)re.(f.) (::)\r\nA(fgf)men.(ef..) (::)\r\n",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Aeterna lux divinitas;\r\nbook: Liber Hymnarius, p. 190;\r\noccasion: Tempore Per Annum Feriis II Hebd. I & III;\r\noffice-part: Ad Officium Lectionis H;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 4;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c4) Æ(d)tér(e)na(f) lux,(g) di(eg)ví(f)ni(e)tas,(f'_) (,)\r\nin(d) u(e)ni(f)tá(g)te(eg) Trí(f)ni(e)tas,(ded.) (;)\r\nte(e) con(c)fi(e)té(gh)mur(hi) dé(h)bi(g)les,(h'_) (,)\r\nte(f) de(h)pre(h)cá(g)mur(ef) súp(g)pli(f)ces.(e.) \r\n\r\n2.(::)\r\nSum(d)mum(e) Pa(f)rén(g)tem(eg) cré(f)di(e)mus(f'_) (,)\r\nNa(d)túm(e)que(f) Pa(g)tris(eg) ú(f)ni(e)cum,(ded.) (;)\r\net(e) ca(c)ri(e)tá(gh)tis(hi) vín(h)cu(g)lum(h'_) (,)\r\nqui(f) iun(h)git(h) il(g)los(ef) Spí(g)ri(f)tum.(e.) \r\n\r\n3.(::)\r\nO(d) vé(e)ri(f)tas,(g) o(eg) cá(f)ri(e)tas,(f'_) (,)\r\no(d) fi(e)nis(f) et(g) fe(eg)lí(f)ci(e)tas,(ded.) (;)\r\nspe(e)rá(c)re(e) fac(gh) et(hi) cré(h)de(g)re,(h'_) (,)\r\na(f)má(h)re(h) fac(g) et(ef) cón(g)se(f)qui.(e.) \r\n\r\n4,(::)\r\nQui(d) fi(e)nis(f) et(g) e(eg)xór(f)di(e)um(f'_) (,)\r\nre(d)rúm(e)que(f) fons(g) es(eg) óm(f)ni(e)um,(ded.) (;)\r\ntu(e) so(c)lus(e) es(gh) so(hi)lá(h)ci(g)um,(h'_) (,)\r\ntu(f) cer(h)ta(h) spes(g) cre(ef)dén(g)ti(f)um.(e.) \r\n\r\n5.(::)\r\nQui(d) cun(e)cta(f) so(g)lus(eg) éf(f)fi(e)cis(f'_) (,)\r\ncun(d)ctís(e)que(f) so(g)lus(eg) súf(f)fi(e)cis,(ded.) (;)\r\ntu(e) so(c)la(e) lux(gh) es(hi) óm(h)ni(g)bus(h'_) (,)\r\net(f) prǽ(h)mi(h)um(g) spe(ef)rán(g)ti(f)bus.(e.) \r\n\r\n6.(::)\r\nChri(d)stum(e) ro(f)gá(g)mus(eg) et(f) Pa(e)trem,(f'_) (,)\r\nChri(d)sti(e) Pa(f)trís(g)que(eg) Spí(f)ri(e)tum;(ded.) (;)\r\nu(e)num(c) po(e)tens(gh) per(hi) óm(h)ni(g)a,(h'_) (,)\r\nfo(f)ve(h) pre(h)cán(g)tes,(ef) Trí(g)ni(f)tas.(e.) (::)\r\nA(efe)men.(de.) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Splendor paternae gloriae;\r\nbook: Liber Hymnarius, p. 191;\r\noccasion: Tempore Per Annum Feriis II Hebd. I & III;\r\noffice-part: Ad Laudes matutinas H;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 1;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c4)Splen(h)dor(h) pa(h)tér(h)næ(h) gló(hi)ri(h)æ,(h'_) (,)\r\nde(h) lu(h)ce(h) lu(g)cem(f) pró(gh)fe(g)rens,(g.) (;)\r\nlux(f) lu(h)cis(h) et(g) fons(f) lú(g)mi(g)nis,(h'_) (,)\r\ndi(g)em(g) di(g)es(f) il(d)lú(f)mi(e)nans,(d.) \r\n\r\n2.(::)\r\nVe(h)rús(h)que(h) sol,(h) il(h)lá(hi)be(h)re(h'_) (,)\r\nmi(h)cans(h) ni(h)tó(g)re(f) pér(gh)pe(g)ti,(g.) (;)\r\niu(f)bár(h)que(h) San(g)cti(f) Spí(g)ri(g)tus(h'_) (,)\r\nin(g)fún(g)de(g) no(f)stris(d) sén(f)si(e)bus.(d.) \r\n\r\n3.(::)\r\nVo(h)tis(h) vo(h)cé(h)mus(h) et(hi) Pa(h)trem,(h'_) (,)\r\nPa(h)trem(h) pe(h)rén(g)nis(f) gló(gh)ri(g)æ,(g.) (;)\r\nPa(f)trem(h) po(h)tén(g)tis(f) grá(g)ti(g)æ,(h'_) (,)\r\ncul(g)pam(g) re(g)lé(f)get(d) lú(f)bri(e)cam.(d.) \r\n\r\n4.(::)\r\nIn(h)fór(h)met(h) a(h)ctus(h) stré(hi)nu(h)os,(h'_) (,)\r\nden(h)tem(h) re(h)tún(g)dat(f) ín(gh)vi(g)di,(g.) (;)\r\nca(f)sus(h) se(h)cún(g)det(f) á(g)spe(g)ros,(h'_) (,)\r\ndo(g)net(g) ge(g)rén(f)di(d) grá(f)ti(e)am.(d.) \r\n\r\n5.(::)\r\nMen(h)tem(h) gu(h)bér(h)net(h) et(hi) re(h)gat(h'_) (,)\r\nca(h)sto,(h) fi(h)dé(g)li(f) cór(gh)po(g)re;(g.) (;)\r\nfi(f)des(h) ca(h)ló(g)re(f) fér(g)ve(g)at,(h'_) (,)\r\nfrau(g)dis(g) ve(g)né(f)na(d) né(f)sci(e)at.(d.) \r\n\r\n6.(::)\r\nChri(h)stús(h)que(h) no(h)bis(h) sit(hi) ci(h)bus,(h'_) (,)\r\npo(h)tús(h)que(h) no(g)ster(f) sit(gh) fi(g)des;(g.) (;)\r\nlæ(f)ti(h) bi(h)bá(g)mus(f) só(g)bri(g)am(h'_) (,)\r\ne(g)bri(g)e(g)tá(f)tem(d) Spí(f)ri(e)tus.(d.) \r\n\r\n7.(::)\r\nLæ(h)tus(h) di(h)es(h) hic(h) tráns(hi)e(h)at;(h'_) (,)\r\npu(h)dor(h) sit(h) ut(g) di(f)lú(gh)cu(g)lum,(g.) (;)\r\nfi(f)des(h) ve(h)lut(g) me(f)rí(g)di(g)es,(h'_) (,)\r\ncre(g)pú(g)scu(g)lum(f) mens(d) né(f)sci(e)at.(d.) \r\n\r\n8.(::)\r\nAu(h)ró(h)ra(h) cur(h)sus(h) pró(hi)ve(h)hit;(h'_) (,)\r\nAu(h)ró(h)ra(h) to(g)tus(f) pród(gh)e(g)at,(g.) (;)\r\nin(f) Pa(h)tre(h) to(g)tus(f) Fí(g)li(g)us(h'_) (,)\r\net(g) to(g)tus(g) in(f) Ver(d)bo(f) Pa(e)ter.(d.) (::)\r\nA(ded)men.(cd..) (::)\r\n",
    office: "hy",
    mode: "1",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: O sacrosancta Trinitas;\r\nbook: Liber Hymnarius, p. 196;\r\noccasion: Tempore Per Annum Feriis III Hebd. I & III;\r\noffice-part: Ad Officium Lectionis H;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 4;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c4)O(d) Sa(e)cro(f)sán(g)cta(eg) Trí(f)ni(e)tas,(f'_) (,)\r\nquæ(d) cun(e)cta(f) con(g)dens(eg) ór(f)di(e)nas,(ded.) (;)\r\ndi(e)em(c) la(e)bó(gh)ri(hi) dé(h)pu(g)tans(h'_) (,)\r\nno(f)ctem(h) qui(h)é(g)ti(ef) dé(g)di(f)cas,(e.) \r\n\r\n2.(::)\r\nTe(d) ma(e)ne,(f) si(g)mul(eg) vé(f)spe(e)re,(f'_) (,)\r\nte(d) no(e)ct<i>e</i>() ac(f) di(g)e(eg) cá(f)ni(e)mus;(ded.) (;)\r\nin(e) tu(c)a(e) nos(gh) tu(hi) gló(h)ri(g)a(h'_) (,)\r\nper(f) cun(h)cta(h) ser(g)va(ef) tém(g)po(f)ra.(e.) \r\n\r\n3.(::)\r\nNos(d) ád(e)su(f)mus(g) te(eg) cér(f)nu(e)i(f'_) (,)\r\nen(d) a(e)do(f)rán(g)tes(eg) fá(f)mu(e)li;(ded.) (;)\r\nvo(e)ta(c) pre(e)cés(gh)que(hi) súp(h)pli(g)cum(h'_) (,)\r\nhym(f)nis(h) ad(h)iún(g)ge(ef) cǽ(g)li(f)tum.(e.) \r\n\r\n4.(::)\r\nPræ(d)sta,(e) Pa(f)ter(g) pi(eg)ís(f)si(e)me,(f'_) (,)\r\nPa(d)trí(e)que(f) com(g)par(eg) U(f)ni(e)ce,(ded.) (;)\r\ncum(e) Spí(c)ri(e)tu(gh) Pa(hi)rá(h)cli(g)to(h'_) (,)\r\nre(f)gnans(h) per(h) om(g)ne(ef) sǽ(g)cu(f)lum.(e.) (::)\r\nA(efe)men.(de.) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Scientiarum Domino;\r\nbook: Liber Hymnarius, p. 199;\r\noccasion: Tempore Per Annum Feriis IV Hebd. I & III;\r\noffice-part: Ad Officium Lectionis H;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 4;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c4)Sci(d)en(e)ti(f)á(g)rum(eg) Dó(f)mi(e)no,(f'_) (,)\r\nsit(d) ti(e)bi(f) iu(g)bi(eg)lá(f)ti(e)o,(ded.) (;)\r\nqui(e) no(c)stra(e) vi(gh)des(hi) ín(h)ti(g)ma(h'_) (,)\r\ntu(f)á(h)que(h) fo(g)ves(ef) grá(g)ti(f)a.(e.) \r\n\r\n2-(::)\r\nQui(d) bo(e)num,(f) pa(g)stor(eg) óp(f)ti(e)me,(f'_) (,)\r\ndum(d) ser(e)vas,(f) quæ(g)ris(eg) pér(f)di(e)tum,(ded.) (;)\r\nin(e) pá(c)scu(e)is(gh) u(hi)bér(h)ri(g)mis(h'_) (,)\r\nnos(f) iun(h)ge(h) pi(g)is(ef) gré(g)gi(f)bus,(e.) \r\n\r\n3.(::)\r\nNe(d) ter(e)ror(f) i(g)ræ(eg) iú(f)di(e)cis(f'_) (,)\r\nnos(d) hæ(e)dis(f) iun(g)gat(eg) ré(f)pro(e)bis,(ded.) (;)\r\nsed(e) si(c)mus(e) te(gh)met(hi) iú(h)di(g)ce(h'_) (,)\r\no(f)ves(h) æ(h)tér(g)næ(ef) pá(g)scu(f)æ.(e.) \r\n\r\n4.(::)\r\nTi(d)bi,(e) Re(f)dém(g)ptor,(eg) gló(f)ri(e)a,(f'_) (,)\r\nho(d)nor,(e) vir(f)tus,(g) vi(eg)ctó(f)ri(e)a,(ded.) (;)\r\nre(e)gnán(c)ti(e) su(gh)per(hi) óm(h)ni(g)a(h'_) (,)\r\nper(f) sæ(h)cu(h)ló(g)rum(ef) sǽ(g)cu(f)la.(e.) (::)\r\nA(efe)men.(de.) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Christe precamur;\r\nbook: Liber Hymnarius, p. 201;\r\noccasion: Tempore Per Annum Feriis V Hebd. I & III;\r\noffice-part: Ad Officium Lectionis H;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 4;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c4)Chri(d)ste,(e) pre(f)cá(g)mur(eg) ád(f)nu(e)as(f'_) (,)\r\no(d)rán(e)ti(f)bus(g) ser(eg)vis(f) tu(e)is,(ded.) (;)\r\ni(e)ní(c)qui(e)tas(gh) hæc(hi) sǽ(h)cu(g)li(h'_) (,)\r\nne(f) no(h)stram(h) cap(g)tí(ef)vet(g) fi(f)dem.(e.) \r\n\r\n2.(::)\r\nNon(d) co(e)gi(f)té(g)mus(eg) ím(f)pi(e)e,(f'_) (,)\r\nin(d)vi(e)de(f)á(g)mus(eg) né(f)mi(e)ni,(ded.) (;)\r\nlæ(e)si(c) non(e) red(gh)dá(hi)mus(h) vi(g)cem,(h'_) (,)\r\nvin(f)cá(h)mus(h) in(g) bo(ef)no(g) ma(f)lum.(e.) \r\n\r\n3.(::)\r\nAb(d)sit(e) no(f)stris(g) e(eg) cór(f)di(e)bus(f'_) (,)\r\ni(d)ra,(e) do(f)lus,(g) su(eg)pér(f)bi(e)a;(ded.) (;)\r\nab(e)sí(c)stat(e) a(gh)va(hi)rí(h)ti(g)a,(h'_) (,)\r\nma(f)ló(h)rum(h) ra(g)dix(ef) óm(g)ni(f)um.(e.) \r\n\r\n4.(::)\r\nCon(d)sér(e)vet(f) pa(g)cis(eg) foe(f)de(e)ra(f'_) (,)\r\nnon(d) si(e)mu(f)lá(g)ta(eg) cá(f)ri(e)tas;(ded.) (;)\r\nsit(e) il(c)li(e)bá(gh)ta(hi) cá(h)sti(g)tas(h'_) (,)\r\ncre(f)du(h)li(h)tá(g)te(ef) pér(g)pe(f)ti.(e.) \r\n\r\n5.(::)\r\nSit,(d) Chri(e)ste,(f) rex(g) pi(eg)ís(f)si(e)me,(f'_) (,)\r\nti(d)bi(e) Pa(f)trí(g)que(eg) gló(f)ri(e)a(ded.) (;)\r\ncum(e) Spí(c)ri(e)tu(gh) Pa(hi)rá(h)cli(g)to,(h'_) (,)\r\nin(f) sem(h)pi(h)tér(g)na(ef) sǽ(g)cu(f)la.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Adesto Christe;\r\nbook: Liber Hymnarius, p. 204;\r\noccasion: Tempore Per Annum Feriis VI Hebd. I & III;\r\noffice-part: Ad Officium Lectionis H;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 4;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c4)Ad(d)é(e)sto,(f) Chri(g)ste,(eg) cór(f)di(e)bus,(f'_) (,)\r\ncel(d)sa(e) re(f)dém(g)ptis(eg) cá(f)ri(e)tas;(ded.) (;)\r\nin(e)fún(c)de(e) no(gh)stris(hi) fér(h)vi(g)dos(h'_) (,)\r\nfle(f)tus,(h) ro(h)gá(g)mus,(ef) vó(g)ci(f)bus.(e.) \r\n\r\n2.(::)\r\nAd(d) te(e) pre(f)ces,(g) pi(eg)ís(f)si(e)me(f'_) (,)\r\nIe(d)su,(e) fi(f)de(g) pro(eg)fún(f)di(e)mus;(ded.) (;)\r\ndi(e)mít(c)te,(e) Chri(gh)ste,(hi) quǽ(h)su(g)mus,(h'_) (,)\r\nfa(f)ctis(h) ma(h)lum(g) quod(ef) fé(g)ci(f)mus.(e.) \r\n\r\n3.(::)\r\nSan(d)ctæ(e) cru(f)cis(g) si(eg)gná(f)cu(e)lo,(f'_) (,)\r\ntu(d)o(e) sa(f)crá(g)to(eg) cór(f)po(e)re,(ded.) (;)\r\nde(e)fén(c)de(e) nos(gh) ut(hi) fí(h)li(g)os(h'_) (,)\r\nom(f)nes,(h) ro(h)gá(g)mus,(ef) ún(g)di(f)que.(e.) \r\n\r\n4.(::)\r\nSit,(d) Chri(e)ste,(f) rex(g) pi(eg)ís(f)si(e)me,(f'_) (,)\r\nti(d)bi(e) Pa(f)trí(g)que(eg) gló(f)ri(e)a(ded.) (;)\r\ncum(e) Spí(c)ri(e)tu(gh) Pa(hi)rá(h)cli(g)to,(h'_) (,)\r\nin(f) sem(h)pi(h)tér(g)na(ef) sǽ(g)cu(f)la.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
    { page: "204", sequence: 1, extent: 1 }
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Auctor perennis;\r\nbook: Liber Hymnarius, p. 206;\r\noccasion: Tempore Per Annum Sabbatis Hebd. I & III;\r\noffice-part: Ad Officium Lectionis H;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 4;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c4)Au(d)ctor(e) pe(f)rén(g)nis(eg) gló(f)ri(e)æ,(f'_) (,)\r\nqui(d) sep(e)ti(f)fór(g)mis(eg) grá(f)ti(e)æ(ded.) (;)\r\ndas(e) Spí(c)ri(e)tum(gh) cre(hi)dén(h)ti(g)bus,(h'_) (,)\r\nas(f)sí(h)ste(h) mi(g)tis(ef) óm(g)ni(f)bus.(e.) \r\n\r\n2.(::)\r\nEx(d)pél(e)le(f) mor(g)bos(eg) cór(f)po(e)rum,(f'_) (,)\r\nmen(d)tis(e) re(f)pél(g)le(eg) scán(f)da(e)lum,(ded.) (;)\r\nex(e)scín(c)de(e) vi(gh)res(hi) crí(h)mi(g)num,(h'_) (,)\r\nfu(f)ga(h) do(h)ló(g)res(ef) cór(g)di(f)um.(e.) \r\n\r\n3.(::)\r\nSe(d)ré(e)nas(f) men(g)tes(eg) éf(f)fi(e)ce,(f'_) (,)\r\no(d)pus(e) ho(f)né(g)stum(eg) pér(f)fi(e)ce,(ded.) (;)\r\npre(e)ces(c) o(e)rán(gh)tum(hi) ác(h)ci(g)pe,(h'_) (,)\r\nvi(f)tam(h) pe(h)rén(g)nem(ef) trí(g)bu(f)e.(e.) \r\n\r\n4.(::)\r\nSep(d)tem(e) di(f)é(g)rum(eg) cúr(f)si(e)bus(f'_) (,)\r\nnunc(d) tem(e)pus(f) om(g)ne(eg) dú(f)ci(e)tur;(ded.) (;)\r\no(e)ctá(c)vus(e) il(gh)le(hi) úl(h)ti(g)mus(h'_) (,)\r\ndi(f)es(h) e(h)rit(g) iu(ef)dí(g)ci(f)i,(e.) \r\n\r\n5.(::)\r\nIn(d) quo,(e) Re(f)dém(g)ptor,(eg) quǽ(f)su(e)mus,(f'_) (,)\r\nne(d) nos(e) in(f) i(g)ra(eg) ár(f)gu(e)as,(ded.) (;)\r\nsed(e) a(c) si(e)ní(gh)stra(hi) lí(h)be(g)ra,(h'_) (,)\r\nad(f) déx(h)te(h)ram(g) nos(ef) cól(g)lo(f)ca,(e.) \r\n\r\n6.(::)\r\nUt,(d) cum(e) pre(f)ces(g) su(eg)scé(f)pe(e)ris(f'_) (,)\r\ncle(d)mens(e) tu(f)á(g)rum(eg) plé(f)bi(e)um,(ded.) (;)\r\nred(e)dá(c)mus(e) om(gh)nes(hi) gló(h)ri(g)am(h'_) (,)\r\ntri(f)no(h) De(h)o(g) per(ef) sǽ(g)cu(f)la.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Dies aetasque;\r\nbook: Liber Hymnarius, p. 183;\r\noccasion: Tempore Per Annum Dominicis Hebd. I & III;\r\noffice-part: Ad Officium Lectionis H;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 4;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c4)Di(d)es(e) æ(f)tás(g)que(eg) cé(f)te(e)ris(f'_) (,)\r\no(d)ctá(e)va(f) splen(g)det(eg) sán(f)cti(e)or(ded.) (;)\r\nin(e) te(c) quam,(e) Ie(gh)su,(hi) cón(h)se(g)cras,(h'_) (,)\r\npri(f)mí(h)ti(h)æ(g) sur(ef)gén(g)ti(f)um.(e.) \r\n\r\n2.(::)\r\nTu(d) ti(e)bi(f) no(g)stras(eg) á(f)ni(e)mas(f'_) (,)\r\nnunc(d) pri(e)mo(f) con(g)re(eg)sú(f)sci(e)ta;(ded.) (;)\r\nti(e)bi(c) con(e)súr(gh)gant(hi) cór(h)po(g)ra(h'_) (,)\r\nse(f)cún(h)da(h) mor(g)te(ef) lí(g)be(f)ra.(e.) \r\n\r\n3.(::)\r\nTi(d)bí(e)que(f) mox(g) in(eg) nú(f)bi(e)bus,(f'_) (,)\r\nChri(d)ste,(e) fe(f)rá(g)mur(eg) ób(f)vi(e)am(ded.) (;)\r\nte(e)cum(c) vi(e)ctú(gh)ri(hi) pér(h)pe(g)tim:(h'_) (,)\r\ntu(f) vi(h)ta,(h) re(g)sur(ef)ré(g)cti(f)o.(e.) \r\n\r\n4.(::)\r\nCu(d)ius(e) vi(f)dén(g)tes(eg) fá(f)ci(e)em,(f'_) (,)\r\ncon(d)fi(e)gu(f)ré(g)mur(eg) gló(f)ri(e)æ;(ded.) (;)\r\nte(e) co(c)gno(e)scá(gh)mus(hi) si(h)cut(g) es,(h'_) (,)\r\nlux(f) ve(h)ra(h) et(g) su(ef)á(g)vi(f)tas.(e.) \r\n\r\n5.(::)\r\nRe(d)gnum,(e) cum(f) Pa(g)tri(eg) trá(f)di(e)tos,(f'_) (,)\r\nple(d)nos(e) sep(f)té(g)no(eg) chrís(f)ma(e)te,(ded.) (;)\r\nin(e) te(c)met(e) nos(gh) læ(hi)tí(h)fi(g)cas,(h'_) (,)\r\ncon(f)súm(h)met(h) San(g)cta(ef) Trí(g)ni(f)tas.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
    { page: "183", sequence: 0, extent: 1 }
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Pergrato mundo;\r\nbook: Liber Hymnarius, p. 197;\r\noccasion: Tempore Per Annum Feriis III Hebd. I & III;\r\noffice-part: Ad Laudes matutinas H;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 1;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c4)Per(h)grá(h)ta(h) mun(h)do(h) nún(hi)ti(h)at(h'_) (,)\r\nau(h)ró(h)ra(h) so(g)lis(f) spí(gh)cu(g)la,(g.) (;)\r\nres(f) et(h) co(h)ló(g)re(f) vé(g)sti(g)ens(h'_) (,)\r\niam(g) cun(g)cta(g) dat(f) ni(d)té(f)sce(e)re.(d.) \r\n\r\n2.(::)\r\nQui(h) sol(h) per(h) æ(h)vum(h) prǽ(hi)ni(h)tes,(h'_) (,)\r\no(h) Chri(h)ste,(h) no(g)bis(f) ví(gh)vi(g)dus,(g.) (;)\r\nad(f) te(h) ca(h)nén(g)tes(f) vér(g)ti(g)mur,(h'_) (,)\r\nte(g) ge(g)sti(g)én(f)tes(d) pér(f)fru(e)i.(d.) \r\n\r\n3.(::)\r\nTu(h) Pa(h)tris(h) es(h) sci(h)én(hi)ti(h)a(h'_) (,)\r\nVer(h)búm(h)que(h) per(g) quod(f) óm(gh)ni(g)a(g.) (;)\r\nmi(f)ro(h) re(h)fúl(g)gent(f) ór(g)di(g)ne(h'_) (,)\r\nmen(g)tés(g)que(g) no(f)stras(d) át(f)tra(e)hunt.(d.) \r\n\r\n4.(::)\r\nDa(h) lu(h)cis(h) ut(h) nos(h) fí(hi)li(h)i(h'_) (,)\r\nsic(h) am(h)bu(h)lé(g)mus(f) ím(gh)pi(g)gri,(g.) (;)\r\nut(f) Pa(h)tris(h) us(g)que(f) grá(g)ti(g)am(h'_) (,)\r\nmo(g)res(g) et(g) a(f)ctus(d) éx(f)pri(e)mant.(d.) \r\n\r\n5.(::)\r\nSin(h)cé(h)ra(h) præ(h)st<i>a</i>() ut(h) pró(hi)flu(h)ant(h'_) (,)\r\nex(h) o(h)re(h) no(g)stro(f) iú(gh)gi(g)ter,(g.) (;)\r\net(f) ve(h)ri(h)tá(g)tis(f) dúl(g)ci(g)bus(h'_) (,)\r\nut(g) ex(g)ci(g)té(f)mur(d) gáu(f)di(e)is.(d.) \r\n\r\n6.(::)\r\nSit,(h) Chri(h)ste,(h) rex(h) pi(h)ís(hi)si(h)me,(h'_) (,)\r\nti(h)bi(h) Pa(h)trí(g)que(f) gló(gh)ri(g)a(g.) (;)\r\ncum(f) Spí(h)ri(h)tu(g) Pa(f)rá(g)cli(g)to,(h'_) (,)\r\nin(g) sem(g)pi(g)tér(f)na(d) sǽ(f)cu(e)la.(d.) (::)\r\nA(ded)men.(cd..) (::)\r\n",
    office: "hy",
    mode: "1",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Telluris ingens conditor;\r\nbook: Liber Hymnarius, p. 198;\r\noccasion: In Feriis III Per Annum;\r\noffice-part: Ad Vesperas H;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: D;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c4)Tel(d)lú(f)ris(g) in(g)gens(f) cón(h)di(g)tor,(g'_) (,)\r\nmun(d)di(f) so(g)lum(g) qui(f) é(h)ru(g)ens,(g.) (;)\r\npul(h)sis(jk) a(j)quæ(j) mo(g)lé(h)sti(g)is,(g'_) (,)\r\nter(d)ram(f) de(g)dí(g)st<i>i</i>() im(f)mó(h)bi(g)lem,(g.) \r\n\r\n2.(::)\r\nUt(d) ger(f)men(g) ap(g)tum(f) pró(h)fe(g)rens,(g'_) (,)\r\nful(d)vis(f) de(g)có(g)ra(f) fló(h)ri(g)bus,(g.) (;)\r\nfe(h)cún(jk)da(j) fru(j)ctu(g) sí(h)ste(g)ret(g'_) (,)\r\npa(d)stúm(f)que(g) gra(g)tum(f) réd(h)de(g)ret:(g.) \r\n\r\n3.(::)\r\nMen(d)tis(f) per(g)ús(g)tæ(f) vúl(h)ne(g)ra(g'_) (,)\r\nmun(d)da(f) vi(g)ró(g)re(f) grá(h)ti(g)æ,(g.) (;)\r\nut(h) fa(jk)cta(j) fle(j)tu(g) dí(h)lu(g)at(g'_) (,)\r\nmo(d)tús(f)que(g) pra(g)vos(f) át(h)te(g)rat,(g.) \r\n\r\n4.(::)\r\nIus(d)sis(f) tu(g)is(g) ob(f)tém(h)pe(g)ret,(g'_) (,)\r\nnul(d)lis(f) ma(g)lis(g) ap(f)pró(h)xi(g)met,(g.) (;)\r\nbo(h)nis(jk) re(j)plé(j)ri(g) gáu(h)de(g)at(g'_) (,)\r\net(d) mor(f)tis(g) a(g)ctum(f) né(h)sci(g)at.(g.) \r\n\r\n5.(::)\r\nPræ(d)sta,(f) Pa(g)ter(g) pi(f)ís(h)si(g)me,(g'_) (,)\r\nPa(d)trí(f)que(g) com(g)par(f) U(h)ni(g)ce,(g.) (;)\r\ncum(h) Spí(jk)ri(j)tu(j) Pa(g)rá(h)cli(g)to(g'_) (,)\r\nre(d)gnans(f) per(g) om(g)ne(f) sǽ(h)cu(g)lum.(g.) (::)\r\nA(ghg)men.(fg) (::)\r\n",
    office: "hy",
    mode: "d",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Ut queant laxis;\r\nbook: Liber Hymnarius, p. 382;\r\noccasion: In Nativitate S. Ioannis Baptistae;\r\noffice-part: Ad Vesperas H;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 2;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(f3)Ut(e_) que(f)ant(h) la(fg)xis(f.) (,) re(f)so(f)ná(e)re(f) fi(g.)bris(g.) (;)\r\nmi(ghwi)ra(g) ge(f)stó(ge)rum(f.) (,) fá(h)mu(i)li(j) tu(i)ó(hf)rum,(f.) (:)\r\nsol(iji)ve(g) pol(h)lú(ii)ti(f.) (,) lá(j)bi(i)i(j) re(h)á(ij)tum,(j.) (,)\r\nsan(ih)cte(f) Io(e)án(gg)nes.(f.) \r\n\r\n2.(::)\r\nNún(e_)ti(f)us(h) cæ(fg)lo(f.) (,) vé(f)ni(f)ens(e) su(f)pré(g.)mo,(g.) (;)\r\nte(ghwi) pa(g)tri(f) ma(ge)gnum(f.) (,) fo(h)re(i) na(j)sci(i)tú(hf)rum,(f.) (:)\r\nno(iji)men(g) et(h) vi(ii)tæ(f.) (,) sé(j)ri(i)em(j) ge(h)rén(ij)dæ(j.) (,)\r\nór(ih)di(f)ne(e) pro(gg)mit.(f.) \r\n\r\n3.(::)\r\nIl(e_)le(f) pro(h)mís(fg)si(f.) (,) dú(f)bi(f)us(e) su(f)pér(g.)ni(g.) (;)\r\npér(ghwi)di(g)dit(f) prom(ge)ptæ1983(f.) (,) mó(h)du(i)los(j) lo(i)qué(hf)læ;(f.) (:)\r\nsed(iji) re(g)for(h)má(ii)sti(f.) (,) gé(j)ni(i)tus(j) pe(h)rém(ij)ptæ(j.) (,)\r\nór(ih)ga(f)na(e) vo(gg)cis.(f.) \r\n\r\n4.(::)\r\nVen(e_)tris(f) ob(h)strú(fg)so(f.) (,) pó(f)si(f)tus(e) cu(f)bí(g.)li(g.) (;)\r\nsén(ghwi)se(g)ras(f) re(ge)gem(f.) (,) thá(h)la(i)mo(j) ma(i)nén(hf)tem;(f.) (:)\r\nhinc(iji) pa(g)rens(h) na(ii)ti(f.) (,) mé(j)ri(i)tis(j) u(h)tér(ij)que(j.) (,)\r\náb(ih)di(f)ta(e) pan(gg)dit.(f.) \r\n\r\n5.(::)\r\nLáu(e_)di(f)bus(h) ci(fg)ves(f.) (,) cé(f)le(f)brant(e) su(f)pér(g.)ni(g.) (;)\r\nte,(ghwi) De(g)us(f) sim(ge)plex(f.) (,) pa(h)ri(i)tér(j)que(i) tri(hf)ne;(f.) (:)\r\nsúp(iji)pli(g)ces(h) ac(ii) nos(f.) (,) vé(j)ni(i)am(j) pre(h)cá(ij)mur:(j.) (,)\r\npar(ih)ce(f) re(e)dém(gg)ptis.(f.) (::)\r\nA(fgf)men.(ef..) (::)\r\n",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Antra deserti;\r\nbook: Liber Hymnarius, p. 384;\r\noccasion: In Nativitate S. Ioannis Baptistae;\r\noffice-part: Ad Officium lectionis H;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 4;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c4)An(e)tra(d) de(efwg)sér(gh)ti(g.) (,) té(h)ne(g)ris(fe) sub(de) an(e.)nis,(e.) (;)\r\ncí(e_)vi(d)um(e) tur(ed)mas(c.) (,) fú(e)gi(f)ens,(gf) pe(de)tí(e.)sti,(e.) (:)\r\nne(ghwij) le(hg)vi(hi) sal(hg)tem(g_h) ma(h)cu(gf)lá(g)re(gf) vi(e)tam(e_h) (,)\r\nfá(hg)mi(fe)ne(de) pos(e.)ses.(e.) \r\n\r\n2.(::)\r\nPrǽ(e)bu(d)it(efwg) hir(gh)tum(g.) (,) té(h)gi(g)men(fe) ca(de)mé(e.)lus(e.) (;)\r\nár(e_)tu(d)bus(e) sa(ed)cris,(c.) (,) stró(e)phi(f)um(gf) bi(de)dén(e.)tes,(e.) (:)\r\nc<i>u</i>()i(ghwij) la(hg)tex(hi) hau(hg)stum,(g_h) so(h)ci(gf)á(g)ta(gf) pa(e)stum(e_h) (,)\r\nmel(hg)la(fe) lo(de)cú(e.)stis.(e.) \r\n\r\n3.(::)\r\nCé(e)te(d)ri(efwg) tan(gh)tum(g.) (,) ce(h)ci(g)né(fe)re(de) va(e.)tum(e.) (;)\r\ncor(e_)de(d) præ(e)sá(ed)go(c.) (,) iu(e)bar(f) af(gf)fu(de)tú(e.)rum;(e.) (:)\r\ntu(ghwij) qui(hg)dem(hi) mun(hg)di(g_h) sce(h)lus(gf) au(g)fe(gf)rén(e)tem(e_h) (,)\r\nín(hg)di(fe)ce(de) pro(e.)dis.(e.) \r\n\r\n4.(::)\r\nNon(e) fu(d)it(efwg) va(gh)sti(g.) (,) spá(h)ti(g)um(fe) per(de) or(e.)bis(e.) (;)\r\nsán(e_)cti(d)or(e) quis(ed)quam(c.) (,) gé(e)ni(f)tus(gf) Io(de)án(e.)ne,(e.) (:)\r\nqui(ghwij) ne(hg)fas(hi) sæ(hg)cli(g_h) mé(h)ru(gf)it(g) la(gf)ván(e)tem(e_h) (,)\r\ntín(hg)ge(fe)re(de) lym(e.)phis.(e.) \r\n\r\n5.(::)\r\nLáu(e)di(d)bus(efwg) ci(gh)ves(g.) (,) cé(h)le(g)brant(fe) su(de)pér(e.)ni(e.) (;)\r\nte,(e_) De(d)us(e) sim(ed)plex(c.) (,) pa(e)ri(f)tér(gf)que(de) tri(e.)ne;(e.) (:)\r\nsúp(ghwij)pli(hg)ces(hi) ac(hg) nos(g_h) vé(h)ni(gf)am(g) pre(gf)cá(e)mur:(e_h) (,)\r\npar(hg)ce(fe) re(de)dém(e.)ptis.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: O nimis felix;\r\nbook: Liber Hymnarius, p. 386;\r\noccasion: In Nativitate S. Ioannis Baptistae;\r\noffice-part: Ad Laudes H;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 4;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c4)O(e) ni(d)mis(efwg) fe(gh)lix(g.) (,) me(h)ri(g)tí(fe)que(de) cel(e.)si,(e.) (;)\r\nné(e_)sci(d)ens(e) la(ed)bem(c.) (,) ní(e)ve(f)i(gf) pu(de)dó(e.)ris,(e.) (:)\r\nprǽ(ghwij)po(hg)tens(hi) mar(hg)tyr(g_h) e(h)re(gf)mí(g)que(gf) cul(e)tor,(e_h) (,)\r\nmá(hg)xi(fe)me(de) va(e.)tum.(e.) \r\n\r\n2.(::)\r\nNunc(e) po(d)tens(efwg) no(gh)stri(g.) (,) mé(h)ri(g)tis(fe) o(de)pí(e.)mis(e.) (;)\r\npé(e_)cto(d)ris(e) du(ed)ros(c.) (,) lá(e)pi(f)des(gf) re(de)pél(e.)le,(e.) (:)\r\ná(ghwij)spe(hg)rum(hi) pla(hg)nans(g_h) i(h)ter,(gf) et(g) re(gf)flé(e)xos(e_h) (,)\r\ndí(hg)ri(fe)ge(de) cal(e.)les,(e.) \r\n\r\n3.(::)\r\nUt(e) pi(d)us(efwg) mun(gh)di(g.) (,) sa(h)tor(g) et(fe) re(de)dém(e.)ptor,(e.) (;)\r\nmén(e_)ti(d)bus(e) pul(ed)sa(c.) (,) má(e)cu(f)la(gf) po(de)lí(e.)tis,(e.) (:)\r\nri(ghwij)te(hg) di(hi)gné(hg)tur(g_h) vé(h)ni(gf)ens(g) sa(gf)crá(e)tos(e_h) (,)\r\npó(hg)ne(fe)re(de) gres(e.)sus.(e.) \r\nu\r\n4.(::)\r\nLáu(e)di(d)bus(efwg) ci(gh)ves(g.) (,) cé(h)le(g)brant(fe) su(de)pér(e.)ni(e.) (;)\r\nte,(e_) De(d)us(e) sim(ed)plex(c.) (,) pa(e)ri(f)tér(gf)que(de) tri(e.)ne;(e.) (:)\r\nsúp(ghwij)pli(hg)ces(hi) ac(hg) nos(g_h) vé(h)ni(gf)am(g) pre(gf)cá(e)mur:(e_h) (,)\r\npar(hg)ce(fe) re(de)dém(e.)ptis.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\nname: Agnum Dei quem laetus;\r\nbook: Liber Hymnarius, p. 384;\r\noccasion: In Nativitate S. Ioannis Baptistae;\r\noffice-part: Ad Invitatorium Ant;\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: 7;\r\ncentering-scheme: english;\r\nfontsize: 12;\r\nfont: OFLSortsMillGoudy;\r\nheight: 11;\r\nwidth: 4.5;\r\n%%\r\n(c3)A(-ehg)gnum(h) De(i_h_iwjij)i,(ji..) (,) quem(i) læ(ijwk_JI)tus(i) mon(h)strá(ij)vit(ji) Io(h)án(h!ijh/hg>)nes,(e_f!gw_h_e_fveed.) (;) ve(df)ní(h_!i_j_i_/hioj)te(hhg) ad(f)o(fiHG)ré(e_f_e_)mus.(e.) (::)\r\n",
    office: "an",
    mode: "7",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) Te,(h) pa(g)ter(hi) Io(ji)seph,(h.) (,) ó(i)pi(j)fex(h) co(i)lén(h.)de,(g.) (;)\r\nNá(ef)za(e)ræ(d) fe(dh)lix(h.) (,) lá(h)ti(g)tans(h) in(i) um(ij)bra,(g.) (:)\r\nvó(i_)ci(k)bus(j) læ(ih)tis(g.) (,) hu(d)mi(e)lí(f)que(g) cunc(gh)ti(h_') (,)\r\ncor(g_)de(e) ca(f)ná(g.)mus.(g.) (::)\r\n",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)VE(c)ní(c!dwefv)te,(e.) a(fe)do(d)ré(e_f)mus(gh) Re(gf~)gem(de) re(e_f)gum,(ed..) (;) cu(g)ius(gh) hó(hih)di(ghGF)e(ed..) (;) ad(c) æ(df)thé(fe)re(de)um(e.) Vir(ffe)go(d) Ma(dghv)ter(g.) (,) as(gf)súm(gh>)pta(gf) est(de) cæ(e.)lum.(e.) (::)\r\n",
    office: "an",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3)NO(c.)bi(f)lem(e) Chris(f.)ti(h.,) fá(g)mu(f)lam(g) di(h)sér(g.)ta(f.) (;) vo(ff)ce(f) can(g)té(h.)mus,(e.) (,) de(h)cus(i) æ(j)mu(kxk)lá(i.)tam(j.) (:) fé(j.)mi(i)næ(h) for(g.)tis,(i.,) sa(f)cra(f) c<i>u</i>i(g) pro(e)fu(d.)dit(c.,) pá(h.)gi(f)na(g) lau(e.)des.(f.) (::)",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)\r\nDI(e)é(c)i(d) lu(f)ce(ef) réd(g)di(f)ta,(e_,) læ(e)tis(c) gra(d)tís(f)que(ef) vó(g)ci(g)bus(g.;) De(g)i(f) ca(gh)ná(g)mus(f) gló(g)ri(f)am,(e_,) Chris(e)ti(c) fa(d)tén(f)tes(ef) grá(g)ti(f)am.(e.) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3) HO(fhg)di(g)e(g') sci(g)é(gh)tis(g'_) (,)\r\nqui(g)a(hs<hs<hs<) vé(hf)ni(fhg)et(hi~) Dó(i)mi(ih__iwjij)nus,(ji..) (;)\r\net(g_h) ma(i)ne(h) vi(hg)dé(f)bi(fe)tis(fs<hs<hs<iffe.) (,)\r\ngló(ggoh)ri(hf)am(h) e(hi~)ius.(g.) (::)",
    office: "an",
    mode: null,
    pages: [
  ...
  },
  {
    ...
    gabc: "(c3)IE(-ehg)sum(h) Chri(ih@iwjij)stum,(ji) (,) re(i@jwkj>)gem(ih) re(h!ijh/hg)gum,(ef@gwhe) (;) ve(df)ní(h!iji/hiOj)te,(hhg) a(f)do(fiHG)ré(efe)mus.(e) (::)",
    office: "an",
    mode: "7",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) IE(h)su,(h) rex(h) ad(h)mi(d)rá(f)bi(e)lis,(d) (,) et(h) tri(h)um(i)phá(g)tor(h) nó(j)bi(i)lis,(h) (;) dul(h)cé(i)do(j) in(k)ef(j)fá(h)bi(j)lis,(ivHG) (,) to(h)tus(h) de(i)si(g)de(e)rá(g)bi(h)lis.(h) (::)\r\n\r\n2. Rex(h) vir(h)tú(h)tum,(h) rex(d) gló(f)ri(e)æ,(d) (,) rex(h) in(h) síg(i)nis(g) vic(h)tó(j)ri(i)æ,(h) (;) Ie(h)su,(i) lar(j)gí(k)tor(j) grá(h)ti(j)æ,(ivHG) (,) ho(h)nor(h) cæ(i)lés(g)tis(e) cú(g)ri(h)æ.(h) (::)\r\n\r\n3. Te(h) cæ(h)li(h) cho(h)rus(d) praé(f)di(e)cat(d) (,) et(h) tu(h)as(i) lau(g)des(h) ré(j)pli(i)cat.(h) (;) Ie(h)sus(i) or(j)bem(k) læ(j)tí(h)fi(j)cat(ivHG) (,) et(h) nos(h) De(i)o(g) pa(e)cí(g)fi(h)cat.(h) (::)\r\n\r\n4. Ie(h)sus(h) in(h) pa(h)ce(d) ím(f)pe(e)rat,(d) (,) quæ(h) om(h)nem(i) sen(g)sum(h) sú(j)pe(i)rat,(h) (;) hanc(h) sem(i)per(j) mens(k) de(j)sí(h)de(j)rat(ivHG) (,) et(h) il(h)lo(i) fru(g)i(e) pró(g)pe(h)rat.(h) (::)\r\n\r\n5. Iam(h) pro(h)se(h)quá(h)mur(d) láu(f)di(e)bus(d) (,) Ie(h)sum,(h) hym(i)nis(g) et(h) pré(j)ci(i)bus,(h) (;) ut(h) nos(i) do(j)net(k) cæ(j)lés(h)ti(j)bus(ivHG) (,) cum(h) ip(h)so(i) fru(g)i(e) sé(g)di(h)bus.(h) (::)\r\n\r\n6. Ie(h)su,(h) flos(h) ma(h)tris(d) vír(f)gi(e)nis,(d) (,) a(h)mor(h) nos(i)træ(g) dul(h)cé(j)di(i)nis,(h) (;) laus(h) ti(i)bi(j) si(k)ne(j) tér(h)mi(j)nis,(ivHG) (,) reg(h)num(h) be(i)a(g)ti(e)tú(g)di(h)nis.(h) (::) A(ded)men.(cd) (::) ",
    office: "hy",
    mode: "d",
    pages: [
    { page: "124", sequence: 0, extent: 1 }
  ...
  },
  {
    ...
    gabc: "(c4)Ec(ixhg/hvGF/ghwiHGhi)ce(h) *(,) ap(f)pa(g)ré(g/hjh)bit(ge~) Dó(fg)mi(gffvED)nus(dfddc) (,) su(d!ewfe/fgf)per(d) nu(c)bem(bxb!cdcd) cán(d)di(de!fvEDe)dam,(ed) *(:) Et(h!iwjjvIG) cum(h) e(jk!lv)o(k) Sanc(j)tó(l)rum(ml) míl(k)li(jk)a :(klkk/hih) (;) et(h) ha(h)bet(j!kl) in(k) ves(k)ti(k)mén(kw!l>)to,(j) (,) et(j) in(h) fé(j)mo(h)re(-ghg) su(h)o(hg/hiHGg) scrip(f!gwh/ivHF/gwh/iv)tum :(hg) (;) Rex(hv//f!goh) re(g/hfg)gum,(fg/ffd) (,) et(d<) Dó(f)mi(f)nus(dfddc) do(f!goh)mi(hghf/gvFE)nán(d)ti(dewfef)um.(ed) (::)\r\n\r\n<sp>V/</sp>. Ap(h)pa(h)ré(h)bit(hg/hggf) in(g) fi(gh)nem,(g) et(g) non(hf~) men(gh)ti(gh)é(h/iih)tur(h) ; (;) si(gf) mo(gh)ram(h) fé(hi)ce(h)rit,(h) ex(h)spé(h)cta(h) e(hi)um,(h) (,) qui(h)a(h) vé(h)ni(hg/hg)ens(gf) vé(fgwhg/hih)ni(hvGFEfwghv)et.(gf) *(::) Et.(h!iwjjvIG) (::)",
    office: "re",
    mode: "1",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) Æ(df)tér(ed)n<i>a</i> i(e)má(g)g<i>o</i> Al(g)tí(ef)si(ed)mi(d) (,) Lu(e)men,(g) De(h)us,(h) de(g) Lú(hj)mi(ivHG)ne,(h) (;) ti(g)bi,(fe) Re(d)démp(ed)tor(c) gló(d)ri(d)a,(e) (,) ho(dh/ig)nor,(h) pot(d)ést(e)as(g) ré(fe)gi(d)a.(e) (::)\r\n\r\n2. Tu(df) so(ed)lus(e) an(g)te(g) saé(ef)cu(ed)la(d) (,) spes(e) at(g)que(h) cen(h)trum(g) tém(hj)po(ivHG)rum(h);(;) ti(g)bi(fe) vo(d)lén(ed)tes(c) súb(d)di(d)mur,(e) (,) qui(dh/ig) iu(h)re(d) cun(e)ctis(g) ím(fe)pe(d)ras.(e) (::)\r\n\r\n3. Tu(df) flos(ed) pu(e)dí(g)cæ(g) Vír(ef)gi(ed)nis,(d) (,) nos(e)træ(g) ca(h)put(h) pro(g)pá(hj)gi(ivHG)nis,(h) (;) la(g)pis(fe) ca(d)dú(ed)cus(c) vér(d)ti(d)ce(e) (,) ac(dh/ig) mo(h)le(d) te(e)rras(g) óc(fe)cu(d)pans.(e) (::)\r\n\r\n4. Di(df)ro(ed) ty(e)rá(g)nno(g) súb(ef)di(ed)ta,(d) (,) dam(e)ná(g)ta(h) stirps(h) mor(g)tá(hj)li(ivHG)um(h) (;) per(g) te(fe) re(d)fré(ed)git(c) vín(d)cu(d)la(e) (,) si(dh/ig)bí(h)que(d) cæ(e)lum(g) vín(fe)di(d)cat.(e) (::)\r\n\r\n5. Doc(df)tor,(ed) sa(e)cer(g)dos,(g) lé(ef)gi(ed)fer(d) (,) præ(e)fers(g) no(h)tá(h)tum(g) sán(hj)gui(ivHG)ne(h) (;) in(g) ves(fe)te(d) «Prin(ed)ceps(c) prín(d)ci(d)pum(e) (,) re(dh/ig)gúm(h)que(d) rex(e) al(g)tís(fe)si(d)mus».(e) (::)\r\n\r\n6. Pa(df)tri,(ed) ti(e)bi,(g) Pa(g)rá(ef)cli(ed)to(d) (,) sit,(e) Chris(g)te,(h) per(h)pes(g) gló(hj)ri(ivHG)a,(h) (;) qui(g) nos(fe) re(d)démp(ed)tos(c) sán(d)gui(d)ne(e) (,) ad(dh/ig) reg(h)na(d) cæ(e)li(g) pér(fe)tra(d)his.(e) (::) A(efe)men.(de) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3)IM(e)ma(ef)cu(f)lá(f!ghf)tam(fe) Con(f)cep(fe)ti(f)ó(fg)nem(f) (,) Vír(f)gi(hg)nis(hfgff) Ma(ef)rí(f!ghf)æ(fe) ce(f)le(hg)bré(hiHG)mus:(g) (;) Chris(i)tum,(ij) e(kxj/kij>)ius(hg) Fí(hi)li(hvGF)um,(f!ghf/gf/fe) (,) a(h)do(gf)ré(fi/ih)mus(gf) Dó(ghf)mi(ef)num.(f) (::)",
    office: "an",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) NI(f!gh)hil(g) *() in(g)qui(ghOiv)ná(h)tum(hg/h!iwjg/hvg/gf) (,) in(g) e(ghGFgh)am(g) in(gh!iwjIH/iwjIH)cúr(ghivHGg)rit: (hg) *(:) Can(j>)dor(jk) est(kvJIjvIHGhg) (,) lu(f)cis(gh) ae(h)tér(gf)nae,(fghvGFEfvEDed) (;) et(d) spé(f!gh)cu(g)lum(g//hig/hvg/gf) si(fh!iwjjv)ne(jkJIH/iwjIH) má(g)cu(gh!ivHGh)la(hg) (::)\r\n<sp>V/</sp>. Est(j) e(j)nim(ji) hæc(jkj/iji/hhg) spe(hi)ci(i)ó(ih)si(ij)or(hi) so(g!hwih)le(hg) (;) et(g) lu(fg)ci(g) com(g)pa(g)rá(gh)ta,(g) in(g)ve(g)ní(hiHG/hih)tur(ghf) pú(gh)ri(h!iwji/jkJIH)or.(hiHGhg) (::)\r\n*() Can(j>)dor.(jk) (::)",
    office: "re",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) IN(h) plau(hhg)su(ed) grá(g)ti(hj) cár(ji)mi(hi)ni(i) (,) ad(k)sit(kj) no(i)va(ji) læ(h)tí(ih)ti(gh)a(h) (;) dum(k) De(k)i(i) ma(k)tris(klk) Vír(j)gi(i)nis(hiHG) (,) su(i)mit(jk) vi(i)ta(ji) prin(h)cí(ih)pi(gh)a.(h) (::)\r\n\r\n2. Ma(h)rí(hhg)a,(ed) mun(g)di(hj) gló(ji)ri(hi)a,(i) (,) lu(k)cis(kj) æ(i)tér(ji)næ(h) fí(ih)li(gh)a,(h) (;) te(k) præ(k)ser(i)vá(k)vit(klk) Fi(j)li(i)us(hiHG) (,) ab(i) om(jk)ni(i) la(ji)be(h) pé(ih)ni(gh)tus.(h) (::)\r\n\r\n3. O(h)ri(hhg)gi(ed)na(g)lis(hj) má(ji)cu(hi)la(i) (,) cun(k)cta(kj) res(i)pér(ji)sit(h) sǽ(ih)cu(gh)la;(h) (;) so(k)la(k) post(i) Na(k)tum(klk) ví(j)ti(i)is(hiHG) (,) num(i)quam(jk) con(i)tác(ji)ta(h) dí(ih)ce(gh)ris.(h) (::)\r\n\r\n4. Ca(h)put(hhg) ser(ed)pén(g)tis(hj) cá(ji)lli(hi)di(i) (,) tu(k)o(kj) pe(i)de(ji) con(h)té(ih)ri(gh)tur;(h) (;) fas(k)tus(k) gi(i)gán(k)tis(klk) pér(j)fi(i)di(hiHG) (,) Da(i)vid(jk) fun(i)da(ji) de(h)vín(ih)ci(gh)tur.(h) (::)\r\n\r\n5. Co(h)lúm(hhg)ba(ed) mi(g)tis,(hj) hú(ji)mi(hi)lis,(i) (,) fers,(k) ca(kj)rens(i) fel(ji)le(h) crí(ih)mi(gh)nis,(h) (;) sig(k)num(k) De(i)i(k) cle(klk)mén(j)ti(i)æ,(hiHG) (,) ra(i)mum(jk) vi(i)rén(ji)tis(h) grá(ih)ti(gh)a.(h) (::)\r\n\r\n6. Pa(h)tri(hhg) sit(ed) et(g) Pa(hj)rá(ji)cli(hi)to,(i) (,)\r\ntu(k)ó(kj)que(i) Na(ji)to(h) gló(ih)ri(gh)a,(h) (;)\r\nqui(k) san(k)cti(i)tá(k)tis(klk) ú(j)ni(i)cæ(hiHG) (,)\r\nte(i) mu(jk)ne(i)rá(ji)runt(h) grá(ih)ti(gh)a.(h) (::) A(hih)men.(gh) (::)",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c3)De(ef@gwhGFg)um,(fe) (,) qui(e) glo(ef)ri(e)fi(e@foh)cá(hvg!hihijv)tur(i) (,) in(i) con(i)cí(i@jwk)li(ji)o(ji) sanc(h)tó(h!ijhhvg)rum,(ef@gwhefveed) (;) ve(df)ní(h!iji/h@io@jv)te,(hhg) a(f)do(fiHG)ré(efe)mus.(e) (::)",
    office: "an",
    mode: "7",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) CHri(dewfd)ste,(dc) cæ(cd)ló(d.)rum(d.) (,) ha(f)bi(e)tá(d)tor(e) al(e.)me,(d.) (;) vi(dh!iv)ta(h) san(h)cto(hg)rum,(gh) vi(f)a,(gh) spes(g) sa(fg)lús(gvFE)que,(d) (:) hós(dg)ti(fe)am(dc) cle(dd)mens(c.) (,) ti(fe)bi(fg) quam(fe) li(dc)tá(de)mus,(ed) (,) sú(dewfd)sci(dc)pe(cd) lau(d.)dis.(d.) 2.(::) Om(dewfd)ni(dc) um(cd) sem(d.)per(d.) (,) cho(f)rus(e) an(d)ge(e)ló(e.)rum(d.) (;) in(dh!iv) po(h)lo(h) te(hg)met(gh) be(f)ne(gh)dí(g)cit(fg) al(gvFE)to,(d) (:) at(dg)que(fe) te(dc) san(dd)cti(c.) (,) si(fe)mul(fg) u(fe)ni(dc)vér(de)si(ed) (,) láu(dewfd)di(dc)bus(cd) or(d.)nant.(d.) 3.(::) Vír(dewfd)gi(dc)nis(cd) san(d.)ctæ(d.) (,) mé(f)ri(e)tis(d) Ma(e)rí(e.)æ(d.) (;) at(dh!iv)que(h) cunc(h)tó(hg)rum(gh) pá(f)ri(gh)ter(g) pi(fg)ó(gvFE)rum,(d.) (:) cón(dg)ti(fe)ne(dc) pœ(dd)nam(c.) (,) pi(fe)e,(fg) quam(fe) me(dc)ré(de)mur(ed) (,) da(dewfd)que(dc) me(cd)de(d.)lam(d.) 4.(::) Hic(dewfd) tu(dc)am(cd) præ(d.)sta(d.) (,) ce(f)le(e)brá(d)re(e) lau(e.)dem,(d.) (;) ut(dh!iv) ti(h)bi(h) fi(hg)di(gh) va(f)le(gh)á(g)mus(fg) il(gvFE)lam(d.) (:) pró(dg)se(fe)qui(dc) in(dc) cæ(dd)lis(c.) (,) Tri(fe)á(fg)di(fe) ca(dc)nén(de)tes(ed) (,) iú(dewfd)gi(dc)ter(cd) hym(d.)nos.(d.) (::) A(ded)men.(cd) (::)",
    office: "hy",
    mode: "1",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c3)PA(-ehg)nem(h) vi(ih@iwjij)tæ(ji) (,) Chri(ijIH)stum(h) Dó(hg/hoi)mi(fe)num,(ef!gwhefveed) (;) \r\nve(df)ní(h!iji/h!ioj)te,(hhg) a(f)do(fiHG)ré(efe)mus.(e) (::)",
    office: "an",
    mode: "7",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) Sa(dh!iv)cris(h) so(hg)lém(h!iwj)ni(ivHG)is(h) (,) junc(h)ta(f) sint(g) gáu(g)di(f)a,(e) (;) \r\net(f) ex(g) præ(f!gh)cór(hg)di(f)is(ed) (,) so(ef)nent(d) præ(c)có(ef)ni(d)a;(d) (;)\r\nre(h)cé(i)dant(ji) vé(g)te(h)ra,(g) no(ih)va(i) sint(ji) ó(h)mni(gh)a,(h) (,)\r\ncor(dh!iv)da,(h) vo(hvGFg)ces(fe) et(d) ó(f)pe(gf)ra.(ed) (::)\r\n\r\n2. Noc(dh!iv)tis(h) re(hg)có(h!iwj)li(ivHG)tur(h) (,) cœ(h)na(f) no(g)vís(g)si(f)ma,(e) (;)\r\nqua(f) Chri(g)stus(f!gh) cré(hg)di(f)tur(ed) (,) a(ef)gnum(d) et(c) á(ef)zy(d)ma(d) (;)\r\nde(h)dís(i)se(ji) frá(g)tri(h)bus,(g) jux(ih)ta(i) le(ji)gí(h)ti(gh)ma(h) (,)\r\npri(dh!iv)scis(h) in(hvGFg)dúl(fe)ta(d) pá(f)tri(gf)bus.(ed) (::)\r\n\r\n3. De(dh!iv)dit(h) fra(hg)gí(h!iwj)li(ivHG)bus(h) (,) cór(h)por(f)ris(g) fér(g)cu(f)lum,(e) (;)\r\nde(f)dit(g) et(f!gh) trí(hg)sti(f)bus(ed) (,) sán(ef)gui(d)nis(c) pó(ef)cu(d)lum(d) (;)\r\ndi(h)cens:(i) «Ac(ji)cí(g)pi(h)te(g) quod(ih) tra(i)do(ji) vá(h)scu(gh)lum;(h) (,)\r\no(dh!iv)mnes(h) ex(hvGFg)e(fe)o(d) bí(f)bi(gf)te.»(ed) (::)\r\n\r\n4.  Sic(dh!iv) sa(h)cri(hg) fí(h!iwj)ci(ivHG)um(h) (,) i(h)stud(f) in(g)stí(g)tu(f)it,(e) (;)\r\ncu(f)jus(g) of(f!gh)fí(hg)ci(f)um(ed) (,) com(ef)mít(d)ti(c) vó(ef)lu(d)it(d) (;)\r\nso(h)lis(i) pres(ji)bý(g)te(h)ris,(g) qui(ih)bus(i) sic(ji) cón(h)gru(gh)it,(h) (,)\r\nut(dh!iv) su(h)mant,(hvGFg) et(fe) dent(d) cé(f)te(gf)ris.(ed) (::)\r\n\r\n5.  Pa(dh!iv)nis(h) an(hg)gé(h!iwj)li(ivHG)cus(h) (,) fit(h) pa(f)nis(g) hó(g)mi(f)num:(e) (;)\r\ndat(f) pa(g)nis(f!gh) cœ́(hg)li(f)cus(ed) (,) fi(ef)gú(d)ris(c) tér(ef)mi(d)num.(d) (;)\r\nO(h) res(i) mi(ji)rá(g)bi(h)lis:(g) man(ih)dú(i)cat(ji) Dó(h)mi(gh)num(h) (,)\r\nser(dh!iv)vus,(h) pau(hvGFg)per(fe) et(d) hú(f)mi(gf)lis.(ed) (::)\r\n\r\n6.  Te(dh!iv) tri(h)na(hg) Dé(h!iwj)i(ivHG)tas(h) (,) ú(h)na(f)que(g) pó(g)sci(f)mus;(e) (;)\r\nsic(f) nos(g) tu(f!gh) ví(hg)si(f)tas(ed) (,) si(ef)cut(d) te(c) có(ef)li(d)mus:(d) (;)\r\nper(h) tu(i)as(ji) sé(g)mi(h)tas(g) duc(ih) nos(i) quo(ji) tén(h)di(gh)mus,(h) (,)\r\nad(dh!iv) lu(h)cem(hvGFg) quam(fe) in(d)há(f)bi(gf)tas.(ed) (::)\r\n\r\nA(ded)men.(cd) (::)\r\n",
    office: "hy",
    mode: "1",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3) Co(ffef/ghGFghff)mé(ef)de(hvGFgvECgfh)tis(gvFEf) *(,) car(hf/hfg/hiHGh)nes,(gvFEf/ghg) (;) et(gvFEf) sa(ced)tu(ef)ra(f!gwhf/gef/egivHGivHGh)bi(f)mi(gh)ni(g) pá(fe)ni(f!gwh)bus:(gf) *(:) I(gi)ste(g) est(hvGFf) pa(e)nis,(fg) (,)\r\nquem(gf/hhg) de(gvFE)dit(h) vo(gf)bis(f) Dó(f)mi(ghivHGh)nus(fg) (;) ad(f) ve(fe)scén(fhGEfgwhGFgigh/GF)(,)(hjIHijg/hif/hvGEf)(,)(cffvED/ef/ehGFEC/efe~)dum.(fhGEf) (::) ()<sp>V/</sp>. Non(f) Moy(efgwhhi>)ses(h) de(ij)dit(i) vo(hi)bis(h) pa(hg)nem(hi>) de(gh) cæ(f!gwhg)lo,(gf) (;) \r\nsed(fc) Pa(ef)ter(f) me(f)us(fe) dat(fgf) vo(ef)bis(f) (,) pa(hi)nem(f) de(ge) cœ(fg)lo(f) ve(hjIGhvGECefe)rum.(fhGEf) *(::) I(gi)ste.(g) (::)\r\n",
    office: "re",
    mode: "2",
    pages: [
  ...
  },
  {
    id: "gregobase:16356",
    incipit: "Venite exsultemus IV**",
    gabc: "(c4) VE(dh)ní(hi)te,(h) ex(h)sul(h)té(h)mus(g) Dó(gh)mi(g)no;(g) (,) \r\nju(g)bi(g)lé(g)mus(g) De(gh)o(g) sa(g)lu(f)tá(fh)ri(h) no(gh)stro.(g) (;) \r\nPræ(g)oc(f)cu(h)pé(hi)mus(h) fá(h)ci(g)em(g) e(gh)jus(g) (,) in(g) con(f)fes(fh)si(h)ó(gh)ne,(hg) (;)\r\net(fe) in(fgf~) psal(gh~)mis(g) ju(g)bi(hghw!ij)lé(h)mus(gh) e(hhgh)i.(ffefo@gv) \r\n(::/) (Z-)\r\nQuó(dh!iv)ni(h)am(h) De(h)us(h) mag(h)nus(g) Dó(gh)mi(g)nus,(g) (,)\r\net(g) Rex(gh) mag(h)nus(g) su(g)per(f) om(fh)nes(h) de(gh)os.(g) (;)\r\nQuó(g)ni(f)am(fh) non(h) re(h)pél(h)let(h) Dó(hi)mi(h)nus(h) ple(h)bem(g) su(gh)am,(g) (,)\r\nqui(g)a(g) in(g) ma(g)nu(g) e(gh)jus(g) sunt(gh) om(g)nes(f) fi(fh)nes(h) ter(gh)ræ,(hg) (;) \r\net(fe) al(fgf~)ti(g)tú(g)di(g)nes(g) món(gh~)ti(g)um(g) (,) i(hghw!ij)pse(h) cón(gh~)spi(hhgh)cit.(ffefo@gv) \r\n(::/) (Z-)\r\nQuó(dh!iv)ni(h)am(h) ip(h)sí(h)us(h) est(g) ma(gh)re,(g) (,) et(g) ip(g)se(g) fe(g)cit(h) il(h)lud(g) (,)\r\net(g) á(gh)ri(g)dam(g) fun(g)da(h)vé(g)runt(f) ma(fh)nus(h) e(gh)jus.(g) (;)\r\nVe(g)ní(f)te,(fh) ad(h)o(h)ré(hi)mus,(h) (,) et(h) pro(h)ci(h)dá(h)mus(h) an(h)te(g) De(gh)um,(g) (,)\r\nplo(fe)ré(f)mus(fg) co(g)ram(g) Dó(gh)mi(g)no,(g) qui(g) fe(gh)cit(g) nos,(g) (,) qui(g)a(g) ip(gh)se(g) est(g) Dó(h)mi(g)nus(f) De(fh)us(h) no(gh)ster,(hg) (;) \r\nnos(fe) au(fgf~)tem(g) pó(g)pu(g)lus(g) e(gh~)jus(g) (,) et(g) o(gh)ves(g) pás(hghw!ij)cu(h)æ(gh) e(hhgh)jus.(ffefo@gv) \r\n(::/) (Z-)\r\n\r\nHó(dh!iv)di(h)e,(h) si(h) vo(h)cem(h) e(h)jus(h) au(h)di(g)é(gh)ri(g)tis:(g) (,) \r\n«No(g)lí(gh)te(g) ob(g)du(h)rá(g)re(f) cor(fh)da(h) ves(gh)tra,(g) (;) si(g)cut(f) in(fh) ex(h)a(h)cer(h)ba(h)ti(h)ó(hi)ne(h) se(h)cún(h)dum(g) di(gh)em(g) ten(fe~)ta(f)ti(fg)ó(g)nis(gh) in(h) de(g)sér(gh)to,(g) (,) u(g)bi(g) ten(g)ta(g)vé(gh)runt(g) me(f) pa(fh)tres(h) ve(gh)stri,(hg) (;) \r\npro(fe)ba(fgf)vé(g)runt(g) et(g) vi(g)dé(gh)runt(g) (,) <nlba>ó(hghw!ij)pe(h)ra(gh) me(hhgh)a.(ffefo@gv)\r\n (::/) (Z-)\r\n\r\nQua(dh!iv)dra(h)gín(h)ta(h) an(h)nis(h) pró(h)xi(g)mus(g) fu(gh)i(g) (,) \r\nge(g)ne(g)ra(g)ti(g)ó(gh)ni(g) hu(g)ic,(g) (,)\r\net(g) di(h)xi:(g) (`) Sem(gh~)per(g) hi(f) er(fh)rant(h) cor(gh)de.(g) (;)\r\nIp(f)si(h) ve(hi)ro(h) non(h) cog(h)no(hZ)vé(h)runt(h) vi(h)as(g) me(gh)as,(g) (,) \r\nqui(g)bus(g) ju(g)rá(gh)vi(g) in(f) i(fh)ra(h) me(gh)a:(hg) (;)\r\nSi(fe) in(fgf~)tro(g)í(gh)bunt(g) (,) in(g) ré(hghw!ij)qui(h)em(gh~) me(hhgh)am.(ffefo@gv) \r\n(::/) (Z-)\r\n%\r\n\r\nGló(dh!iv)ri(h)a(h) Pa(h)tri(g) et(g) Fí(gh)li(g)o,(g) (,) \r\net(h) Spi(g)rí(f)tu(fh)i(h) Sanc(gh)to.(g) (;)\r\nSi(f)cut(h) e(hi)rat(h) in(h) prin(g)cí(gh)pi(g)o,(g) (,)\r\net(f) nunc,(fh) et(h) sem(gh)per,(hg) (;)\r\net(fe) in(fgf~) sǽ(gh)cu(g)la(g) sæ(g)cu(hghw!ij)ló(h)rum.(gh) <nlba>A(hhgh)men.(ffefo@gv)\r\n (::/) \r\n",
    office: "ps",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) HO(g)di(g)e(g) nó(g)bis *(gf) de(h!iwj) cæ(ji!jwkjk)lo(kj) (;) pax(j) vé(ji/jvIH/ij)ra(i) de(i!jwk/JIH/!iwjIH)scén(gh!ivHGh)dit:(hg) (:) * Hó(ji)di(ji)e(h/ijijg) (,) per(g) tó(iji)tum(-ghg) mún(hiHF~)dum(gf) (;) mel(g!hji)lí(j)flu(hgi)i(i) fá(jkj)cti(h!iwj) sunt(i!jwkJIH/!iwjIH) cæ(gh!ivHGh)li.(hg) (::) <sp>V/</sp>. Hó(j)di(ji)e(jkj/iji/hhg) il(hi)lú(i)xit(ih) nó(jk)bis(j) (,) dí(jk)es(j) red(j)em(ji~)pti(ih)ó(ij)nis(hi) nó(g!hwih)væ,(hg) (;) re(g)pa(fg)ra(g)ti(g)ó(g)nis(g) an(g)ti(gh)quæ,(g) (,) fe(g)li(g)ci(g)tá(hiHG/hih)tis(ghf) æ(gh)tér(h!iwji/jkJIH)næ.(hiHG/hg) (::) * Hó(ji)di(ji)e.(h/ijijg) (::)",
    office: "re",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3)NUnc,(f) Sanc(f)te,(f) no(e)bis(f) Spí(h)ri(g)tus,(f) (,) \r\nu(h)num(i) Pa(i)tri(i) cum(h) Fí(i)li(i)o,(j) (;) \r\ndi(j)gná(j)re(i) promp(j)tus(h) ín(i)ge(h)ri(f) (,) \r\nnos(f)tro(e) re(f)fú(h)sus(i) péc(f)to(e)ri.(f) (::)\r\n\r\n2. Os,(f) lin(f)gua,(f) mens,(e) sen(f)sus,(h) vi(g)gor(f) (,)\r\ncon(h)fes(i)si(i)ó(i)nem(h) pér(i)so(i)nent,(j) (;)\r\nflam(j)més(j)cat(i) i(j)gne(h) cá(i)ri(h)tas,(f) (,)\r\nac(f)cén(e)dat(f) ar(h)dor(i) pró(f)xi(e)mos.(f) (::)\r\n\r\n3. Per(f) te(f) sci(f)á(e)mus(f) da(h) Pa(g)trem,(f) (,)\r\nnos(h)cá(i)mus(i) at(i)que(h) Fí(i)li(i)um,(j) (;)\r\nte(j) u(j)tri(i)us(j)que(h) Spí(i)ri(h)tum,(f) (,)\r\ncre(f)dá(e)mus(f) om(h)ni(i) tém(f)po(e)re.(f) (::)\r\nA(fgf)men.(ef) (::)",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)VE(d)ní(e)te,(f) ex(g)sul(g)té(g)mus(h) Dó(h)mi(g)no,(g'_) (,) iu(g)bi(g)lé(g)mus(h) De(h)o,(g') sa(f)lu(d)tá(e)ri(fg) no(e_f)stro.(e.) (;) Præ(d)oc(e)cu(f)pé(g)mus(g) fá(g)ci(g)em(h) e(h)ius(g'_) (,) in(f) con(d)fes(e)si(f)ó(ee)ne,(d.) (;) et(c) in(de~) psal(ef~)mis(e'_) (,) iu(f)bi(fg)lé(ed)mus(fg) e(fe)i.(e.) (::Z)\r\n\r\nQuó(d)ni(e)am(f) De(g)us(g) ma(g)gnus(h) Dó(h)mi(g)nus,(g'_) (,) et(g) rex(g_h) ma(h)gnus(g') su(f)per(d) om(e)nes(fg) de(e_f)os.(e_.) (;) Quó(d)ni(e)am(f) non(g) re(g)pél(g)let(g) Dó(g)mi(g)nus(g) ple(g)bem(h) su(h)am,(g_') (,) qui(e)a(f) in(g) ma(g)nu(h) e(h)ius(g_') (,) sunt(g) om(f)nes(d) fi(e)nes(f) ter(ee)ræ,(d.) (;) et(c) al(de~)ti(e)tú(e)di(e)nes(e) món(ef~)ti(e)um(e_') (,) i(fg)pse(ed) cón(fg)spi(fe)cit.(e.) (::Z)\r\n\r\nQuó(d)ni(e)am(f) i(g)psí(g)us(g) est(h) ma(h)re,(g_') (,) et(g) i(g)pse(g) fe(g)cit(h) il(h)lud,(g_') (,) et(g) á(gh)ri(g)dam(g') fun(g)da(g)vé(f)runt(d) ma(e)nus(fg) e(e_f)ius.(e.) (;) Ve(d)ní(e)te,(f) a(g)do(g)ré(g)mus,(g_') et(g) pro(g)ci(g)dá(g)mus(g) an(g)te(h) De(h)um,(g_') (,) plo(e)ré(f)mus(g) co(g)ram(h) Dó(h)mi(g)no,(g') qui(h) fe(h)cit(g) nos,(g_') (,) qui(e)a(f) i(gh)pse(g) est(g') Dó(g)mi(f)nus,(d) De(e)us(f) no(ee)ster,(d.) (;) nos(c) au(de~)tem(e) pó(e)pu(e)lus(e) e(ef~)ius,(e_') (,) et(e) o(ef)ves(e) pá(fg)scu(ed)æ(fg) e(fe~)ius.(e.) (::Z)\r\n\r\nHó(d)di(e)e,(f) si(g) vo(g)cem(g) e(g)ius(g) au(g)di(h)é(h)ri(g)tis:(g_')  «(,)No(g)lí(gh)te(g') ob(g)du(g)rá(f)re(d) cor(e)da(fg) ve(e_f)stra,(e.) (;) si(d)cut(e) in(f) e(g)xa(g)cer(g)ba(g)ti(g)ó(g)ne(g_') se(g)cún(g)dum(h) di(h)em(g_') (,) ten(e)ta(f)ti(g)ó(g)nis(g) in(g) de(h)sér(h)to:(g.) (,) u(gh)bi(g') ten(g)ta(g)vé(g)runt(f) me(d') pa(e)tres(f) ve(ee)stri:(d.) (;) pro(c)ba(de)vé(e)runt(e) et(e) vi(e)dé(ef)runt(e_) (,) ó(fg)pe(ed)ra(fg) me(fe)a.(e.) (::Z)\r\n\r\nQua(d)dra(e)gín(f)ta(g) an(g)nis(g) pró(g)xi(g)mus(h) fu(h)i(g_') (,) ge(g)ne(g)ra(g)ti(h)ó(h)ni(g') hu(g)ic,(g_') (,) et(g) di(gh)xi:(g') (`) Sem(g)per(f) hi(d) er(e)rant(fg) cor(e_f)de.(e.) (;) I(d)psi(e) ve(f)ro(g) non(g) co(g)gno(g)vé(g)runt(g) vi(g)as(h) me(h)as:(g.) (,) qui(gh)bus(g) iu(g)rá(g)vi(f) in(d) i(e)ra(f) me(ee)a:(d.) (;) Si(c) in(de~)tro(e)í(ef)bunt(e_') (,) in(f) ré(fg)qui(ed)em(fg) me(fe)am.»(e.) (::Z)\r\n\r\nGló(d)ri(e)a(f) Pa(g)tri,(g) et(h) Fí(h)li(g)o,(g_') (,) et(g) Spi(f)rí(d)tu(e)i(fg) San(e_f)cto.(e.) (;) Si(d)cut(e) e(f)rat(g) in(g) prin(h)cí(h)pi(g)o,(g_') (,) et(d) nunc,(e) et(f) sem(ee)per,(d.) (;) et(c) in(de~) s{<sp>'ae</sp>}(ef)cu(e)la(e') sæ(f)cu(fg)ló(ed)rum.(fg) A(fe)men.(e.) (::)",
    office: "ps",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) Chri(d)stum(dfd~) na(e)tum,(e/fgf/eeo@fvded.0) (,)\r\nqui(dfe) be(fg)á(g)tum(g') co(f)ro(ghg)ná(h)vit(gf) Sté(gh)pha(gf)num,(efEDd) (;) ve(c)ní(c!dwe!fv)te,(ed__) ad(-dfe)o(fg)ré(ghGFg)mus.(fe..) (::)",
    office: "an",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) FEs(d)tum(e) ce(f)lé(g)bre(gvFE) már(d)ty(de)ris(e) (,) di(e)gne(e) co(ed)lá(g)mus(gh) Sté(h)pha(gh)ni,(h) (;) qui(hi) pri(j)mus(ivHG) in(h) cer(g)tá(h)mi(gvFE)ne(e) (,) pal(e)ma(g) ni(gh)tet(g) vic(g)to(fe)ri(de)æ.(e) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
    { page: "479", sequence: 0, extent: 1 }
  ...
  },
  {
    ...
    gabc: "(c4)Re(c@dwefv)gem(e) A(e)pos(e)to(e)ló(e)rum(fg~) Dó(ge)mi(f)num,(deDC) (;) ve(ce@fwg)ní(g)te,(gh) ad(hvGF)ó(g)re(gvFE)mus.(e) (::)",
    office: "an",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Ex(ddc)súl(cf)tet(ed) cæ(dh)lum(h) láu(g')di(f)bus,(e./ghd.) (;)\r\nre(f)súl(ed)tet(de) ter(g)ra(g) gáu(g')di(f)is(ed/ffd.) (:)\r\nA(d)pos(d')to(d)ló(dh)rum(h) gló(h')ri(g)am(hv_GF'/gwhGFED.) (;)\r\nsa(e)cra(g') ca(g)nunt(ghg/hvGF'ED) sol(fe)lém(d)ni(cd)a.(d_eD'Cd.) (::)\r\n\r\n2. Vos,(ddc) sæ(cf)cli(ed) jus(dh)ti(h) jú(g')di(f)ces,(e./ghd.) (;)\r\net(f) ve(ed)ra(de) mun(g)di(g) lú(g')mi(f)na,(ed/ffd.) (:)\r\nvo(d)tis(d') pre(d)cá(dh)mur(h) cór(h')di(g)um:(hv_GF'/gwhGFED.) (;)\r\nau(e)dí(g')te(g) pre(ghg/hvGF'ED)ces(fe) súp(d)pli(cd)cum.(d_eD'Cd.) (::)\r\n\r\n3. Qui(ddc) cæ(cf)lum(ed) ver(dh)bo(h) cláu(g')di(f)tis,(e./ghd.) (;)\r\nse(f)rás(ed)que(de) e(g)jus(g) sól(g')vi(f)tis,(ed/ffd.) (:)\r\nnos(d) a(d') pec(d)cá(dh)tis(h) óm(h')ni(g)bus(hv_GF'/gwhGFED.) (;)\r\nsól(e)vi(g')te(g) jus(ghg/hvGF'ED)su,(fe) quǽ(d)su(cd)mus.(d_eD'Cd.) (::)\r\n\r\n4. Quo(ddc)rum(cf) præ(ed)cép(dh)to(h) súb(g')di(f)tur(e./ghd.) (;)\r\nsa(f)lus(ed) et(de) lan(g)guor(g) óm(g')ni(f)um,(ed/ffd.) (:)\r\nsa(d)ná(d')te(d) æ(dh)gros(h) mó(h')ri(g)bus,(hv_GF'/gwhGFED.) (;)\r\nnos(e) red(g')dén(g)tes(ghg/hvGF'ED) vir(fe)tú(d)ti(cd)bus:(d_eD'Cd.) (::)\r\n\r\n5. Ut,(ddc) cum(cf) Ju(ed)dex(dh) ad(h)vé(g')ne(f)rit(e./ghd.) (;)\r\nchris(f)tus(ed) in(de) fi(g)ne(g) sǽ(g')cu(f)li,(ed/ffd.) (:)\r\nnos(d) sem(d')pi(d)tér(dh)ni(h) gáu(h')di(g)i(hv_GF'/gwhGFED.) (;)\r\nfá(e)ci(g')at(g) es(ghg/hvGF'ED)se(fe) cóm(d)po(cd)tes.(d_eD'Cd.) (::)\r\n\r\n6. De(ddc)o(cf) sint(ed) lau(dh)des(h) gló(g')ri(f)æ,(e./ghd.) (;)\r\nqui(f) dat(ed) nos(de) e(g)van(g)gé(g')li(f)cis(ed/ffd.) (:)\r\nper(d) vos(d') doc(d)trí(dh)nis(h) ins(h')tru(g)i(hv_GF'/gwhGFED.) (;)\r\net(e) pró(g')se(g)qui(ghg/hvGF'ED) cæ(fe)lés(d)ti(cd)a.(d_eD'Cd.) (::)\r\n\r\nA(ded)men.(cd..) (::)",
    office: "hy",
    mode: "1",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)CHri(d)stum(-dfd~) na(e)tum,(e/fgf/eeo@fv/ded) (,) qui(d) In(-dfe)no(fg)cén(gh)tes(g) co(f)ro(-ghg)ná(h)vit(gf) már(gh)ty(gf)res,(efEDd) (;) ve(c)ní(c!dwefv)te,(ed) ad(-dfe)o(fg)ré(ghGFg)mus.(fe) (::)",
    office: "an",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4) CHris(g)te,(g) qui(e) splen(g)dor(h) et(i) di(j)es(h'_,)\r\nnoc(g)tis(i) te(h)né(j)bras(g) dé(hi)te(i)git,(i.) (;)\r\nlu(h)cís(j)que(k) lu(ih)men(j) cré(i)de(j)ris,(hvGF,)\r\nlu(h)men(hg) be(j)á(ij)tis(h) prǽ(g)di(fg)cans.(g.) (::)",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Æ(e)tér(c)ne(d) lu(f)cis(ef) Cón(g)di(f)tor,(e'_) (,) \r\nlux(e) i(c)pse(d) to(f)tus(ef) et(g) di(g)es,(g.) (;)\r\nno(g)ctem(f) nec(g) ul(h)lam(gf) sén(g)ti(f)ens(e'_) (,)\r\nna(e)tu(c)ra(d) lu(f)cis(ef) pér(g)pe(f)tis.(e.) (::) ",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Vi(d_)ta(c) sanc(d)tó(fg)rum,(f_') (,) vi(g)a,(h) spes(g) sa(f)lús(g.)que,(h.) (;)\r\nChris(gh)te,(i) lar(h)gí(gf)tor(e'_) (,) pro(d)bi(f)tá(e)tis(f) at(d.)que(c.) (:)\r\ncón(d_)di(c)tor(d) pa(fg)cis,(f'_) (,) ti(g)bi(h) vo(g)ce,(f) sen(e.)su(d.) (,)\r\npán(f_)gi(e)mus(f) hym(dc)num:(d.) (::)",
    office: "hy",
    mode: "1",
    pages: [
    { page: "217", sequence: 0, extent: 1 }
  ...
  },
  {
    ...
    gabc: "(c4)DE(f)us,(f) qui(g) cla(h)ro(f) lú(g)mi(f)ne(e'_) (,)\r\ndi(g)em(f) fe(f)cís(e)ti,(d) Dó(f)mi(g)ne,(f.) (;)\r\ntu(f)am(f) ro(g)gá(h)mus(f) gló(g)ri(f)am(e'_) (,)\r\ndum(g) pro(f)nus(f) di(e)es(d) vól(f)vi(e)tur.(d.) (::)",
    office: "hy",
    mode: "1",
    pages: [
    { page: "233", sequence: 0, extent: 1 }
  ...
  },
  {
    ...
    gabc: "(c4)DE(e)us,(c) qui(d) cæ(f)li(ef) lu(g)men(f) es(e'_) (,)\r\nsa(e)tór(c)que(d) lu(f)cis,(ef) qui(g) po(g)lum(g.) (;)\r\npa(g)tér(f)no(g) ful(h)tum(gf) brá(g)chi(f)o(e'_) (,)\r\npræ(e)clá(c)ra(d) pan(f)dis(ef) déx(g)te(f)ra,(e.) (::)",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3)Ad(f)és(e)to,(f) re(h)rum(i) cón(h)di(g)tor,(f'_) (,)\r\npa(i)tér(i)næ(h) lu(i)cis(j) gló(h)ri(g)a,(f.) (;)\r\ncu(f)ius(f) a(g)mó(e)ta(c) grá(e)ti(f)a(f'_) (,)\r\nnos(f)tra(e) pa(f)vés(h)cunt(i) péc(h)to(g)ra,(f.) (::)",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3)De(f)us(e) de(f) nul(h)lo(i) vé(h)ni(g)ens,(f'_) (,)\r\nDe(i)us(i) de(h) De(i)o(j) pród(h)i(g)ens,(f.) (;)\r\nDe(f)us(f) ab(g) his(e) pro(c)gré(e)di(f)ens,(f'_) (,)\r\nin(f) nos(e) ve(f)ni(h) sub(i)vé(h)ni(g)ens.(f.) (::)",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Di(g)cá(g)mus(d) lau(f)des(g) Dó(hg)mi(fg)no(g'_) (,)\r\nfer(j)vén(i)te(h) promp(i)ti(g) spí(hg)ri(fg)tu;(g.) (;)\r\nho(j)ra(i) vo(h)lú(j)ta(k) sé(j)xi(ivHG)es(g'_) (,)\r\nnos(f) ad(h) o(i)rán(h)dum(g) pró(hg)vo(fg)cat.(g.) (::)",
    office: "hy",
    mode: "8",
    pages: [
    { page: "221", sequence: 0, extent: 1 }
  ...
  },
  {
    id: "gregobase:16848",
    incipit: "Quid sum",
    gabc: "(c4)Quid(f) sum(e) mi(f)ser(d') tunc(e) dic(c)tú(d)rus,(d.) (;)\r\nquem(f) pa(fg)tró(fe)num(dc) ro(e)ga(f)tú(e)rus,(d.;)\r\ncum(a) vix(cd) ius(d)tus(dc) sit(e) se(f)cú(e)rus?(d.) (::)\r\n\r\n2. Rex(f) tre(e)mén(f)dæ(d') ma(e)ies(c)tá(d)tis,(d.) (;)\r\nqui(f) sal(fg)ván(fe)dos(dc) sal(e)vas(f) gra(e)tis,(d.;)\r\nsal(a)va(cd) me,(d) fons(dc) pi(e)e(f)tá(e)tis.(d.) (::)\r\n3. Re(h)cor(j)dá(j)re,(igh) Ie(hvGF)su(g) pi(h)e,(h.d.) (;)\r\nquod(f) sum(e) cau(f)sa(d') tu(e)æ(c) vi(d)æ,(d.) (;)\r\nne(f) me(gh) per(hvGF)das(evDC) il(e)la(f) di(e)e.(d.) (::)\r\n\r\n4. Quæ(h)rens(j) me(j) se(igh)dís(hvGF)ti(g) las(h)sus,(h.d.) (;)\r\nred(f)e(e)mís(f)ti(d') cru(e)cem(c) pas(d)sus;(d.) (;)\r\ntan(f)tus(gh) la(hvGF)bor(evDC) non(e) sit(f) cas(e)sus.(d.) (::)\r\n5. Ius(h)te(gf) iu(g)dex(hd) ul(dc)ti(a)ó(cd)nis,(d.) (;)\r\ndo(fe)num(d) fac(c) re(a)mis(c)si(d)ó(f)nis(ecd.) (;)\r\nan(h)te(f) di(g)em(d') ra(c)ti(d)ó(f)nis.(ecd.) (::)\r\n\r\n6. In(h)ge(gf)mís(g)co(hd) tam(dc)quam(a) re(cd)us,(d.) (;)\r\ncul(fe)pa(d) ru(c)bet(a) vul(c)tus(d) me(f)us;(ecd.) (;)\r\nsup(h)pli(f)cán(g)ti(d') par(c)ce,(d) De(f)us.(ecd.) (::)\r\n7. O(f) tu,(e) De(f)us(d) ma(e)ies(c)tá(d)tis,(d.) (;)\r\nal(f)me(fg) can(fe)dor(dc) Tri(e)ni(f)tá(e)tis,(d.) (;)\r\nnos(a) con(cd)iún(d)ge(dc) cum(e) be(f)á(e)tis.(d.) (::)\r\nA(cefvED)men.(c.d.) (::)\r\n",
    office: "hy",
    mode: "1",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Pec(f)ca(e)trí(f)cem(d') qui(e) sol(c)vís(d)ti(d.) (;)\r\net(f) la(fg)tró(fe)nem(dc) ex(e)au(f)dís(e)ti,(d.) (;)\r\nmi(a)hi(cd) quo(d)que(dc) spem(e) de(f)dís(e)ti.(d.) (::)\r\n\r\n2. Pre(f)ces(e) me(f)æ(d') non(e) sunt(c) di(d)gnæ,(d.) (;)\r\nsed(f) tu,(fg) bo(fe)nus,(dc) fac(e) be(f)ní(e)gne(d.) (;)\r\nne(a) per(cd)én(d)ni(dc) cre(e)mer(f) i(e)gne.(d.) (::)\r\n3. In(h)ter(j) o(j)ves(igh) lo(hvGF)cum(g) præ(h)sta(h.d.) (;)\r\net(f) ab(e) hæ(f)dis(d') me(e) se(c)qués(d)tra,(d.) (;)\r\nstá(f)tu(gh)ens(hvGF) in(evDC) par(e)te(f) dex(e)tra.(d.) (::)\r\n\r\n4. Con(h)fu(j)tá(j)tis(igh) ma(hvGF)le(g)díc(h)tis,(h.d.) (;)\r\nflam(f)mis(e) á(f)cri(d')bus(e) ad(c)díc(d)tis,(d.) (;)\r\nvo(f)ca(gh) me(hvGF) cum(evDC) be(e)ne(f)díc(e)tis.(d.) (::)\r\n5. O(h)ro(gf) sup(g)plex(hd) et(dc) ac(a)clí(cd)nis,(d.) (;)\r\ncor(fe) con(d)trí(c)tum(a) qua(c)si(d) ci(f)nis,(ecd) (;)\r\nge(h)re(f) cu(g)ram(d') me(c)i(d) fi(f)nis.(ecd.) (::)\r\n6. La(d)cri(h)mó(ixhi)sa(h') di(g)es(fe) il(g)la,(h.) (;)\r\nqua(f) re(e)súr(g)get(h.) ex(dfEDC) fa(f)víl(e)la(d.) (::)\r\n7. Iu(h)di(j)cán(k)dus(jvIH) ho(hvGF)mo(g) re(h)us:(h.d.) (;)\r\nhu(f)ic(e) er(g)go(h.) par(dfEDC)ce,(f) De(e)us.(d.) (::)\r\nA(cefvED)men.(c.d.) (::)\r\n",
    office: "hy",
    mode: "1",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Ma(h)rí(hhg)a,(ed) quæ(g) mor(hj)tá(ji)li(hi)um(i'_) (,)\r\npre(k)ces(kj) a(i)mán(ji)ter(h) éx(ih)ci(gh)pis,(h.) (;)\r\nro(k)gá(k)mus(i) ec(k)ce(klk) súp(j)pli(i)ces,(hiHG'_) (,)\r\nno(i)bis(jk) ad(i)és(ji)to(h) pér(ih)pe(gh)tim.(h.) (::)",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3)Pre(ef)cé(f)mur(gh) om(i)nes(hg) cér(f)nu(ef)i,(f.) (,)\r\ncla(fe)mé(h)mus(i) at(ji)que(h) sín(ivHG)gu(fg)li,(g.) (;)\r\nplo(i)ré(ij)mus(i) an(ih)te(fg) iú(hih)di(fe)cem,(e.) (,)\r\nflec(ef)tá(f)mus(gh) i(i)ram(hg) vín(fgf)di(ef)cem:(f.) (::)\r\n",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)\r\nPe(f)trus(e) be(d)á(c!de)tus(e) (,)\r\nca(e)te(f)ná(g)rum(fe) lá(d)que(cd)os(d) (;)\r\nChris(f)to(gh) iu(h)bén(gh)te(dc) (,)\r\nru(f)pit(gh) mi(g)ra(fe)bí(d)li(e)ter;(e) (:)\r\ncus(g)tos(h) o(j)ví(j)lis(jh) (,)\r\net(h) doc(hi)tor(g) Ec(gf)clé(e)si(fg)æ,(g) (;)\r\npas(g)tór(hi)que(h) gre(gh)gis,(h) (,)\r\ncon(h)ser(hi)vá(g)tor(ge) ó(f)vi(ed)um(de) (;)\r\nar(c)cet(d) lu(f)pó(ef)rum(d) (,)\r\ntru(e)cu(f)lén(gh)tam(g) rá(fe)bi(de)em.(e) (::)",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "name: ;Venite, servi, Pentecost\r\nuser-notes: ;\r\ncommentary: ;\r\nannotation: ;\r\ncentering-scheme: latin;\r\n%fontsize: 12;\r\n%spacing: vichi;\r\n%font: OFLSortsMillGoudy;\r\n%width: 4.5;\r\n%height: 11;\r\n%%\r\n(c4)VE(d)ní(d)te,(df) ser(d)vi,(dc) súp(f)pli(gh)ces,(h) (,)\r\net(hg) men(j)t<i>e</i>() et(jk) o(j)r<i>e</i>() ex(ji)tól(h)li(gh)te(h) (;)\r\ndi(d)gnis(h) be(hih)á(g)tum(ge) láu(f)di(ed)bus(de) (,)\r\nno(c)men(ed) De(g)i(ghg) cum(fe) cán(d)ti(cd)co.(d) (::)\r\n2. Hoc(d) nam(d)que(df) tem(d)pus(dc) il(f)lud(gh) est,(h) (,)\r\nquo(hg) sæ(j)cu(jk)ló(j)rum(ji) iú(h)di(gh)cem(h) (;)\r\nin(d)iú(h)sta(hih) mor(g)ti(ge) trá(f)di(ed)dit(de) (,)\r\nmor(c)tá(ed)li(g)um(ghg) sen(fe)tén(d)ti(cd)a.(d) (::)\r\n3. Et(d) nos(d) a(df)mó(d)re(dc) dé(f)bi(gh)to,(h) (,)\r\nti(hg)mó(j)re(jk) iu(j)sto(ji) súb(h)di(gh)ti,(h) (;)\r\nad(d)vér(h)sus(hih) om(g)nes(ge) ím(f)pe(ed)tus(de) (,)\r\nquos(c) sæ(ed)vus(g) ho(ghg)stis(fe) ín(d)cu(cd)tit,(d) (::)\r\n4. U(d)num(d) ro(df)gé(d)mus(dc) et(f) Pa(gh)trem(h) (,)\r\nDe(hg)um(j) re(jk)gém(j)que(ji) Fí(h)li(gh)um(h) (;)\r\nsi(d)múl(h)que(hih) San(g)ctum(ge) Spí(f)ri(ed)tum,(de) (,)\r\nin(c) Tri(ed)ni(g)tá(ghg)te(fe) Dó(d)mi(cd)num.(d) (::) A(ded)men.(cd) (::)\r\n",
    office: "hy",
    mode: "1",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)HÆC(d) ho(d)ra,(df) quæ(d) res(dc)plén(f)du(gh)it(h) (,)\r\ncru(hg)cís(j)que(jk) sol(j)vit(ji) nú(h)bi(gh)la,(h) (;)\r\nmun(d)dum(h) te(hih)né(g)bris(ge) é(f)xu(ed)ens,(de) (,)\r\nred(c)dens(ed) se(g)ré(ghg)na(fe) lú(d)mi(cd)na.(d) (::)\r\n2. Hæc(d) ho(d)ra,(df) qua(d) re(dc)sú(f)sci(gh)tans(h) (,)\r\nIe(hg)sus(j) se(jk)púl(j)cris(ji) cór(h)po(gh)ra,(h) (;)\r\npro(d)dí(h)re(hih) mor(g)tis(ge) lí(f)be(ed)ra(de) (,)\r\nius(c)sit(ed) re(g)fú(ghg)so(fe) spí(d)ri(cd)tu.(d) (::)\r\n3. No(d)vá(d)ta(df) sæ(d)cla(dc) cré(f)di(gh)mus(h) (,)\r\nmor(hg)tis(j) so(jk)lú(j)tis(ji) lé(h)gi(gh)bus,(h) (;)\r\nvi(d)tæ(h) be(hih)á(g)tæ(ge) mú(f)ne(ed)ra(de) (,)\r\ncur(c)sum(ed) pe(g)rén(ghg)nem(fe) cúr(d)re(cd)re.(d) (::)\r\n4. Ie(d)su,(d) ti(df)bi(d) sit(dc) gló(f)ri(gh)a,(h) (,)\r\nqui(hg) mor(j)te(jk) vi(j)cta(ji) pr<sp>'ae</sp>(h)ni(gh)tes,(h) (;)\r\ncum(d) Pa(h)tr<i>e</i>() et(hih) al(g)mo(ge) Spí(f)ri(ed)tu,(de) (,)\r\nin(c) sem(ed)pi(g)tér(ghg)na(fe) s<sp>'ae</sp>(d)cu(cd)la.(d) (::) A(ded)men.(cd) (::)",
    office: "hy",
    mode: "1",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)IAM(d) Chri(d)stus,(df) astr<i>a</i>(d) a(dc)scén(f)de(gh)rat,(h) (,)\r\nre(hg)gré(j)ssus(jk) un(j)de(ji) vé(h)ne(gh)rat,(h) (;)\r\npro(d)mí(h)ssa(hih) Pa(g)tris(ge) mú(f)ne(ed)ra,(de) (,)\r\nSanc(c)tum(ed) da(g)tú(ghg)rus(fe) Spí(d)ri(cd)tum.(d) (::)",
    office: "hy",
    mode: null,
    pages: [
  ...
  },
  {
    id: "gregobase:17817",
    incipit: "O vir beate",
    gabc: "(c4) O(e) vir(e) be(ed)át<i>e,</i>(g) A(h)pós(j)to(j)lis(i_h_) (,) co(i)mes(j) la(i)bo(h)rum(g) dé(h!iwji)di(hg)te(g.) (;) ad(gh)iú(j)tor(i) at(h)que(g) mú(i)ne(g)ris,(h_g_) (,) lau(hi)des(g) pre(h)cés(gf)que(d) sú(f!gwhg)sci(fe)pe.(e.) (::)",
    office: "hy",
    mode: "3",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)O(ded) Chri(c)ste,(d) flos(fe) con(fgFE)vál(d)li(cd)um,(d_,)\r\nte(c) láu(e)di(d)bus(f) ex(fe)tól(d)li(ce)mus,(e.;)\r\nquod(d) hanc(dh) or(h)ná(g)sti(fvED) vír(f)gi(gf)nem(e_,)\r\npal(c)mis(e) quo(d)que(e) mar(fe)tý(d)ri(cd)i.(d.::) \r\n2.() Hæc(ded) pru(c)dens,(d) for(fe)tis,(fgFE) sá(d)pi(cd)ens,(d_,)\r\nfi(c)dem(e) pro(d)fés(f)sa,(fe) lí(d)be(ce)re,(e.;)\r\npro(d) te(dh) di(h)ra(g) sup(fvED)plí(f)ci(gf)a(e_,)\r\nex(c)cé(e)pit(d) im(e)per(fe)tér(d)ri(cd)ta.(d.::) \r\n3.() Sic(ded) spre(c)to(d) mun(fe)di(fgFE) prín(d)ci(cd)pe,(d_,)\r\ntu(c)o(e) di(d)tá(f)ta(fe) mú(d)ne(ce)re,(e.;)\r\ncru(d)én(dh)to(h) par(g)ta(fvED) proe(f)li(gf)o,(e_,)\r\næ(c)tér(e)na(d) tu(e)lit(fe) prǽ(d)mi(cd)a.(d.::) \r\n4.() Hu(ded)ius,(c) Re(d)dém(fe)ptor,(fgFE) mé(d)ri(cd)tis(d_,)\r\nnos(c) pi(e)us(d) ad(f)de(fe) só(d)ci(ce)os,(e.;)\r\nut,(d) men(dh)te(h) pu(g)ra,(fvED) frú(f)cti(gf)bus(e_,)\r\ntu(c)i(e) fru(d)á(e)mur(fe) sán(d)gui(cd)nis.(d.::) \r\n5.() Ie(ded)su,(c) ti(d)bi(fe) sit(fgFE) gló(d)ri(cd)a,(d_,)\r\nqui(c) na(e)tus(d) es(f) de(fe) Vír(d)gi(ce)ne,(e.;)\r\ncum(d) Pa(dh) tr<i>e</i>() et(h) al(g)mo(fvED) Spí(f)ri(gf)tu,(e_,)\r\nin(c) sem(e)pi(d)tér(e)na(fe) sǽ(d)cu(cd)la.(d.::)\r\nA(ded)men.(cd..) (::)\r\n",
    office: "hy",
    mode: "1",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Æ(ed)tér(g)ne(hj) re(j)rum(ij) cón(k)di(j)tor,(ih__) (,)\r\nqui(g) ma(hj)re,(j) so(i)lum,(ji) ǽ(h)the(gi)ra(i.) (;)\r\ngu(i)bér(g)nas,(hi) iu(i)stus(hj) réd(g)di(gf)tor(e'_) (,)\r\ncun(f)ctis(g) se(f)cún(g)dum(ghg) ó(fe)pe(de)ra,(e.) \r\n2.(::) Su(ed)pér(g)bum(hj) qui(j) iam(ij) spí(k)ri(j)tum(ih__) (,)\r\ne(g)iús(hj)que(j) cun(i)ctos(ji) cóm(h)pli(gi)ces(i.) (;)\r\ncon(i)dém(g)nans(hi) in(i) in(hj)tér(g)i(gf)tum,(e'_) (,)\r\nve(f)ros(g) fir(f)má(g)sti(ghg) súp(fe)pli(de)ces,(e.) \r\n3.(::) Pre(ed)cá(g)mur(hj) te(j) fi(ij)dén(k)ti(j)us,(ih__) (,)\r\nhos(g) de(hj)fen(j)só(i)res(ji) dí(h)ri(gi)ge,(i.) (;)\r\nno(i)bis(g) per(hi) quos(i) pro(hj)pí(g)ti(gf)us(e'_) (,)\r\nsa(f)lú(g)tis(f) do(g)na(ghg) pór(fe)ri(de)ge.(e.) \r\n4.(::) Nos(ed) con(g)so(hj)lán(j)do(ij) ví(k)si(j)tent,(ih__) (,)\r\npur(g)gent,(hj) in(j)flám(i)ment,(ji) dó(h)ce(gi)ant,(i.) (;)\r\nad(i) bo(g)na(hi) sem(i)per(hj) ín(g)ci(gf)tent,(e'_) (,)\r\nvim(f) dǽ(g)mo(f)num(g) co(ghg)ér(fe)ce(de)ant.(e.) \r\n5.(::) O(ed) an(g)ge(hj)ló(j)rum(ij) gló(k)ri(j)a,(ih__) (,)\r\nse(g)cú(hj)ro(j) gres(i)su(ji) pér(h)ge(gi)re(i.) (;)\r\nfac(i) ho(g)rum(hi) nos(i) cu(hj)stó(g)di(gf)a,(e'_) (,)\r\nut(f) te(g) pos(f)sí(g)mus(ghg) cér(fe)ne(de)re.(e.) \r\n6.(::) Sint,(ed) an(g)ge(hj)ló(j)rum(ij) Dó(k)mi(j)ne,(ih__) (,)\r\nho(g)nó(hj)ris(j) ti(i)bi(ji) cán(h)ti(gi)ca,(i.) (;)\r\nqui(i) mi(g)ro(hi) præ(i)bes(hj) ór(g)di(gf)ne(e'_) (,)\r\nil(f)lis(g) no(f)bís(g)que(ghg) cǽ(fe)li(de)ca.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "3",
    pages: [
    { page: "448", sequence: 0, extent: 1 }
  ...
  },
  {
    ...
    gabc: "(c4)AN(h_)ge(g)lum(h) pa(gf)cis(e.) (,) Mí(e)cha(g)el(e) ad(f) i(e.)stam,(d.) (;)\r\nChri(d)ste,(d) de(dh)mít(h)ti(h_g_j_) ro(i)gi(h)tá(g)mus(h) au(gf)lam,(e.) (:)\r\ncun(f_)cta(e) quo(g) cre(ghGEf)bro(d.) (,) ve(e)ni(g)én(e)te(f) cre(ed)scant(c'_) (,)\r\npró(f_)spe(e)ra(g) no(fe)bis.(d.) \r\n2.(::) An(h_)ge(g)lus(h) for(gf)tis(e.) (,) Gá(e)bri(g)el,(e) ut(f) ho(e.)stem(d.) (;)\r\npel(d)lat(d) an(dh)tí(h)quum,(h_g_j_) vó(i)li(h)tet(g) su(h)pér(gf)ne,(e.) (:)\r\nsǽ(f_)pi(e)us(g) tem(ghGEf)plum(d.) (,) cú(e)pi(g)ens(e) fa(f)vén(ed)do(c'_) (,)\r\nví(f_)se(e)re(g) no(fe)strum.(d.) \r\n3.(::) An(h_)ge(g)lum(h) no(gf)bis(e.) (,) mé(e)di(g)cum(e) sa(f)lú(e.)tis(d.) (;)\r\nmit(d)te(d) de(dh) cæ(h)lis(h_g_j_) Rá(i)pha(h)el,(g) ut(h) om(gf)nes(e.) (:)\r\nsa(f_)net(e) æ(g)gró(ghGEf)tos(d.) (,) pa(e)ri(g)tér(e)que(f) no(ed)stros(c'_) (,)\r\ndí(f_)ri(e)gat(g) a(fe)ctus.(d.) \r\n4.(::) Chri(h_)ste,(g) san(h)ctó(gf)rum(e.) (,) de(e)cus(g) an(e)ge(f)ló(e.)rum,(d.) (;)\r\nad(d)sit(d) il(dh)ló(h)rum(h_g_j_) cho(i)rus(h) us(g)que(h) no(gf)bis,(e.) (:)\r\nut(f_) si(e)mul(g) tan(ghGEf)dem(d.) (,) Trí(e)a(g)di(e) per(f) æ(ed)vum(c'_) (,)\r\ncár(f_)mi(e)na(g) de(fe)mus.(d.) (::)\r\nA(ded)men.(cd..) (::)\r\n",
    office: "hy",
    mode: "1",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)Chri(ghg)ste,(f) cun(g)ctó(gh)rum(gf__) (,) do(h)mi(h)ná(hiwjh)tor(ih) al(g.)me,(g.) (;)\r\nplebs(j_) ti(i)bi(k) sup(ji)plex(i_j) (,) ré(h)so(g)net(h) in(i) au(h.)la,(g.) (:)\r\nán(gh)nu(i)o(h) cu(ghg)ius(e_f) (,) ré(g)de(h)unt(g) co(f)lén(ef)da(d.) (,)\r\ntém(ghg)po(f)re(g) fe(gh)sta.(g.) \r\n2.(::) Hic(ghg) lo(f)cus(g) nem(gh)pe(gf__) (,) vo(h)ci(h)tá(hiwjh)tur(ih) au(g.)la(g.) (;)\r\nre(j_)gis(i) im(k)mén(ji)si(i_j) (,) ni(h)ti(g)dí(h)que(i) cæ(h.)li(g.) (:)\r\npor(gh)ta,(i) quæ(h) vi(ghg)tæ(e_f) (,) pá(g)tri(h)am(g) pe(f)tén(ef)tes(d.) (,)\r\nác(ghg)ci(f)pit(g) om(gh)nes.(g.) \r\n3.(::) Hæc(ghg) tu(f)am(g) ple(gh)bem(gf__) (,) sa(h)cra(h) co(hiwjh)git(ih) æ(g.)des,(g.) (;)\r\nhæc(j_) sa(i)cra(k)mén(ji)tis(i_j) (,) pi(h)a(g) di(h)tat(i) us(h.)que,(g.) (:)\r\ncǽ(gh)li(i)cis(h) e(ghg)scis(e_f) (,) a(g)lit(h) in(g) pe(f)rén(ef)nis(d.) (,)\r\nmú(ghg)ne(f)ra(g) vi(gh)tæ.(g.) \r\n4.(::) Quǽ(ghg)su(f)mus(g) er(gh)go,(gf__) (,) De(h)us,(h) ut(hiwjh) se(ih)ré(g.)no(g.) (;)\r\nád(j_)nu(i)as(k) vul(ji)tu(i_j) (,) fá(h)mu(g)los(h) gu(i)bér(h.)nans,(g.) (:)\r\nqui(gh) tu(i)i(h) sum(ghg)mo(e_f) (,) cé(g)le(h)brant(g) a(f)mó(ef)re(d.) (,)\r\ngáu(ghg)di(f)a(g) tem(gh)pli.(g.) \r\n5.(::) Æ(ghg)qua(f) laus(g) sum(gh)mum(gf__) (,) cé(h)le(h)bret(hiwjh) Pa(ih)rén(g.)tem(g.) (;)\r\nte(j_)que,(i) Sal(k)vá(ji)tor,(i_j) (,) pi(h)e(g) rex,(h) per(i) æ(h.)vum;(g.) (:)\r\nSpí(gh)ri(i)tus(h) San(ghg)cti(e_f) (,) ré(g)so(h)net(g) per(f) om(ef)nem(d.) (,)\r\ngló(ghg)ri(f)a(g) mun(gh)dum.(g.) (::)\r\nA(ghg)men.(fg..) (::)\r\n",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    id: "gregobase:17941",
    incipit: "Dum tuas",
    gabc: "(c4)DUM(e) tu(d)as(e) fe(gh)sto, (gvFE'_,) pa(d)ter(efg) o(fe) co(de)lé(e.)nde,(e.) (;) cá(e)nti(gh)co(h) lau(gh)des(h'_) (,) ha(j)bet(hg) hæc(h) co(gvFE)ró(de)na, (e.) (:) vo(e)cis(e) ac(ed) men(f)tis(d_c_), (,) Ió(d)a(ed)chim, (efe) be(fd)ní(fgh)gne(h'_)(,) ác(g)ci(fe)pe(de) mu(e.)nus.(e.) (::)",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "annotation: Hymnus;\r\nannotation: IV;\r\n%%\r\n(c4)Vir(f) cel(fe)se,(d) for(e)ma(g) ful(gh)gi(f)da(e) (,) vir(g)tu(h)tis,(g) hym(hiwji)num(g) su(g)sci(f)pe,(h) (;) qui(h) iu(h)re(g) dum(hiwji) te(gf) præ(h)di(h)cat,(dewfe) (,) De(e)i(c) ca(e)nit(gfh) ma(gf)gna(g)li(fe)a.(f) (::) (z)\r\n\r\n2. Qui(f) sem(fe)pi(d)ter(e)nus(g) Pon(gh)ti(f)fex(e) (,) stir(g)pem(h) De(g)o(hiwji) mor(g)ta(g)li(f)um(h) (;) re(h)vin(h)xit,(g) at(hiwji)que(gf) red(h)di(h)dit(dewfe) (,) pa(e)ci(c) no(e)vo(gfh) nos(gf) fœ(g)de(fe)re.(f) (::) (z)\r\n\r\n3. Te(f) fe(fe)cit(d) ip(e)se(g) pro(gh)vi(f)dus(e) (,) su(g)is(h) mi(g)ni(hiwji)strum(g) mu(g)ne(f)ris,(h) (;) Pa(h)tri(h) da(g)tu(hiwji)rum(gf) glo(h)ri(h)am(dewfe) (,) e(e)ius(c)que(e) vi(gfh)tam(gf) ple(g)bi(fe)bus.(f) (::) (Z)\r\n\r\n[alt:Pro papa:] 4.Tu(f) Pe(fe)tr<i>i</i> o(d)vi(e)le(g) cæ(gh)li(f)tus(e) (,) sum(g)ptis(h) re(g)ge(hiwji)bas(g) cla(g)vi(f)bus,(h)(;) gre(h)gem(h)que(g) ver(hiwji)bo(gf) gra(h)ti(h)æ,(dewfe) (,) pu(e)ris(c) fo(e)ve(gfh)as(gf) a(g)cti(fe)bus.(f) (::) (z)\r\n\r\n\r\n[alt:Pro episcopo:] 4. Vir(f)tu(fe)te(d) fac(e)tus(g) di(gh)ti(f)or(e) (,) te(g) con(h)se(g)cran(hiwji)tis(g) Spi(g)ri(f)tus,(h) (;) præ(h)sul,(h) sa(g)lu(hiwji)tis(gf) pin(h)gui(h)a(dewfe) (,) tu(e) tra(c)di(e)dis(gfh)ti(gf) pa(g)bu(fe)la(f) (::) (z)\r\n\r\n\r\n[alt:Pro presbytero:] 4. Re(f)ga(fe)lis(d) hu(e)ius(g) cul(gh)mi(f)nis(e) (,) a(g)dep(h)tus(g) al(hiwji)ti(g)tu(g)di(f)nem,(h) (;) ver(h)bo(h) fu(g)i(hiwji)st<i>i</i> et(gf) mo(h)ri(h)bus(dewfe) (,) doc(e)tor,(c) sa(e)cer(gfh)dos,(gf) hos(g)ti(fe)a.(f) (::) (z)\r\n\r\n5. Lo(f)ca(fe)tus(d) in(e) cæ(g)le(gh)sti(f)bus,(e) (,) san(g)ctæ(h) me(g)men(hiwji)t<i>o</i> Ec(g)cle(g)si(f)æ,(h) (;) o(h)ves(h) ut(g) om(hiwji)nes(gf) pas(h)cu(h)a(dewfe) (,) Chri(e)sti(c) pe(e)tant(gfh) fe(gf)li(g)ci(fe)a.(f) (::) (z)\r\n\r\n6. Sit(f) Tri(fe)ni(d)ta(e)ti(g) glo(gh)ri(f)a,(e) (,) quæ(g) san(h)ct<i>i</i> ho(g)no(hiwji)ris(g) mu(g)ni(f)a(h) (;) ti(h)bi(h) mi(g)ni(hiwji)stro(gf) se(h)du(h)lo(dewfe) (,) di(e)gnis(c) co(e)ro(gfh)nas(gf) gau(g)di(fe)is.(f) (::) \r\n   A(efe)men.(de) (::) \r\n\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    id: "gregobase:17945",
    incipit: "Vir celse forma fulgida",
    gabc: "annotation: Hymnus;\r\nannotation: IV;\r\n%%\r\n(c4)Vir(f) cel(ffe)se,(d) for(e)ma(g) ful(gh)gi(f)da(e) (,) vir(g)tu(h)tis,(g) hym(hiwji)num(g) su(g)sci(f)pe,(h) (;) qui(h) iu(h)re(g) dum(hiwji) te(gf) præ(h)di(h)cat,(dewfe) (,) De(e)i(c) ca(e)nit(gfh) ma(gf)gna(g)li(fe)a.(e) (::) \r\n\r\n2. Qui(f) sem(ffe)pi(d)ter(e)nus(g) Pon(gh)ti(f)fex(e) (,) stir(g)pem(h) De(g)o(hiwji) mor(g)ta(g)li(f)um(h) (;) re(h)vin(h)xit,(g) at(hiwji)que(gf) red(h)di(h)dit(dewfe) (,) pa(e)ci(c) no(e)vo(gfh) nos(gf) fœ(g)de(fe)re.(e) (::) \r\n\r\n3. Te(f) fe(ffe)cit(d) ip(e)se(g) pro(gh)vi(f)dus(e) (,) su(g)is(h) mi(g)ni(hiwji)strum(g) mu(g)ne(f)ris,(h) (;) Pa(h)tri(h) da(g)tu(hiwji)rum(gf) glo(h)ri(h)am(dewfe) (,) e(e)ius(c)que(e) vi(gfh)tam(gf) ple(g)bi(fe)bus.(e) (::) \r\n\r\n[alt:Pro papa:] 4.Tu(f) Pe(ffe)tr<i>i</i> o(d)vi(e)le(g) cæ(gh)li(f)tus(e) (,) sum(g)ptis(h) re(g)ge(hiwji)bas(g) cla(g)vi(f)bus,(h)(;) gre(h)gem(h)que(g) ver(hiwji)bo(gf) gra(h)ti(h)æ,(dewfe) (,) pu(e)ris(c) fo(e)ve(gfh)as(gf) a(g)cti(fe)bus.(f) (::) \r\n\r\n[alt:Pro episcopo:] 4. Vir(f)tu(ffe)te(d) fac(e)tus(g) di(gh)ti(f)or(e) (,) te(g) con(h)se(g)cran(hiwji)tis(g) Spi(g)ri(f)tus,(h) (;) præ(h)sul,(h) sa(g)lu(hiwji)tis(gf) pin(h)gui(h)a(dewfe) (,) tu(e) tra(c)di(e)dis(gfh)ti(gf) pa(g)bu(fe)la.(e) (::) \r\n\r\n\r\n[alt:Pro presbytero:] 4. Re(f)ga(ffe)lis(d) hu(e)ius(g) cul(gh)mi(f)nis(e) (,) a(g)dep(h)tus(g) al(hiwji)ti(g)tu(g)di(f)nem,(h) (;) ver(h)bo(h) fu(g)i(hiwji)st<i>i</i> et(gf) mo(h)ri(h)bus(dewfe) (,) doc(e)tor,(c) sa(e)cer(gfh)dos,(gf) hos(g)ti(fe)a.(e) (::) \r\n\r\n5. Lo(f)ca(ffe)tus(d) in(e) cæ(g)le(gh)sti(f)bus,(e) (,) san(g)ctæ(h) me(g)men(hiwji)t<i>o</i> Ec(g)cle(g)si(f)æ,(h) (;) o(h)ves(h) ut(g) om(hiwji)nes(gf) pas(h)cu(h)a(dewfe) (,) Chri(e)sti(c) pe(e)tant(gfh) fe(gf)li(g)ci(fe)a.(e) (::) \r\n\r\n6. Sit(f) Tri(ffe)ni(d)ta(e)ti(g) glo(gh)ri(f)a,(e) (,) quæ(g) san(h)ct<i>i</i> ho(g)no(hiwji)ris(g) mu(g)ni(f)a(h) (;) ti(h)bi(h) mi(g)ni(hiwji)stro(gf) se(h)du(h)lo(dewfe) (,) di(e)gnis(c) co(e)ro(gfh)nas(gf) gau(g)di(fe)is.(e) (::) \r\n   A(efe)men.(de) (::) \r\n\r\n\r\n\r\n",
    office: "hy",
    mode: "4",
    pages: [
    { page: "298", sequence: 0, extent: 1 }
  ...
  },
  {
    id: "gregobase:17954",
    incipit: "Christe cunctorum dominator",
    gabc: "(c4)CHri(ghg)ste,(f) cun(g)ctó(gh)rum(gf__) (,) do(h)mi(h)ná(h/iwjh)tor(ih) al(g.)me,(g.) (;)\r\nplebs(j_) ti(i)bi(k) sup(ji)plex(i_j) (,) ré(h)so(g)net(h) in(i) au(h.)la,(g.) (:)\r\nán(gh)nu(i)o(h) cu(ghg)ius(e_f) (,) ré(g)de(h)unt(g) co(f)lén(ef)da(d.) (,)\r\ntém(ghg)po(f)re(g) fe(gh)sta.(g.) \r\n2.(::) Hic(ghg) lo(f)cus(g) nem(gh)pe(gf__) (,) vo(h)ci(h)tá(h/iwjh)tur(ih) au(g.)la(g.) (;)\r\nre(j_)gis(i) im(k)mén(ji)si(i_j) (,) ni(h)ti(g)dí(h)que(i) cæ(h.)li(g.) (:)\r\npor(gh)ta,(i) quæ(h) vi(ghg)tæ(e_f) (,) pá(g)tri(h)am(g) pe(f)tén(ef)tes(d.) (,)\r\nác(ghg)ci(f)pit(g) om(gh)nes.(g.) \r\n3.(::) Hæc(ghg) tu(f)am(g) ple(gh)bem(gf__) (,) sa(h)cra(h) co(h/iwjh)git(ih) æ(g.)des,(g.) (;)\r\nhæc(j_) sa(i)cra(k)mén(ji)tis(i_j) (,) pi(h)a(g) di(h)tat(i) us(h.)que,(g.) (:)\r\ncǽ(gh)li(i)cis(h) e(ghg)scis(e_f) (,) a(g)lit(h) in(g) pe(f)rén(ef)nis(d.) (,)\r\nmú(ghg)ne(f)ra(g) vi(gh)tæ.(g.) \r\n4.(::) Quǽ(ghg)su(f)mus(g) er(gh)go,(gf__) (,) De(h)us,(h) ut(h/iwjh) se(ih)ré(g.)no(g.) (;)\r\nád(j_)nu(i)as(k) vul(ji)tu(i_j) (,) fá(h)mu(g)los(h) gu(i)bér(h.)nans,(g.) (:)\r\nqui(gh) tu(i)i(h) sum(ghg)mo(e_f) (,) cé(g)le(h)brant(g) a(f)mó(ef)re(d.) (,)\r\ngáu(ghg)di(f)a(g) tem(gh)pli.(g.) \r\n5.(::) Æ(ghg)qua(f) laus(g) sum(gh)mum(gf__) (,) cé(h)le(h)bret(h/iwjh) Pa(ih)rén(g.)tem(g.) (;)\r\nte(j_)que,(i) Sal(k)vá(ji)tor,(i_j) (,) pi(h)e(g) rex,(h) per(i) æ(h.)vum;(g.) (:)\r\nSpí(gh)ri(i)tus(h) San(ghg)cti(e_f) (,) ré(g)so(h)net(g) per(f) om(ef)nem(d.) (,)\r\ngló(ghg)ri(f)a(g) mun(gh)dum.(g.) (::)\r\nA(ghg)men.(fg..) (::)\r\n",
    office: "hy",
    mode: "8",
    pages: [
    { page: "249", sequence: 0, extent: 1 }
  ...
  },
  {
    ...
    gabc: "(f3)CHri(c.)ste,(f) cun(e)ctó(f.)rum(h.) (,) sa(g)tor(f) et(g) re(h)dém(g.)ptor,(f.) (;)\r\nsí(ff)de(f)rum,(g) ter(h.)ræ,(e.) (,) ma(h)ris(i) at(j)que(kxk) re(i.)ctor,(j.) (:)\r\nóm(j.)ni(i)um(h) lau(g.)des(i.) (,) ti(f)bi(f) per(g)so(e)nán(d.)tum(c.) (,)\r\nsol(h.)ve(f) re(g)á(e.)tum,(f.) \r\n2.(::) Va(c.)se(f) qui(e) gem(f.)mas(h.) (,) frá(g)gi(f)li(g) re(h)cón(g.)dis,(f.) (;)\r\nví(ff)ri(f)bus(g) flu(h.)xas(e.) (,) á(h)ni(i)mo(j) pu(kxk)dí(i.)cas(j.) (:)\r\nfé(j.)mi(i)nas(h) red(g.)dens(i.) (,) fa(f)ci(f)én(g) s()que(e) cla(d.)ros(c.) (,)\r\nfer(h.)re(f) tri(g)úm(e.)phos.(f.) \r\n3.(::) Quas(c.) et(f) in(e) sen(f.)su(h.) (,) té(g)ne(f)ras(g) vi(h)dé(g.)mus,(f.) (;)\r\npræ(ff)ro(f)ga(g)tí(h.)va(e.) (,) mé(h)ri(i)ti(j) co(kxk)ró(i.)nas,(j.) (:)\r\nín(j.)co(i)las(h) re(g.)gni(i.) (,) fa(f)cis(f) et(g) pe(e)rén(d.)nes(c.) (,)\r\nes(h.)se(f) su(g)pér(e.)ni.(f.) \r\n4.(::) Sit(c.) Pa(f)tri(e) sum(f.)mo(h.) (,) de(g)cus(f) at(g)que(h) vir(g.)tus,(f.) (;)\r\nlaus(ff) ti(f)bi(g) Na(h.)to(e.) (,) ce(h)le(i)brís(j)que(kxk) cul(i.)tus,(j.) (:)\r\nFlá(j.)mi(i)ni(h) San(g.)cto(i.) (,) pá(f)ri(f)lis(g) po(e)té(d.)stas(c.) (,)\r\nnunc(h.) et(f) in(g) æ(e.)vum.(f.) (::)\r\nA(fgf)men.(ef..) (::)\r\n",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)NN(g)vus(d) a(g)thlé(g)ta(ghg) Dó(ge)mi(fg)ni(g.) (,)\r\ncol(h!iwji)lau(h)dé(g)tur(h) Do(gf)mí(e)ni(f)cus,(g.) (;)\r\nqui(g) rem(i) con(j)fór(k)mat(klk) nó(j)mi(i)ni,(hig.) (,)\r\nvir(g) fa(d)ctus(g) e(g)van(ghg)gé(ge)li(fg)cus.(g.) \r\n2.(::) Con(g)sér(d)vans(g) si(g)ne(ghg) má(ge)cu(fg)la(g.) (,)\r\nvir(h!iwji)gi(h)ni(g)tá(h)tis(gf) lí(e)li(f)um,(g.) (;)\r\nar(g)dé(i)bat(j) qua(k)si(klk) fá(j)cu(i)la(hig.) (,)\r\npro(g) ze(d)lo(g) per(g)e(ghg)ún(ge)ti(fg)um.(g.) \r\n3.(::) Mun(g)dum(d) cal(g)cans(g) sub(ghg) pé(ge)di(fg)bus(g.) (,)\r\nac(h!iwji)cín(h)xit(g) cor(h) ad(gf) prœ(e)li(f)a,(g.) (;)\r\nnu(g)dus(i) oc(j)cúr(k)rens(klk) hó(j)sti(i)bus,(hig.) (,)\r\nChri(g)sti(d) suf(g)fúl(g)tus(ghg) grá(ge)ti(fg)a.(g.) \r\n4.(::) Pu(g)gnat(d) ver(g)bo,(g) mi(ghg)rá(ge)cu(fg)lis,(g.) (,)\r\nmis(h!iwji)sis(h) per(g) or(h)bem(gf) frá(e)tri(f)bus,(g.) (;)\r\ncre(g)bros(i) a(j)di(k)ún(klk)gens(j) sé(i)du(hig.)lis(g)\r\nfle(d)tus(g) o(g)ra(ghg)ti(ge)ó(fg)ni(g.)bus.(g) \r\n5.() Sit(d) tri(g)no(g) De<i>o</i>(ghg) et(ge) sím(fg)pli(g.)ci(h!iwji)\r\nlaus,(h) ho(g)nor,(h) de(gf)cus,(e) gló(f)ri(g.)a,(g)\r\nqui(i) nos(j) pre(k)ce(klk) Do(j)mí(i)ni(hig.)ci(g)\r\ndu(d)cat(g) ad(g) cæ(ghg)li(ge) gáu(fg)di(g.)a.(g)\r\nA(ghg)men.(fg..) (::)\r\n",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    id: "gregobase:17961",
    incipit: "Commune vos apostoli",
    gabc: "(c4)COm(f)mú(f)ne(f) vos,(fe) a(dc)pó(de)sto(e)li,(e'_) (,)\r\nex(g)tól(gh)lat(hg) hym(hih)ni(gf) iú(g)bi(gf)lum,(e.) (;)\r\nquos(f) ád(e)vo(fg)cat(gf) par(dc) grá(de)ti(dc)a,(c'_) (,)\r\nco(g)ró(g)nat(f) u(g)na(ghg) gló(fe)ri(de)a.(e.) \r\n2.(::) Ar(f)dó(f)re(f) pul(fe)sus(dc) cǽ(de)li(e)co,(e'_) (,)\r\nChri(g)sti(gh) pre(hg)mis(hih) ve(gf)stí(g)gi(gf)a,(e.) (;)\r\nSi(f)mon,(e) et(fg) il(gf)lum(dc) nún(de)ti(dc)as(c'_) (,)\r\nze(g)lo(g) pe(f)rá(g)ctus(ghg) ím(fe)pi(de)gro.(e.) \r\n3.(::) Tu(f) car(f)ne(f) fra(fe)ter,(dc) ás(de)se(e)cla(e'_) (,)\r\nfra(g)tér(gh)que(hg) Chri(hih)sti(gf) spí(g)ri(gf)tu,(e.) (;)\r\nIu(f)da,(e) Ma(fg)gí(gf)strum(dc) prǽ(de)di(dc)cas(c'_) (,)\r\nscrip(g)tís(g)que(f) fra(g)tres(ghg) é(fe)ru(de)dis.(e.) \r\n4.(::) Nec(f) per(f)ti(f)mé(fe)scit(dc) sán(de)gui(e)nem(e'_) (,)\r\nu(g)tér(gh)que(hg) pu(hih)rum(gf) fún(g)de(gf)re,(e.) (;)\r\nut(f) ve(e)ri(fg)tá(gf)tis(dc) é(de)ni(dc)tens(c'_) (,)\r\nsit(g) te(g)stis(f) at(g)que(ghg) ví(fe)cti(de)ma.(e.) \r\n5.(::) O(f) sum(f)ma(f) cæ(fe)li(dc) sí(de)de(e)ra,(e'_) (,)\r\nnos(g) de(gh)tis(hg) ut(hih) per(gf) á(g)spe(gf)ra,(e.) (;)\r\nfi(f)de(e) va(fg)lén(gf)tes(dc) ín(de)te(dc)gra,(c'_) (,)\r\nten(g)dá(g)mus(f) ad(g) cæ(ghg)lé(fe)sti(de)a.(e.) \r\n6.(::) Pa(f)tri(f) per(f) æ(fe)vum(dc) gló(de)ri(e)a(e'_) (,)\r\nNa(g)tó(gh)que(hg) cum(hih) Pa(gf)rá(g)cli(gf)to,(e.) (;)\r\nquo(f)rum(e) su(fg)pér(gf)nis(dc) gáu(de)di(dc)is(c'_) (,)\r\nsi(g)mul(g) fru(f)é(g)mur(ghg) pér(fe)pe(de)tim.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "initial-style: 1;\r\n%%\r\n(c4)COn(e)ci(d)to(e!fg) gres(gh)su(g.) (,) pe(h)tis(g) al(fe)ta(de) mon(e.)tis,(e.) (;)\r\nVir(e_)go,(d) quam(e) ma(ed)trem(c.) (,) De(e)us(f) i(gf)pse(de) fe(e.)cit,(e.) (:)\r\nut(g!hw!ij) se(hg)ni(hi) ma(hg)tri(g_h) stu(h)di(gf)ós<i>i</i>(g) a(gf)mó(e)ris(e_h) (,)\r\npí(hg)gno(fe)ra(de) pro(e.)mas.(e.)  \r\n2.(::) Cum(e) sa(d)lu(e!fg)tán(gh)tis(g.) (,) ca(h)pit(g) il(fe)la(de) vo(e.)cem,(e.) (;)\r\náb(e_)di(d)tus(e) ge(ed)stit(c.) (,) pu(e)er(f) ex(gf)si(de)lí(e.)re,(e.) (:)\r\nte(g!hw!ij) pa(hg)rens(hi) di(hg)cit(g_h) dó(h)mi(gf)nam,(g) sa(gf)lú(e)tat(e_h) (,)\r\nte(hg)que(fe) be(de)á(e.)tam.(e.)  \r\n3.(::) I(e)psa(d) præ(e!fg)dí(gh)cis(g.) (,) fo(h)re(g) te(fe) be(de)á(e.)tam(e.) (;)\r\nSpí(e_)ri(d)tu(e) fer(ed)vens(c.) (,) pé(e)ni(f)tus(gf) lo(de)quén(e.)te,(e.) (:)\r\nac(g!hw!ij) De(hg)um(hi) can(hg)tu(g_h) cé(h)le(gf)bras(g) a(gf)moe(e)no(e_h) (,)\r\nmagn<i>a</i>(hg) o(fe)pe(de)rán(e.)tem.(e.)  \r\n4.(::) Te(e)que(d) fe(e!fg)lí(gh)cem(g.) (,) pó(h)pu(g)li(fe) per(de) or(e.)bem(e.) (;)\r\nsem(e_)per,(d) o(e) ma(ed)ter,(c.) (,) ré(e)ci(f)tant(gf) o(de)ván(e.)tes(e.) (:)\r\nat(g!hw!ij)que(hg) te(hi) cre(hg)dunt(g_h) Dó(h)mi(gf)ni(g) fa(gf)vó(e)rum(e_h) (,)\r\nes(hg)se(fe) mi(de)ní(e.)stram.(e.)  \r\n5.(::) Quæ,(e) fe(d)rens(e!fg) Chri(gh)stum,(g.) (,) no(h)va(g) sem(fe)per(de) af(e.)fers(e.) (;)\r\ndo(e_)na,(d) tu(e) no(ed)bis(c.) (,) fer(e) o(f)pes(gf) sa(de)lú(e.)tis,(e.) (:)\r\nqui(g!hw!ij) pi(hg)e(hi) te(hg)cum(g_h) Trí(h)a(gf)dem(g) su(gf)pér(e)nam(e_h) (,)\r\nma(hg)gni(fe)fi(de)cá(e.)mus.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)DUM(e) tu(d)as(e) fe(gh)sto,(gvFE'_) (,) pa(d)ter(efg) o(fe) co(de)lén(e.)de,(e.) (;)\r\ncán(e)ti(gh)co(h) lau(gh)des(h'_) (,) ha(j)bet(hg) hæc(h) co(gvFE)ró(de)na,(e.) (:)\r\nvo(e)cis(e) ac(ed) men(f)tis,(ed__) (,) Ió(d)a(ed)chim,(efe) be(fd)ní(fgh)gne(h'_) (,)\r\nác(g)ci(fe)pe(de) mu(e.)nus.(e.) \r\n2.(::) Lon(e)ga(d) te(e) re(gh)gum(gvFE'_) (,) sé(d)ri(efg)es(fe) a(de)vó(e.)rum(e.) (;)\r\nA(e)bra(gh)hæ(h) pro(gh)lem(h'_) (,) tu(j)lit(hg) at(h)que(gvFE) Da(de)vid;(e.) (:)\r\nclá(e)ri(e)or(ed) mun(f)di(ed__) (,) dó(d)mi(ed)na(efe) co(fd)rú(fgh)scas(h'_) (,)\r\npro(g)le(fe) Ma(de)rí(e.)a.(e.) \r\n3.(::) Sic(e) tu(d)um(e) ger(gh)men(gvFE'_) (,) be(d)ne(efg)díct(fe) ab(de) An(e.)na(e.) (;)\r\né(e)di(gh)tum,(h) pa(gh)trum(h'_) (,) re(j)pe(hg)tí(h)ta(gvFE) vo(de)ta(e.) (:)\r\nim(e)plet,(e) et(ed) mæ(f)sto(ed__) (,) pró(d)pe(ed)rat(efe) re(fd)fér(fgh)re(h'_) (,)\r\ngáu(g)di(fe)a(de) mun(e.)do.(e.) \r\n4.(::) Laus(e) ti(d)bi,(e) Pro(gh)lis(gvFE'_) (,) Pa(d)ter(efg) in(fe)cre(de)á(e.)tæ;(e.) (;)\r\nlaus(e) ti(gh)bi,(h) sum(gh)mi(h'_) (,) Sú(j)bo(hg)les(h) Pa(gvFE)rén(de)tis;(e.) (:)\r\nsum(e)ma(e) laus,(ed) com(f)par,(ed__) (,) ti(d)bi(ed) sit(efe) per(fd) om(fgh)ne,(h'_) (,)\r\nSpí(g)ri(fe)tus,(de) æ(e.)vum.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
    { page: "402", sequence: 0, extent: 1 }
  ...
  },
  {
    id: "gregobase:17970",
    incipit: "Eia mater",
    gabc: "initial-style: 1;\r\n%%\r\n(f3)E(f)ia,(f) ma(h)ter,(hg) fons(f) a(g)mó(f)ris,(e.) (;)\r\nme(g) sen(g)tí(h)re(gf) vim(h) do(i)ló(j)ris(j.) (;)\r\nfac,(h) ut(h) te(g)cum(f) lú(e)ge(f)am.(f.)  \r\n2.(::)\r\n\r\nFac(f) ut(f) ár(h)de(hg)at(f) cor(g) me(f)um(e.) (;)\r\nin(g) a(g)mán(h)do(gf) Chri(h)stum(i) De(j)um,(j.) (;)\r\nut(h) si(h)bi(g) com(f)plá(e)ce(f)am.(f.)  \r\n3.(::)\r\n\r\nSan(f)cta(f) ma(h)ter,(hg) i(f)stud(g) a(f)gas,(e.) (;)\r\nCru(g)ci(g)fí(h)xi(gf) fi(h)ge(i) pla(j)gas(j.) (;)\r\ncor(h)di(h) me(g)o(f) vá(e)li(f)de.(f.)  \r\n4.(::)\r\n\r\nTu(f)i(f) Na(h)ti(hg) vul(f)ne(g)rá(f)ti,(e.) (;)\r\ntam(g) di(g)gná(h)ti(gf) pro(h) me(i) pa(j)ti(j.) (;)\r\npoe(h)nas(h) me(g)cum(f) dí(e)vi(f)de.(f.)  \r\n5.(::)\r\n\r\nFac(f) me(f) ve(h)re(hg) te(f)cum(g) fle(f)re,(e.) (;)\r\nCru(g)ci(g)fí(h)xo(gf) con(h)do(i)lé(j)re,(j.) (;)\r\ndo(h)nec(h) e(g)go(f) ví(e)xe(f)ro.(f.)  \r\n6.(::)\r\n\r\nIux(f)ta(f) cru(h)cem(hg) te(f)cum(g) sta(f)re(e.) (;)\r\nac(g) me(g) ti(h)bi(gf) so(h)ci(i)á(j)re(j.) (;)\r\nin(h) plan(h)ctu(g) de(f)sí(e)de(f)ro.(f.)  \r\n7.(::)\r\n\r\nQuan(f)do(f) cor(h)pus(hg) mo(f)ri(g)é(f)tur,(e.) (;)\r\nfac(g) ut(g) á(h)ni(gf)mæ(h) do(i)né(j)tur(j.) (;)\r\npa(h)ra(h)dí(g)si(f) gló(e)ri(f)a.(f.) (::)\r\nA(fgf)men.(ef..) (::)\r\n",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)FOr(ed)tem(g) pi(hj)úm(jji)que(hg) prǽ(h)su(gf)lem(e.) (,)\r\nca(fe)ná(d)mus(dh) om(h)nes,(gf) túr(g)bi(fe)das(e.) (;)\r\nqui(dhiv) flu(h)ctu(hg)án(hjji)tis(hg) sǽ(h)cu(gf)li(g_h) (,)\r\nter(hg)ris(h) pro(gf)cél(gg)las(d) éx(efg)pu(fe)lit.(e.) \r\n2.(::) Non(ed) scep(g)tra(hj) con(jji)cús(hg)sus(h) ti(gf)met,(e.) (,)\r\nnon(fe) im(d)pe(dh)rán(h)tem(gf) fé(g)mi(fe)nam,(e.) (;)\r\ntem(dhiv)pló(h)que,(hg) clau(hjji)sis(hg) pó(h)sti(gf)bus,(g_h) (,)\r\nar(hg)cet(h) cru(gf)én(gg)tum(d) cǽ(efg)sa(fe)rem.(e.) \r\n3.(::) Ar(ed)cá(g)na(hj) sa(jji)cræ(hg) pá(h)gi(gf)næ(e.) (,)\r\nal(fe)tus(d) ma(dh)gí(h)ster(gf) éx(g)pli(fe)cat;(e.) (;)\r\ndi(dhiv)ví(h)na(hg) pan(hjji)dens(hg) dóg(h)ma(gf)ta,(g_h) (,)\r\nmi(hg)ra(h) ni(gf)tet(gg) fa(d)cún(efg)di(fe)a.(e.) \r\n4.(::) Fi(ed)de(g) ci(hj)én(jji)te(hg) spí(h)ri(gf)tum,(e.) (,)\r\npræ(fe)clá(d)ra(dh) fun(h)dit(gf) cár(g)mi(fe)na;(e.) (;)\r\nfi(dhiv)de(h) co(hg)ǽ(hjji)quans(hg) már(h)ty(gf)res,(g_h) (,)\r\nde(hg)prén(h)dit(gf) ar(gg)tus(d) már(efg)ty(fe)rum.(e.) \r\n5.(::) Iam(ed) nunc(g) fu(hj)rén(jji)tem(hg) tár(h)ta(gf)ri(e.) (,)\r\nlu(fe)pum(d) fla(dh)gél(h)lo(gf) súb(g)mo(fe)ve;(e.) (;)\r\nsci(dhiv)én(h)ti(hg)æ(hjji) nos(hg) lú(h)mi(gf)ne(g_h) (,)\r\nfo(hg)ve,(h) tu(gf)é(gg)re(d) iú(efg)gi(fe)ter.(e.) \r\n6.(::) Sit(ed) Tri(g)ni(hj)tá(jji)ti(hg) gló(h)ri(gf)a,(e.) (,)\r\nquam,(fe) te(d) ro(dh)gán(h)te(gf) pró(g)spe(fe)re,(e.) (;)\r\nhym(dhiv)nis(h) in(hg) au(hjji)la(hg) cǽ(h)li(gf)ca(g_h) (,)\r\nlau(hg)dé(h)mus(gf) usqu<i>e</i>(gg) in(d) sǽ(efg)cu(fe)lum.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "3",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)GAu(g)dén(hi)tes(j) fe(ih)stum(g) có(h)li(f)mus(g_') (,)\r\nsan(i)ctá(k)rum(j) Chri(i)sti(k) vír(ji)gi(h)num,(g.) (;)\r\nquæ(g) pu(h)ro(f) cor(g)de(e) Dó(fe)mi(d)num(c'_) (,)\r\nse(g)cú(hi)tæ(j) sunt(ih) in(g) láu(h)di(f)bus.(g.) \r\n2.(::) O(g) ca(hi)sti(j)tá(ih)tis(g) lí(h)li(f)um,(g_') (,)\r\nrex(i) vír(k)gi(j)num(i) san(k)ctís(ji)si(h)me,(g.) (;)\r\ntu,(g) cu(h)stos(f) pu(g)di(e)cí(fe)ti(d)æ,(c'_) (,)\r\nfrau(g)des(hi) re(j)pél(ih)le(g) dǽ(h)mo(f)num.(g.) \r\n3.(::) Qui(g) ca(hi)stis(j) in(ih) vi(g)scé(h)ri(f)bus(g_') (,)\r\npla(i)cá(k)ris(j) cle(i)men(k)tís(ji)si(h)me,(g.) (;)\r\nno(g)stros(h) re(f)á(g)tus(e) dí(fe)lu(d)e,(c'_) (,)\r\ndi(g)mít(hi)tens(j) quæ(ih) pec(g)cá(h)vi(f)mus.(g.) \r\n4.(::) Gra(g)tes(hi) pre(j)cán(ih)tes(g) á(h)gi(f)mus;(g_') (,)\r\ner(i)rá(k)mus,(j) vi(i)am(k) dí(ji)ri(h)ge;(g.) (;)\r\ntu,(g) pa(h)ter(f) in(g)dul(e)gén(fe)ti(d)æ,(c'_) (,)\r\nno(g)bis(hi) suc(j)cúr(ih)re,(g) quǽ(h)su(f)mus.(g.) \r\n5.(::) Ie(g)su,(hi) ti(j)bi(ih) sit(g) gló(h)ri(f)a,(g_') (,)\r\nqui(i) na(k)tus(j) es(i) de(k) Vír(ji)gi(h)ne,(g.) (;)\r\ncum(g) Patr<i>e</i>(h) et(f) al(g)mo(e) Spí(fe)ri(d)tu(c'_) (,)\r\nin(g) sem(hi)pi(j)tér(ih)na(g) sǽ(h)cu(f)la.(g.) (::)\r\nA(ghg)men.(fg..) (::)\r\n",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3)HÆ(f) fé(h)mi(hg)næ(i) lau(hf)dá(g)bi(i)les(h_') (,)\r\net(h) ho(f)no(g)rá(h)tæ(gh) mé(f)ri(g)tis,(f.) (;)\r\nut(f) san(h)ctis(hg) pol(i)lent(ji) mó(g)ri(i)bus,(h_') (,)\r\ntri(h)úm(f)phant(g) sic(h) cum(gh) án(f)ge(g)lis.(f.) \r\n2.(::) Ex(f) cor(h)de(hg) de(i)vo(hf)tís(g)si(i)mo(h_') (,)\r\nin(h) flet(f) o(g)rán(h)tes(gh) Dó(f)mi(g)num,(f.) (;)\r\nvi(f)gí(h)li(hg)is,(i) ie(ji)iú(g)ni(i)is(h_') (,)\r\nhæ(h)ré(f)bant(g) ist(h) as(gh)sí(f)du(g)is.(f.) \r\n3.(::) Sper(f)nén(h)tes(hg) mun(i)di(hf) gló(g)ri(i)am(h_') (,)\r\nac(h) men(f)te(g) sem(h)per(gh) ín(f)te(g)gra,(f.) (;)\r\nper(f)fé(h)ctam(hg) post(i) iu(ji)stí(g)ti(i)am(h_') (,)\r\nmi(h)grá(f)runt(g) su(h)per(gh) sí(f)de(g)ra.(f.) \r\n4.(::) Quæ(f) san(h)cti(hg)tá(i)tis(hf) á(g)cti(i)bus(h_') (,)\r\nsu(h)a(f) di(g)tá(h)runt(gh) lí(f)mi(g)na,(f.) (;)\r\nlæ(f)tán(h)tur(hg) nunc(i) per(ji)pé(g)tu(i)is(h_') (,)\r\ncæ(h)lé(f)stis(g) æ(h)dis(gh) prǽ(f)mi(g)is.(f.) \r\n5.(::) Laus(f) un<i>i</i>(h) ac(hg) tri(i)no(hf) Dó(g)mi(i)no,(h_') (,)\r\nqui(h) nos(f) e(g)á(h)rum(gh) pré(f)ci(g)bus,(f.) (;)\r\npe(f)rá(h)cto(hg) vi(i)tæ(ji) tér(g)mi(i)no,(h_') (,)\r\ncon(h)iún(f)gat(g) cæ(h)li(gh) cí(f)vi(g)bus.(f.) (::)\r\nA(fgf)men.(ef..) (::)\r\n",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)HI(ghg) sa(e)cer(f)dó(g.)tes(g.) (,) Dó(h)mi(f)ni(h) sa(j)crá(ih)ti,(g.) (;)\r\ncon(j_)se(h)cra(j)tó(ih)res(g.) (,) Dó(h)mi(g)ni(e) fi(f)dé(g.)les(g.) (:)\r\nat(gf)que(e) pa(g)stó(fe)res(dc) pó(c)pu(d)li(e) fu(f)é(gh)re(hg__) (,)\r\ním(hiwji)pigr<i>o</i>(hg) a(hih)mó(g.)re.(g.) \r\n2.(::) Nam(ghg)que(e) su(f)scép(g.)tæ(g.) (,) be(h)ne(f)di(h)cti(j)ó(ih)nis(g.) (;)\r\ndo(j_)na(h) ser(j)ván(ih)tes,(g.) (,) stu(h)du(g)é(e)re,(f) lum(g.)bos(g.) (:)\r\nfór(gf)ti(e)ter(g) cin(fe)cti,(dc) má(c)ni(d)bus(e) co(f)rú(gh)scas(hg__) (,)\r\nfer(hiwji)re(hg) lu(hih)cér(g.)nas.(g.) \r\n3.(::) Sic(ghg)que(e) su(f)spén(g.)si(g.) (,) vi(h)gi(f)lés(h)que,(j) quan(ih)do(g.) (;)\r\niá(j_)nu(h)am(j) pul(ih)sans(g.) (,) Dó(h)mi(g)nus(e) ve(f)ní(g.)ret,(g.) (:)\r\nob(gf)vi(e)a(g)vé(fe)runt(dc) pro(c)pe(d)ránt<i>i</i>(e) a(f)lá(gh)cres(hg__) (,)\r\npán(hiwji)de(hg)re(hih) li(g.)men.(g.) \r\n4.(::) Gló(ghg)ri(e)æ(f) sum(g.)mum(g.) (,) de(h)cus(f) at(h)que(j) lau(ih)dis,(g.) (;)\r\nrex,(j_) ti(h)bi,(j) re(ih)gum,(g.) (,) Dé(h)i(g)tas(e) pe(f)rén(g.)nis,(g.) (:)\r\nquic(gf)quid(e) est(g) re(fe)rum(dc) cé(c)le(d)bret(e) per(f) om(gh)ne(hg__) (,)\r\ntem(hiwji)pus(hg) et(hih) æ(g.)vum.(g.) (::)\r\nA(ghg)men.(fg..) (::)\r\n",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)IN(g) cæ(d)lé(g)sti(g) col(ghg)lé(ge)gi(fg)o(g.) (,)\r\nFran(h!iwji)cí(h)scus(g) ful(h)get(gf) gló(e)ri(f)a,(g.) (;)\r\nin(g)sí(i)gni(j) pri(k)vi(klk)lé(j)gi(i)o(hig.) (,)\r\nChri(g)sti(d) por(g)tans(g) in(ghg)sí(ge)gni(fg)a.(g.) \r\n2.(::) Hic(g) coe(d)tus(g) a(g)po(ghg)stó(ge)li(fg)ci(g.) (,)\r\nest(h!iwji) fa(h)ctus(g) con(h)sors(gf) páu(e)pe(f)ris,(g.) (;)\r\ncru(g)cem(i) in(j) se(k) do(klk)mí(j)ni(i)ci(hig.) (,)\r\nsi(g)gnum(d) re(g)pór(g)tans(ghg) fœ(ge)de(fg)ris.(g.) \r\n3.(::) Hic(g) mar(d)tyr(g) de(g)si(ghg)dé(ge)ri(fg)o(g.) (,)\r\ncru(h!iwji)cem(h) post(g) Ie(h)sum(gf) bá(e)iu(f)lat,(g.) (;)\r\nquem(g) már(i)ty(j)rum(k) con(klk)sór(j)ti(i)o(hig.) (,)\r\nChri(g)stus(d) in(g) cæ(g)lis(ghg) có(ge)pu(fg)lat.(g.) \r\n4.(::) Cru(g)cem(d) per(g) ab(g)sti(ghg)nén(ge)ti(fg)am(g.) (,)\r\nFran(h!iwji)cí(h)scus(g) fe(h)rens(gf) iú(e)gi(f)ter,(g.) (;)\r\niam(g) con(i)fes(j)só(k)rum(klk) gló(j)ri(i)am(hig.) (,)\r\na(g)dép(d)tus(g) est(g) fe(ghg)lí(ge)ci(fg)ter.(g.) \r\n5.(::) Can(g)dens(d) de(g)có(g)re(ghg) ní(ge)ve(fg)o,(g.) (,)\r\npas(h!iwji)sum(h) hic(g) se(h)quens(gf) Dó(e)mi(f)num,(g.) (;)\r\nnunc(g) ca(i)sti(j)tá(k)tis(klk) prǽ(j)mi(i)o(hig.) (,)\r\ngau(g)det(d) in(g) cho(g)ro(ghg) vír(ge)gi(fg)num.(g.) \r\n6.(::) Pa(g)ter,(d) Na(g)tus(g) cum(ghg) Flá(ge)mi(fg)ne(g.) (,)\r\nnos(h!iwji) per(h) Fran(g)cí(h)sci(gf) vúl(e)ne(f)ra(g.) (;)\r\nlu(g)strent(i) di(j)ví(k)no(klk) lú(j)mi(i)ne,(hig.) (,)\r\næ(g)tér(d)na(g) dan(g)tes(ghg) mú(ge)ne(fg)ra.(g.) (::)\r\nA(ghg)men.(fg..) (::)\r\n",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)NO(ed)cti(g) suc(hj)cé(ji)dit(hg) lú(h)ci(hi)fer,(i.) (,)\r\nquem(i) mox(ijwk) au(j)ró(ji)ra(hg) sé(hiwji)qui(hg)tur,(g.) (;)\r\nso(g)lis(ghWiHG) or(h)tum(gf) præ(efg)nún(f)ti(e)ans(d.) (,)\r\nmun(hiwj)dum(h) lu(g)strán(fgh)tis(g) lú(fe)mi(de)ne.(e.) \r\n2.(::) Chri(ed)stus(g) sol(hj) est(ji) iu(hg)stí(h)ti(hi)æ,(i.) (,)\r\nau(i)ró(ijwk)ra(j) Ma(ji)ter(hg) grá(hiwji)ti(hg)æ,(g.) (;)\r\nquam,(g) An(ghWiHG)na,(h) præ(gf)is(efg) rú(f)ti(e)lans(d.) (,)\r\nle(hiwj)gis(h) pro(g)pél(fgh)lens(g) té(fe)ne(de)bras.(e.) \r\n3.(::) An(ed)na,(g) ra(hj)dix(ji) u(hg)bér(h)ri(hi)ma,(i.) (,)\r\nar(i)bor(ijwk) tu(j) sa(ji)lu(hg)tí(hiwji)fe(hg)ra,(g.) (;)\r\nvir(g)gam(ghWiHG) pro(h)dú(gf)cens(efg) fló(f)ri(e)dam(d.) (,)\r\nquæ(hiwj) Chri(h)stum(g) no(fgh)bis(g) át(fe)tu(de)lit.(e.) \r\n4.(::) O(ed) ma(g)tris(hj) Chri(ji)sti(hg) gé(h)ne(hi)trix(i.) (,)\r\ntu(i)que(ijwk) pa(j)rens(ji) san(hg)ctís(hiwji)si(hg)me,(g.) (;)\r\nna(g)tæ(ghWiHG) fa(h)vén(gf)te(efg) mé(f)ri(e)to,(d.) (,)\r\nno(hiwj)bis(h) ro(g)gá(fgh)te(g) vé(fe)ni(de)am.(e.) \r\n5.(::) Ie(ed)su,(g) ti(hj)bi(ji) sit(hg) gló(h)ri(hi)a,(i.) (,)\r\nqui(i) na(ijwk)tus(j) es(ji) de(hg) Vír(hiwji)gi(hg)ne,(g.) (;)\r\ncum(g) Pa(ghWiHG) tr<i>e</i>() et(h) al(gf)mo(efg) Spí(f)ri(e)tu,(d.) (,)\r\nin(hiwj) sem(h)pi(g)tér(fgh)na(g) sǽ(fe)cu(de)la.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "3",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)PHi(e)líp(e)pe,(ed) summ<i>æ</i>(g) ho(gh)nó(j)ri(j)bus(ih__) (,)\r\nvo(i)ca(j)ti(i)ó(h)nis(g) é(h!iwji)ni(hg)tens,(g.) (;)\r\ncum(gh) ci(j)ve(i) Pe(h)tro(g) prín(i)ci(g)pe(hg__) (,)\r\nqua(hi) men(g)te(h) Chri(gf)stum(d) dí(f!gwhg)li(fe)gis!(e.) \r\n2.(::) At(e) ips<i>e</i>(e) a(ed)mó(g)ris(gh) ín(j)ti(j)ma(ih__) (,)\r\nti(i)bi(j) re(i)pén(h)dit(g) pí(h!iwji)gno(hg)ra,(g.) (;)\r\nti(gh)bí(j)que(i) Pa(h)tris(g) dís(i)se(g)rit(hg__) (,)\r\nsu(hi)ǽ(g)que(h) vi(gf)tæ(d) dóg(f!gwhg)ma(fe)ta.(e.) \r\n3.(::) Nec(e) te(e) mi(ed)nus(g) com(gh)plé(j)cti(j)tur,(ih__) (,)\r\nIa(i)có(j)be,(i) Chri(h)sti(g) cá(h!iwji)ri(hg)tas,(g.) (;)\r\nqui(gh) fra(j)ter(i) e(h)ius(g) dí(i)ce(g)ris(hg__) (,)\r\nsed(hi) et(g) co(h)lúmn<i>a</i>(gf) Ec(d)clé(f!gwhg)si(fe)æ.(e.) \r\n4.(::) Al(e)mæ(e) Si(ed)on(g) qui(gh) prǽ(j)si(j)des(ih__) (,)\r\npri(i)mus(j) gre(i)gi(h) cla(g)rís(h!iwji)si(hg)mo,(g.) (;)\r\nnos(gh) us(j)que(i) scrip(h)tis(g) pró(i)vi(g)dis(hg__) (,)\r\nver(hi)bum(g) sa(h)lú(gf)tis(d) é(f!gwhg)do(fe)ces.(e.) \r\n5.(::) O(e) vos,(e) be(ed)á(g)ti,(gh) nó(j)bi(j)li(ih__) (,)\r\nIe(i)sum(j) pro(i)fés(h)si(g) sán(h!iwji)gui(hg)ne,(g.) (;)\r\nspe(gh) nos(j) fi(i)dé(h)que(g) cúr(i)re(g)re(hg__) (,)\r\ndat<i>e</i>(hi) in(g) su(h)pér(gf)nam(d) pá(f!gwhg)tri(fe)am,(e.) \r\n6.(::) Ut,(e) quan(e)do(ed) man(g)si(gh)ó(j)ni(j)bus(ih__) (,)\r\niam(i) Pa(j)tris(i) im(h)mo(g)rá(h!iwji)bi(hg)mur,(g.) (;)\r\nsi(gh)mul(j) ca(i)ná(h)mus(g) pér(i)pe(g)tim(hg__) (,)\r\nin(hi) Tri(g)ni(h)tá(gf)tis(d) gló(f!gwhg)ri(fe)am.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "3",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)QUI(g) la(g)cri(f)má(e)tus(f) Lá(hg)za(fg)rum(g.) (,)\r\nge(gh)mén(i) s()que(j) cum(h) so(i)ró(g)ri(fg)bus,(g.) (;)\r\ni(j)psum(h) fe(i)cí(g)sti(hg) prǽ(f)po(gh)tens(h.) (,)\r\nil(hg)lá(e)rum(f) red(h)di(ih) stú(g)di(fg)is:(g.) \r\n2(::) Qui(g) pe(g)ti(f)ví(e)sti(f) són(hg)ti(fg)bus(g.) (,)\r\nbe(gh)ní(i)gnus(j) in(h)dul(i)gén(g)ti(fg)am,(g.) (;)\r\nac(j) ver(h)ba(i) mi(g)se(hg)rán(f)ti(gh)a(h.) (,)\r\ndi(hg)xí(e)sti(f) poe(h)næ(ih) só(g)ci(fg)o:(g.) \r\n3(::) Qui,(g) mó(g)ri(f)ens,(e) di(f)scí(hg)pu(fg)lo(g.) (,)\r\nma(gh)trem(i) do(j)ná(h)sti(i) Vír(g)gi(fg)nem,(g.) (;)\r\ntu(j)ó(h)rum(i) quæ(g) fi(hg)dé(f)li(gh)um(h.) (,)\r\na(hg)gón<i>i</i>(e) ad(f)és(h)set(ih) úl(g)ti(fg)mo:(g.) \r\n4(::) Da(g) no(g)bis,(f) Chri(e)ste(f) Dó(hg)mi(fg)ne,(g.) (,)\r\ntu(gh)o(i) re(j)dém(h)ptis(i) sán(g)gui(fg)ne,(g.) (;)\r\ndu(j)ræ(h) mor(i)tis(g) tri(hg)stí(f)ti(gh)am(h.) (,)\r\nin(hg) vi(e)tæ(f) ver(h)ti(ih) gáu(g)di(fg)um.(g.) \r\n5(::) Tu(g)ós(g)que(f) vo(e)ca(f) fá(hg)mu(fg)los,(g.) (,)\r\nex(gh) hoc(i) pro(j)fé(h)ctos(i) sǽ(g)cu(fg)lo,(g.) (;)\r\nut(j) u(h)bi(i) mors(g) iam(hg) dé(f)e(gh)rit(h.) (,)\r\nte(hg) vi(e)tæ(f) ca(h)nant(ih) prín(g)ci(fg)pem.(g.) (::)\r\nA(ghg)men.(fg..) (::)\r\n",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3)QUI(e) vi(f)vis(gh) an(g)te(fe) sǽ(f)cu(g)la(f_) (,)\r\nvi(f)tǽ(g)que(h) fons(ih) es(g) ú(fgwh)ni(hg)cus,(g.) (;)\r\nnos,(g) De(i)us,(ij) mort<i>i</i>(ji) ob(hg)nó(fgwh)xi(hg)os(g_') (,)\r\ncul(e)pǽ(f)que(gh) re(g)os(fe) á(fg)spi(gf)ce.(f.) \r\n2.(::) Pec(e)cán(f)ti,(gh) Pa(g)ter,(fe) hó(f)mi(g)ni(f_) (,)\r\npoe(f)nam(g) san(h)xíst<i>i</i>(ih) in(g)té(fgwh)ri(hg)tum,(g.) (;)\r\nut,(g) pul(i)vis(ij) da(ji)tus(hg) púl(fgwh)ve(hg)ri,(g_') (,)\r\nse(e) súb(f)de(gh)ret(g) pi(fe)á(fg)cu(gf)lum.(f.) \r\n3.(::) Vi(e)tá(f)le(gh) sed(g) spi(fe)rá(f)cu(g)lum(f_) (,)\r\nquod(f) in(g)di(h)dí(ih)sti(g) pró(fgwh)vi(hg)dus,(g.) (;)\r\næ(g)ter(i)ni(ij)tá(ji)tis(hg) pér(fgwh)ma(hg)net(g_') (,)\r\nger(e)men(f) im(gh)mar(g)ce(fe)scí(fg)bi(gf)le.(f.) \r\n4.(::) Hæc(e) spes,(f) hoc(gh) est(g) so(fe)lá(f)ci(g)um:(f_) (,)\r\nre(f)vi(g)re(h)scé(ih)mus,(g) Dó(fgwh)mi(hg)ne,(g.) (;)\r\npri(g)mús(i)que(ij) re(ji)sur(hg)gén(fgwh)ti(hg)um(g_') (,)\r\nad(e) te(f) nos(gh) Chri(g)stus(fe) rá(fg)pi(gf)et.(f.) \r\n5.(::) Hoc(e) vi(f)tæ(gh) re(g)gno(fe) pér(f)fru(g)i(f_) (,)\r\nda(f) fra(g)tres(h) in(ih) te(g) mór(fgwh)tu(hg)os,(g.) (;)\r\nquos(g) Chri(i)sti(ij) fi(ji)des(hg) ím(fgwh)bu(hg)it,(g_') (,)\r\nquos(e) al(f)mus(gh) un(g)xit(fe) Spí(fg)ri(gf)tus.(f.) \r\n6.(::) Hoc(e) re(f)gnum(gh) no(g)bis(fe) pró(f)pe(g)ra(f_) (,)\r\ne(f) ter(g)ris(h) cum(ih) ces(g)sé(fgwh)ri(hg)mus,(g.) (;)\r\nut(g) con(i)ci(ij)ná(ji)mus(hg) óm(fgwh)ni(hg)um(g_') (,)\r\nte(e) fi(f)nem,(gh) te(g) prin(fe)cí(fg)pi(gf)um.(f.) (::)\r\nA(fgf)men.(ef..) (::)\r\n",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)NUnc,(f) San(e)cte,(d) no(e)bis,(dc) Spí(de)ri(e)tus,(e'_) (,)\r\nu(g)num(ghwih) Pa(gf)tri(g) cum(ghg) Fí(fe)li(de)o,(e.) (;)\r\ndi(f)gná(e)re(d) prom(e)ptus(dc) ín(dewf)ge(d)ri(d'_) (,)\r\nno(d)stro(f) re(e)fú(g)sus(ghg) pé(fe)cto(de)ri.(e.) \r\n2.(::) Os,(f) lin(e)gua,(d) mens,(e) sen(dc)sus,(de) vi(e)gor(e'_) (,)\r\ncon(g)fes(ghwih)si(gf)ó(g)nem(ghg) pér(fe)so(de)nent,(e.) (;)\r\nflam(f)mé(e)scat(d) i(e)gne(dc) cá(dewf)ri(d)tas,(d'_) (,)\r\nac(d)cén(f)dat(e) ar(g)dor(ghg) pró(fe)xi(de)mos.(e.) \r\n3.(::) Per(f) te(e) sci(d)á(e)mus(dc) da(de) Pa(e)trem,(e'_) (,)\r\nno(g)scá(ghwih)mus(gf) at(g)que(ghg) Fí(fe)li(de)um,(e.) (;)\r\nte(f) u(e)tri(d)ús(e)que(dc) Spí(dewf)ri(d)tum(d'_) (,)\r\ncre(d)dá(f)mus(e) om(g)ni(ghg) tém(fe)po(de)re.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)NUnc,(g) San(g)cte,(h) no(g)bis,(f) Spí(g)ri(h)tus,(g_h) (,)\r\nu(j)num(j) Pa(j)tri(jk) cum(ji) Fí(h)li(i)o,(iji.) (;)\r\ndi(h)gná(i)re(j) prom(h)ptus(g) ín(h)ge(g)ri(fef_) (,)\r\nno(d)stro(e) re(f)fú(g)sus(f) pé(h)cto(g)ri.(g.) \r\n2.(::) Os,(g) lin(g)gua,(h) mens,(g) sen(f)sus,(g) vi(h)gor(g_h) (,)\r\ncon(j)fes(j)si(j)ó(jk)nem(ji) pér(h)so(i)nent,(iji.) (;)\r\nflam(h)mé(i)scat(j) i(h)gne(g) cá(h)ri(g)tas,(fef_) (,)\r\nac(d)cén(e)dat(f) ar(g)dor(f) pró(h)xi(g)mos.(g.) \r\n3.(::) Per(g) te(g) sci(h)á(g)mus(f) da(g) Pa(h)trem,(g_h) (,)\r\nno(j)scá(j)mus(j) at(jk)que(ji) Fí(h)li(i)um,(iji.) (;)\r\nte(h) u(i)tri(j)ús(h)que(g) Spí(h)ri(g)tum(fef_) (,)\r\ncre(d)dá(e)mus(f) om(g)ni(f) tém(h)po(g)re.(g.) (::)\r\nA(ghg)men.(fg..) (::)\r\n",
    office: "hy",
    mode: "8",
    pages: [
    { page: "192", sequence: 0, extent: 1 }
  ...
  },
  {
    ...
    gabc: "(c4)RE(f)ctor(e) po(d)tens,(e) ve(dc)rax(de) De(e)us,(e'_) (,)\r\nqui(g) tém(ghwih)pe(gf)ras(g) re(ghg)rum(fe) vi(de)ces,(e.) (;)\r\nsplen(f)dó(e)re(d) ma(e)ne(dc) ín(dewf)stru(d)is(d'_) (,)\r\net(d) í(f)gni(e)bus(g) me(ghg)rí(fe)di(de)em,(e.) \r\n2.(::) Ex(f)stín(e)gue(d) flam(e)mas(dc) lí(de)ti(e)um,(e'_) (,)\r\nau(g)fer(ghwih) ca(gf)ló(g)rem(ghg) nó(fe)xi(de)um,(e.) (;)\r\ncon(f)fer(e) sa(d)lú(e)tem(dc) cór(dewf)po(d)rum(d'_) (,)\r\nve(d)rám(f)que(e) pa(g)cem(ghg) cór(fe)di(de)um.(e.) \r\n3.(::) Præ(f)sta,(e) Pa(d)ter(e) pi(dc)ís(de)si(e)me,(e'_) (,)\r\nPa(g)trí(ghwih)que(gf) com(g)par(ghg) U(fe)ni(de)ce,(e.) (;)\r\ncum(f) Spí(e)ri(d)tu(e) Pa(dc)rá(dewf)cli(d)to(d'_) (,)\r\nre(d)gnans(f) per(e) om(g)ne(ghg) sǽ(fe)cu(de)lum.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)RE(f)rum,(e) De(d)us,(e) te(dc)nax(de) vi(e)gor,(e'_) (,)\r\nim(g)mó(ghwih)tus(gf) in(g) te(ghg) pér(fe)ma(de)nens,(e.) (;)\r\nlu(f)cis(e) di(d)úr(e)næ(dc) tém(dewf)po(d)ra(d'_) (,)\r\nsuc(d)cés(f)si(e)bus(g) de(ghg)tér(fe)mi(de)nans,(e.) \r\n2.(::) Lar(f)gí(e)re(d) cla(e)rum(dc) vé(de)spe(e)re,(e'_) (,)\r\nquo(g) vi(ghwih)ta(gf) num(g)quam(ghg) dé(fe)ci(de)dat,(e.) (;)\r\nsed(f) prǽ(e)mi(d)um(e) mor(dc)tis(dewf) sa(d)cræ(d'_) (,)\r\npe(d)rén(f)nis(e) in(g)stet(ghg) gló(fe)ri(de)a.(e.) \r\n3.(::) Præ(f)sta,(e) Pa(d)ter(e) pi(dc)ís(de)si(e)me,(e'_) (,)\r\nPa(g)trí(ghwih)que(gf) com(g)par(ghg) U(fe)ni(de)ce,(e.) (;)\r\ncum(f) Spí(e)ri(d)tu(e) Pa(dc)rá(dewf)cli(d)to(d'_) (,)\r\nre(d)gnans(f) per(e) om(g)ne(ghg) sǽ(fe)cu(de)lum.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
    { page: "8", sequence: 0, extent: 1 }
  ...
  },
  {
    id: "gregobase:18016",
    incipit: "Salve mater",
    gabc: "(c3)SAl(efee)ve,(d) ma(fh)ter(h) mi(g)se(f)ri(hih)cór(fe)di(de)æ,(e.) (,)\r\nma(i)ter(h) spe(ij)i(j') et(j) ma(h)ter(jlk) vé(ji)ni(hi)æ,(i.) (;)\r\nma(i)ter(h) De(ij)i(h') et(h) ma(f)ter(h) grá(g)ti(fe)æ,(e.) (,)\r\nma(efee)ter(d) ple(fh)na(h) san(g)ctæ(f) læ(hih)tí(fe)ti(de)æ.(e.) \r\n2.(::) Val(efee)lis(d) ver(fh)nans(h) vir(g)tú(f)tum(hih) lí(fe)li(de)is,(e.) (,)\r\nto(i)ta(h) flu(ij)ens(j') sum(j)mis(h) de(jlk)lí(ji)ci(hi)is,(i.) (;)\r\nma(i)ter(h) san(ij)cta,(h') tu(h)is(f) suf(h)frá(g)gi(fe)is(e.) (,)\r\ncon(efee)de(d)scén(fh)de(h) no(g)stris(f) mi(hih)sé(fe)ri(de)is.(e.) \r\n3.(::) Te(efee) cre(d)á(fh)vit(h) Pa(g)ter(f) in(hih)gé(fe)ni(de)tus,(e.) (,)\r\nob(i)um(h)brá(ij)vit(j') te(j) U(h)ni(jlk)gé(ji)ni(hi)tus,(i.) (;)\r\nfe(i)cun(h)dá(ij)vit(h') te(h) San(f)ctus(h) Spí(g)ri(fe)tus:(e.) (,)\r\ni(efee)psis(d) ho(fh)nor(h) ex(g) cor(f)de(hih) pé(fe)ni(de)tus.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "8",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)SAn(d)ctó(e)rum(f) mé(g)ri(h)tis(h_') (,) ín(h)cli(g)ta(e) gáu(f)di(gf)a(e.) (;)\r\npan(d)gá(e)mus,(f) só(g)ci(h)i,(h_') (,) gé(g)sta(e)que(f) fór(g)ti(h)a;(h.) (:)\r\nnam(h) gli(hi)scit(ih) á(g)ni(h)mus(h'_) (,) pró(h)me(g)re(e) cán(f)ti(ed)bus(d.) (;)\r\nvi(g)ctó(f)rum(g) ge(e)nus(fe) óp(d)ti(e)mum.(e.) \r\n2.(::) Hi(d) sunt(e) quos(f) ré(g)ti(h)nens(h_') (,) mun(h)dus(g) in(e)hór(f)ru(gf)it,(e.) (;)\r\ni(d)psum(e) nam(f) sté(g)ri(h)li(h_') (,) flo(g)re(e) per(f)á(g)ri(h)dum(h.) (:)\r\nspre(h)vé(hi)re(ih) pé(g)ni(h)tus(h'_) (,) te(h)que(g) se(e)cú(f)ti(ed) sunt,(d.) (;)\r\nrex,(g) Chri(f)ste,(g) bo(e)ne(fe) cǽ(d)li(e)tum.(e.) \r\n3.(::) Hi(d) pro(e) te(f) fú(g)ri(h)as(h_') (,) sǽ(h)va(g)que(e) sú(f)sti(gf)nent;(e.) (;)\r\nnon(d) mur(e)mur(f) ré(g)so(h)nat,(h_') (,) non(g) que(e)ri(f)mó(g)ni(h)a,(h.) (:)\r\nsed(h) cor(hi)de(ih) tá(g)ci(h)to(h'_) (,) mens(h) be(g)ne(e) cón(f)sci(ed)a(d.) (;)\r\ncon(g)sér(f)vat(g) pa(e)ti(fe)én(d)ti(e)am.(e.) \r\n4.(::) Quæ(d) vox,(e) quæ(f) pó(g)te(h)rit(h_') (,) lin(h)gua(g) re(e)té(f)xe(gf)re(e.) (;)\r\nquæ(d) tu(e) mar(f)tý(g)ri(h)bus(h_') (,) mú(g)ne(e)ra(f) prǽ(g)pa(h)ras?(h.) (:)\r\nRu(h)bri(hi) nam(ih) flú(g)i(h)do(h'_) (,) sán(h)gui(g)ne(e) láu(f)re(ed)is(d.) (;)\r\ndi(g)tán(f)tur(g) be(e)ne(fe) fúl(d)gi(e)dis.(e.) \r\n5.(::) Te,(d) tri(e)na(f) Dé(g)i(h)tas(h_') (,) ú(h)na(g)que,(e) pó(f)sci(gf)mus,(e.) (;)\r\nut(d) cul(e)pas(f) á(g)blu(h)as,(h_') (,) nó(g)xi(e)a(f) súb(g)tra(h)has,(h.) (:)\r\ndes(h) pa(hi)cem(ih) fá(g)mu(h)lis,(h'_) (,) nos(h) quo(g)que(e) gló(f)ri(ed)am(d.) (;)\r\nper(g) cun(f)cta(g) ti(e)bi(fe) sǽ(d)cu(e)la.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(f3)STa(f)bat(e) ma(f)ter(fg) do(i)lo(h)ró(g)sa(f.) (;)\r\niux(h)ta(g) cru(f)cem(fe) la(f)cri(g)mó(f)sa,(e.) (;)\r\ndum(g) pen(h)dé(g)bat(f) Fí(e)li(f)us.(f.) \r\n2.(::) Cu(f)ius(e) á(f)ni(fg)mam(i) ge(h)mén(g)tem,(f.) (;)\r\ncon(h)tri(g)stá(f)tam(fe) et(f) do(g)lén(f)tem(e.) (;)\r\nper(g)trans(h)í(g)vit(f) glá(e)di(f)us.(f.) \r\n3.(::) O(f) quam(e) tri(f)stis(fg) et(i) af(h)flí(g)cta(f.) (;)\r\nfu(h)it(g) il(f)la(fe) be(f)ne(g)dí(f)cta(e.) (;)\r\nma(g)ter(h) U(g)ni(f)gé(e)ni(f)ti!(f.) \r\n4.(::) Quæ(f) mæ(e)ré(f)bat(fg) et(i) do(h)lé(g)bat(f.) (;)\r\npi(h)a(g) ma(f)ter,(fe) cum(f) vi(g)dé(f)bat(e.) (;)\r\nNa(g)ti(h) poe(g)nas(f) ín(e)cli(f)ti.(f.) \r\n5.(::) Quis(f) est(e) ho(f)mo(fg) qui(i) non(h) fle(g)ret,(f.) (;)\r\nma(h)trem(g) Chri(f)sti(fe) si(f) vi(g)dé(f)ret(e.) (;)\r\nin(g) tan(h)to(g) sup(f)plí(e)ci(f)o?(f.) \r\n6.(::) Quis(f) non(e) pos(f)set(fg) con(i)tri(h)stá(g)ri,(f.) (;)\r\npi(h)am(g) ma(f)trem(fe) con(f)tem(g)plá(f)ri(e.) (;)\r\ndo(g)lén(h)tem(g) cum(f) Fí(e)li(f)o?(f.) \r\n7.(::) Pro(f) pec(e)cá(f)tis(fg) su(i)æ(h) gen(g)tis(f.) (;)\r\nvi(h)dit(g) Ie(f)sum(fe) in(f) tor(g)mén(f)tis(e.) (;)\r\net(g) fla(h)gél(g)lis(f) súb(e)di(f)tum.(f.) \r\n8.(::) Vi(f)dit(e) su(f)um(fg) dul(i)cem(h) Na(g)tum(f.) (;)\r\nmo(h)ri(g)én(f)tem(fe) de(f)so(g)lá(f)tum,(e.) (;)\r\ncum(g) e(h)mí(g)sit(f) spí(e)ri(f)tum.(f.) \r\n9.(::) Chri(f)ste,(e) cum(f) sit(fg) hinc(i) ex(h)í(g)re,(f.) (;)\r\nda(h) per(g) ma(f)trem(fe) me(f) ve(g)ní(f)re(e.) (;)\r\nad(g) pal(h)mam(g) vi(f)ctó(e)ri(f)æ.(f.) (::)\r\nA(fgf)men.(ef..) (::)\r\n",
    office: "hy",
    mode: "2",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)VE(g)ni,(g) præ(f)cél(e)sa(d) Dó(fhg)mi(fg)na;(g.) (,)\r\nMa(hiwji)rí(h)a,(g) tu(h) nos(ig) ví(h)si(g)ta,(f.) (;)\r\nquæ(f) iam(g) co(f)gná(g)tæ(h) dó(j)mu(g)i(hih'_15) (,)\r\ntan(h)tum(h) por(g)tá(e)sti(f) gáu(hg)di(fg)i.(g.) \r\n2.(::) Ve(g)ni,(g) iu(f)vá(e)men(d) sǽ(fhg)cu(fg)li,(g.) (,)\r\nsor(hiwji)des(h) au(g)fer(h) pi(ig)á(h)cu(g)li,(f.) (;)\r\nac(f) vi(g)si(f)tán(g)do(h) pó(j)pu(g)lum(hih'_15) (,)\r\npoe(h)næ(h) tol(g)le(e) pe(f)rí(hg)cu(fg)lum.(g.) \r\n3.(::) Ve(g)ni,(g) stel(f)la,(e) lux(d) má(fhg)ri(fg)um,(g.) (,)\r\nin(hiwji)fún(h)de(g) pa(h)cis(ig) rá(h)di(g)um;(f.) (;)\r\nre(f)ge(g) quod(f)cúm(g)que(h) dé(j)vi(g)um,(hih'_15) (,)\r\nda(h) vi(h)tam(g) in(e)no(f)cén(hg)ti(fg)um.(g.) \r\n4.(::) Ve(g)ni,(g) pre(f)cá(e)mur,(d) ví(fhg)si(fg)tes(g.) (,)\r\nno(hiwji)bís(h)que(g) vi(h)res(ig) ró(h)bo(g)res(f.) (;)\r\nvir(f)tú(g)te(f) sa(g)cri(h) ím(j)pe(g)tus,(hih'_15) (,)\r\nne(h) flu(h)ctu(g)é(e)tur(f) á(hg)ni(fg)mus.(g.) \r\n5.(::) Ve(g)ni,(g) vir(f)ga(e) re(d)gá(fhg)li(fg)um,(g.) (,)\r\nre(hiwji)duc(h) flu(g)ctus(h) er(ig)rán(h)ti(g)um(f.) (;)\r\nad(f) u(g)ni(f)tá(g)tem(h) fí(j)de(g)i,(hih'_15) (,)\r\nin(h) qua(h) sal(g)ván(e)tur(f) cǽ(hg)li(fg)ci.(g.) \r\n6.(::) Ve(g)ni,(g) te(f)cúm(e)que(d) Fí(fhg)li(fg)um(g.) (,)\r\nlau(hiwji)dé(h)mus(g) in(h) per(ig)pé(h)tu(g)um,(f.) (;)\r\ncum(f) Pa(g) tr<i>e</i>() et(f) San(g)cto(h) Spí(j)ri(g)tu,(hih'_15) (,)\r\nqui(h) no(h)bis(g) dent(e) au(f)xí(hg)li(fg)um.(g.) (::)\r\nA(ghg)men.(fg..) (::)\r\n",
    office: "hy",
    mode: "8",
    pages: [
    { page: "376", sequence: 0, extent: 1 }
  ...
  },
  {
    ...
    gabc: "(c4)VIr(d_)go(e) pru(f)dén(gh)tum(g.) (,) co(fe)mi(d)tá(e)ta(f) cœ(e.)tum(d.) (;)\r\nób(f_)vi(e)am(f) spon(gh)so(g.) (,) vé(g)ni(f)ens(h) pa(i)rá(h.)ta,(g.) (:)\r\nno(h_)ctis(g) hor(f)rén(g.)dæ(f.) (,) ré(fe)mo(d)vet(e) té(f)ne(e.)bras(d.) (,)\r\nlám(f-)pa(e)de(f) pu(gvFE)ra.(e.) \r\n2.(::) Il(d_)le(e) ful(f)gén(gh)tem(g.) (,) ní(fe)ti(d)dis(e) la(f)píl(e.)lis(d.) (;)\r\ná(f_)nu(e)lum(f) mi(gh)ri(g.) (,) trí(g)bu(f)it(h) de(i)có(h.)ris(g.) (:)\r\nvír(h_)gi(g)ni(f) di(g.)cens:(f.)  «(,)Ti(fe)bi(d) tra(e)do(f) san(e.)cti(d.) (,)\r\npi(f-)gnus(e) a(f)mó(gvFE)ris».(e.) \r\n3.(::) Mo(d_)ta(e) fla(f)grán(gh)tis(g.) (,) stí(fe)mu(d)lo(e) ca(f)ló(e.)ris(d.) (;)\r\nmen(f_)tis(e) ex(f)cés(gh)su(g.) (,) rá(g)pi(f)tur(h) fre(i)quén(h.)ti,(g.) (:)\r\nfi(h_)xa(g) dum(f) por(g.)tat(f.) (,) Ca(fe)tha(d)rí(e)na(f) mem(e.)bris(d.) (,)\r\nvúl(f-)ne(e)ra(f) Chri(gvFE)sti.(e.) \r\n4.(::) Un(d_)de(e) ter(f) fe(gh)lix(g.) (,) qua(fe)ter(d) et(e) be(f)á(e.)ta(d.) (;)\r\nin(f_) si(e)nu(f) spon(gh)si(g.) (,) re(g)qui(f)é(h)vit(i) al(h.)mi,(g.) (:)\r\nin(h_)ter(g) il(f)lú(g.)stres(f.) (,) á(fe)ni(d)mas(e) re(f)lá(e.)ta(d.) (,)\r\nlux(f-) no(e)va(f) cæ(gvFE)li.(e.) \r\n5.(::) Sit(d_) De(e)us(f) cæ(gh)li(g.) (,) ré(fe)si(d)dens(e) in(f) ar(e.)ce,(d.) (;)\r\ntri(f_)nus(e) et(f) sim(gh)plex(g.) (,) be(g)ne(f)dí(h)ctus(i) il(h.)le,(g.) (:)\r\nqui(h_) po(g)tens(f) to(g.)tum(f.) (,) stá(fe)bi(d)li(e) gu(f)bér(e.)nat(d.) (,)\r\nór(f-)di(e)ne(f) mun(gvFE)dum.(e.) (::)\r\nA(efe)men.(de..) (::)\r\n",
    office: "hy",
    mode: "4",
    pages: [
  ...
  },
  {
    ...
    gabc: "(c4)CHri(@[[uh:m{]d_e_0fW_0g_0h_0][uh}])stus(g) na(h_g_!hw_!i_1j_)tus(h) est(gh~) no(hhgh)bis :(ffe/fog.) (;) ve(d!e!fog)ní(g)te,(gh/hg/he__) a(df!gwh)do(g)ré(fg!hvhgh)mus.(e.) (::)",
    office: "an",
    mode: "4",
    pages: [
